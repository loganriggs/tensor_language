...
if __name__ == "__main__":
    ...
    for seed in seeds:
        for spec_name, spec in run_specs.items():
            ...
            # add stalled on the copy-only plateau. mlp uses add. norm off (polynomial).
            ...
            for step in range(STEPS):
                ...
                # deep norm-free bilinear stacks explode (degree ~2^depth); clip to stay
                # finite without normalization (until a tensor-compatible norm is added).
