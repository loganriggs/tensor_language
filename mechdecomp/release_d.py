...
def main():
    ...
    for rnd in range(ROUNDS):
        ...
        if rnd == 0:
            ...
            assert 0.85 < R2 < 0.94, f"G1 FAIL: round-0 R2 {R2} does not reproduce the known ~0.90"
    ...
    for tag, Dx in (("feature basis D0 (round 0)", D0), ("refined D (round 7)", D)):
        WDx = W @ Dx
        Cv, _ = omp_codes(WDx, Yva, KSPARSE)
