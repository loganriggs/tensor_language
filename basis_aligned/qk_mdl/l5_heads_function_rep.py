...
L = 5
OUT = f'{QK}/l5_heads_function_rep.json'
m, cfg = load_elriggs('bilin18')
NH, HD, D = cfg['n_head'], cfg['n_embd'] // cfg['n_head'], cfg['n_embd']
g0 = torch.Generator(); g0.manual_seed(7)
TOK = torch.randint(0, cfg['vocab_size'], (32, 256), generator=g0).repeat(1, 2)
...
res = {'note': 'L5 heads on REPEATED sequences (A+A); contextual = H5, H7',
...
print('l5 heads function REP done', flush=True)
