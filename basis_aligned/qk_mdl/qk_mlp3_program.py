"""Layer-3 MLP explicit program (bottom-up ladder; same TN-native family that cracked MLP0/1):
...
torch.save({k: v for k, v in ARMS.items() if v[0] is not None}, f'{QK}/qk_mlp3_program.pt')
...
json.dump(res, open(f'{QK}/qk_mlp3_program.json', 'w'), indent=2)
