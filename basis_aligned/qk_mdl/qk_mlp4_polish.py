...
WANT = 4
A512, U512 = torch.load(f'{QK}/qk_mlp4_program.pt', map_location=DEV)['table_prev_R256']
FLOOR1 = json.load(open(f'{QK}/qk_completeness_ledger.json'))['mlp_floor'][str(4)]
...
json.dump(res, open(f'{QK}/qk_mlp4_polish.json', 'w'), indent=2)
torch.save({'g': g.detach(), 'ab': ab.detach()}, f'{QK}/qk_mlp4_polish.pt')
print("QK MLP4 POLISH DONE", flush=True)
