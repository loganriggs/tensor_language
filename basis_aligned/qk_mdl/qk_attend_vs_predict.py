...
CAP_HEADS = [(0, 8), (1, 3), (1, 4), (1, 7), (2, 1), (2, 4), (2, 5), (3, 2), (3, 5), (3, 8), (5, 5), (6, 2), (6, 5), (7, 3), (8, 6), (9, 8), (10, 6), (11, 2), (11, 4), (12, 6), (13, 2), (13, 8), (14, 1), (14, 6), (15, 3), (15, 4), (16, 0), (16, 1), (16, 4), (16, 5)]
PRED = {tuple(k[:2]): k[2] for k in [(0, 8, 'KEY_newline'), (1, 3, 'PREV1'), (1, 4, 'MATCH_same'), (1, 7, 'KEY_newline'), (2, 1, 'MATCH_prev'), (2, 4, 'KEY_newline'), (2, 5, 'MATCH_same'), (3, 2, 'KEY_newline'), (3, 5, 'MATCH_same'), (3, 8, 'MATCH_same'), (5, 5, 'MATCH_prev'), (6, 2, 'KEY_func'), (6, 5, 'MATCH_prev'), (7, 3, 'MATCH_prev'), (8, 6, 'MATCH_prev'), (9, 8, 'KEY_newline'), (10, 6, 'KEY_newline'), (11, 2, 'PREV1'), (11, 4, 'KEY_newline'), (12, 6, 'MATCH_prev'), (13, 2, 'MATCH_prev'), (13, 8, 'KEY_newline'), (14, 1, 'MATCH_same'), (14, 6, 'MATCH_prev'), (15, 3, 'KEY_cap'), (15, 4, 'KEY_cap'), (16, 0, 'KEY_func'), (16, 1, 'KEY_cap'), (16, 4, 'KEY_newline'), (16, 5, 'KEY_cap')]}
...
for (li, h) in CAP_HEADS:
    ...
    di = round(base_adv - ind_adv(run(EVi, k1, MEANi)[0]), 4)
    res[f'single_L{li}H{h}']['induction_drop'] = di
    top = sorted([(t, v) for t, v in res[f'single_L{li}H{h}'].items() if isinstance(v,(int,float)) and t!='induction_drop' and v>0], key=lambda x: -x[1])[:2]
    print(f'  L{li}H{h} [{PRED[(li,h)]}]: cat-top {top} | ind {di}', flush=True)
json.dump(res, open(f'{QK}/qk_attend_vs_predict.json', 'w'), indent=2)
print('QK ATTEND VS PREDICT DONE', flush=True)
