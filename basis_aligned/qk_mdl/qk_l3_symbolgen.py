"""TICK 252: symbol-generated LAYER-3 pattern with the unchanged 384-symbol dictionary.
...
def blocks01(idx):
    ...
    return yhs[0], yhs[1], blk3.lambdas[0] * x + blk3.lambdas[1] * x0
...
with torch.no_grad():
    for i in range(0, len(FINEWEB), 4):
        ...
        n += b[:, 1:].numel()
ce = tot / n
out = {'decoder_R2': round(R2, 4), 'l3_symbolgen_dce': round(ce - BASE, 5),
...
json.dump(out, open(f'{QK}/qk_l3_symbolgen.json', 'w'), indent=2)
print('L3 SYMBOLGEN DONE', flush=True)
