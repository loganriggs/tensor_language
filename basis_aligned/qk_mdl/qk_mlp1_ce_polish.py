...
json.dump(res, open(f'{QK}/qk_mlp1_ce_polish.json', 'w'), indent=2)
torch.save({'g': g.detach(), 'ab': ab.detach()}, f'{QK}/qk_mlp1_ce_polish.pt')
print("QK MLP1 CE POLISH DONE", flush=True)
