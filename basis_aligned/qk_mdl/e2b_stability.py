...
for k, SEED_OFF, tag in ((256, 0, 'sketch2048'), (256, 777, 'sketch2048-seed2'),
                         (64, 0, 'sketch2048'), (64, 777, 'sketch2048-seed2')):
    globals()['SEED_OFF'] = SEED_OFF
    tabs = vq_tables(k, 'unembed')
    d = audit_ce(tabs) - base
    res['arms'][f'W={W} vq{k} unembed {tag}'] = d
    print(f'W={W} vq{k} unembed {tag}: dCE {d:+.4f}', flush=True)
    with open(OUT, 'w') as fh:
        json.dump(res, fh, indent=2)
print('e2b stability done', flush=True)
