...
saved to qk_h0_polish_g025.pt for the artifact refresh.
"""
import json
import sys
import numpy as np
...
R_CP, GAMMA_MAX, JSTEPS, N_PROBE = 64, 0.025, 4000, 8
...
for h, (mm, kc) in ((0, (2048, 4)),):
    ...
    json.dump(out, open(f'{QK}/qk_h0_polish_g025.json', 'w'), indent=2)
    torch.save(save, f'{QK}/qk_h0_polish_g025.pt')
