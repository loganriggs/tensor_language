"""LAYOUT circuit: NEWLINE prediction (next token is a line break) -- the atlas outlier (35% head
mass, distributed, recruits h11.0), contrasting the MLP-driven category family.
...
print(f"newline-type tokens: {int(is_cont.sum())}", flush=True)
...
json.dump(res, open(f'{QK}/qk_newline_circuit.json', 'w'), indent=2)
print("QK NEWLINE CIRCUIT DONE", flush=True)
