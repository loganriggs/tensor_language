"""HYBRID FRONTIER AT M=4096 (tick 168, overnight): tick-167 showed sampling coverage
was a real cost (M=1024 -> 4096 moves 455-Mbit base from +0.0048 to +0.0034, saturating).
Retrain the composed frontier (incoherent-rotary + exact anchors) at M=4096 across all
budgets; anchors recomputed per dictionary; seed 1 replicate at the flagship point.
"""
import json
import os
import sys
...
OUT = f'{QK}/qk_hybrid_m4096.json'
NAMES = ('q1', 'k1', 'q2', 'k2')
BRANCHES = (('q1', 'k1'), ('q2', 'k2'))
CTX_M, T_CTX, CTX_STEPS, CTX_LR, N_OFF = 4096, 512, 1500, 3e-4, 8
...
JOBS = [
    ...
    ('b1024', 1024, 8, 0, 0),
    ('h512_b256', 512, 4, 256, 0), ('b512', 512, 4, 0, 0),
    ('h4096k8_b1024', 4096, 8, 1024, 0), ('b4096k8', 4096, 8, 0, 0),
    ('h4096k16_b1024', 4096, 16, 1024, 0), ('b4096k16', 4096, 16, 0, 0),
    ('h1024_b256_s1', 1024, 8, 256, 1),
]
