...
CAP_HEADS = [(1, 3), (1, 4), (2, 4), (2, 5), (3, 5), (3, 8), (5, 5), (6, 2), (6, 5), (7, 3), (8, 6), (10, 6), (11, 2), (11, 4), (12, 6), (13, 2), (14, 1), (15, 3), (15, 4), (16, 0), (16, 1), (16, 4), (16, 5)]
PRED = {tuple(k[:2]): k[2] for k in [(1, 3, 'PREV1'), (1, 4, 'MATCH_same'), (2, 4, 'KEY_punct'), (2, 5, 'MATCH_same'), (3, 5, 'MATCH_same'), (3, 8, 'MATCH_same'), (5, 5, 'MATCH_prev'), (6, 2, 'KEY_func'), (6, 5, 'MATCH_prev'), (7, 3, 'MATCH_prev'), (8, 6, 'MATCH_prev'), (10, 6, 'KEY_punct'), (11, 2, 'PREV1'), (11, 4, 'KEY_punct'), (12, 6, 'MATCH_prev'), (13, 2, 'MATCH_prev'), (14, 1, 'MATCH_same'), (15, 3, 'KEY_cap'), (15, 4, 'KEY_cap'), (16, 0, 'KEY_cap'), (16, 1, 'KEY_cap'), (16, 4, 'KEY_func'), (16, 5, 'KEY_cap')]}
...
json.dump(res, open(f'{QK}/qk_head_function_map.json', 'w'), indent=2)
print('QK HEAD FUNCTION MAP DONE', flush=True)
