"""ARCHITECTURE-GENERALITY of the editing capstone: does copy-head COMMANDEERING replicate on bilinsm12
(a THIRD attention family -- SOFTMAX attention)? Because
...
json.dump(res, open(f'{QK}/qk_bilinsm12_commandeer.json', 'w'), indent=2)
print("QK BILINSM12 COMMANDEER DONE", flush=True)
