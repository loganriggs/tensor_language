...
print(f"swiglu18 base CE(128) {allce:.3f} | induction adv {adv_full:.3f}", {t: round(base_ce[t],2) for t in VOCAB_TASKS}, flush=True)
...
json.dump(res, open(f'{QK}/qk_atlas_swiglu18.json', 'w'), indent=2)
