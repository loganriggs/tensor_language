"""CE-trained vq codebooks for bilin18 layer-0 (the basis_aligned e7 lesson
...
torch.manual_seed(0)
DEV = 'cuda'
OUT = '/workspace/tensor_language/basis_aligned/qk_mdl/tier2_ce_codebooks.json'
...
for K in [16, 64, 256]:
    ...
    torch.save({f'{t}{br}': params[f'{t}{br}'].detach().cpu()
               ...
               f'/workspace/tensor_language/basis_aligned/qk_mdl/ce_codebook_k{K}.pt')
    with open(OUT, 'w') as fh:
        json.dump(results, fh, indent=2)
print('ce codebooks done')
