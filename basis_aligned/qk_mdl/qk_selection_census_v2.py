...
print(f"GATE: {len(PROGSET)} programmatic heads' patterns coded simultaneously: dCE +{gate['dCE']} (SE {gate['SE']})", flush=True)
json.dump({'census': census, 'programmatic': prog, 'gate': gate},
          open(f'{QK}/qk_selection_census_v2.json', 'w'), indent=2)
print("QK SELECTION CENSUS V2 DONE", flush=True)
