...
def main():
 ...
 for cosine in [.9,.999999,1.]:
  ...
  wo=torch.stack([w0,orth]);bo=wo@z/1152;go=wo@wo.T/1152
  ...
  for av,bv in [(1.,1.),(1.,-1.),(.3,-.7),(2.,-2.)]:
   ...
   oa=a+cosine*b;obeta=(1-cosine*cosine)**.5*b
 ...
 (P/'TWO_WRITER_ORTHOGONAL_PRECISION_V1_CONTROL.json').write_text(json.dumps(result,indent=2)+'\n');print(json.dumps(result,indent=2))
