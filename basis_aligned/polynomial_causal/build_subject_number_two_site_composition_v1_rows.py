...
SCHEMA = "subject_number_two_site_composition_v1_rows"
NOUN_PAIRS = (
    ("captain", "captains"), ("teacher", "teachers"),
    ("doctor", "doctors"), ("farmer", "farmers"),
    ("lawyer", "lawyers"), ("reader", "readers"),
    ("singer", "singers"), ("dancer", "dancers"),
    ("worker", "workers"), ("driver", "drivers"),
    ("guard", "guards"), ("pilot", "pilots"),
    ("author", "authors"), ("actor", "actors"),
    ("banker", "bankers"), ("chef", "chefs"),
)
TEMPLATES = (
    ("near_beside", "Near the {a1}, the {s1} {v1} ready; beside the {a2}, the {s2}"),
    ("beyond_behind", "Beyond the {a1}, the {s1} {v1} waiting; behind the {a2}, the {s2}"),
)
...
def main():
    ...
    for group in range(8):
        number1, number2 = ((group >> 1) & 1, group & 1)
    ...
    payload = {
        "schema": SCHEMA,
        "selection_rule": "eight fixed noun-pair groups balancing all four site-number combinations, crossed with two fixed two-clause templates; cardinality-four axis coefficients fixed independently of rows",
