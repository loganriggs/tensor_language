...
## Where the full-graph swap error comes from —12 September06:06

The cachedgraph error splits exactly into recurringnode error and remaininggraph error. A nativeFP32RMS/tanh margin gradient at the midpoint of exact/approximate swapped states predicts actualmarginerror within0.0049–0.0094%relativeerror. Node/complement predictedRMS contributions are0.00494/0.03896(A1),0.00335/0.02119(A2),0.00209/0.02096(past),0.00295/0.02832(progressive). Cross terms arepositive andretained; theseare notindependent percentages. The remaininggraph dominates ineachfamily. [Error split](SPARSE_GRAPH_ERROR_SPLIT_V1_RESULT.json), [code](sparse_graph_error_split_v1.py). This doesnotrescue thefailednodeA2bar; it directs optimizationtoward theotherinteractions ratherthan anA2-driven noderefit.
