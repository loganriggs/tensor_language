...
V1 failed at the protected check immediately before candidate-bundle publication;
the traceback location follows all three optimization loops, although the immutable
failure JSON conservatively certifies only that no bundle existed and EVALUATION had
not opened. The failure was caused solely by a
