...
## Lexical/form commands: reuse with coupling, joint failures — 2026-09-10 18:03 UTC

Previous turn PROGRESSb544a7bf1, preregae1e5d77d pushed. Fixed first-value position3 lexical command and all36 e-output form command from original-lemma ing cue; reuse same donors across cue/lemma, then joint. Exact four-reader Hadamard decomposition folded to MLP17 products without fitting. Managed run_lexical_form_interchange_v1.py SHA68fc2ccc2f2e70ef4e4363728eba0f75cb5cac931eeb324b030dbfe3afc80c65 ran18:03:16–18:03:20,23forwards368seq,1.557861sec. A held B/C/D/E failed. A1nativeall16, A2Y/Z15 each: shop/laugh contexts prefer traveling in their respective four-token comparisons; no filtering. L bare/ing recovery .84174/.84124 and .80855/.78531; all form-preservation point errors .0462–.0976 pass individually. F original/cyclic-lemma recovery .95175/.95041 and .86341/.86437; lexical drift .1149–.1688 fails. Joint target correct14/16,13/16 despite four-token errors .17660/.19757; full-vocab addition .12298/.08285. All combined reuse/composition predictions failed.

New G agreement-margin meanabs .23328 (CI .16004–.30963)fails .10; original CE .70470 replays. Edited foil scores now saved, so earlier attribution limitation is resolved by this new measurement, not reinterpretation of missing data. Native cyclic margin meanabs .46626 report-only. Fold max1.16e-14, no-op0, old lexical replay<8.61e-8. Artifact LEXICAL_FORM_INTERCHANGE_V1_STATES.pt7,476,061bytes contains all final h/selected scores and Hadamard readers/product coefficients. Actual paired CPU audit and checkpoint-free state-addition/readout diagnostic executed: selected-score addition predicts actual J at .04706/.04069, state-addition+readout .04604/.06495; neither fixes native-target choice failures. Raw-state addition errors .15892/.11426. Actual score-component accounting attributes58–81% of F lexical-drift squared norm to predefined interaction coordinate; not causal mediation or identified producer.

New record lexical_form_commands rejects combined claims; LATEST18:03/explanation/MLP17/master/channel dossiers updated. Next explicit lexical/form coupling and its producers, retaining token-specific interaction readers rather than rank/head/threshold rescue. Both user unembedding paths and original handoff remain authority. Full goal active, CPU continuation actually complete. Next hourly18:14/math19:49; existing1614 phase log. Preserve concurrent Claude work.
...
Claimed post-result CPU audit actually executed. Paired intervals for all sites; saved context readers split exactly into panel mean plus token-specific remainder. Mean-only gate errors .64924/.90508; combined replay<=2.21e-13. G uses same runs/run reader throughout, hence zero remainder by construction. Report-only on opened rows, no structure selection or promotion. Cache TOKEN_CONTEXT_SOURCE_V1_ARTIFACT.pt saves all36 native final-position outputs, u17, context readers and MLP16 product pullbacks (10,879,453bytes), no checkpoint needed for CPU reuse. User reaffirmed two paths: individual token readouts and structured unembedding components/hierarchies plus remainders, folded separately. Next distributed production/shared-subterm question; no post-hoc singleton/head selection. Original handoff/pilot remains authority, full goal active. Latest explanation17:37, dossiers updated. Next hourly18:14/math19:49, existing1614 phase log; restored phases after compaction not retroactively invented.

## Grammatical numerator/RMS factors and token-score program — 2026-09-10 17:17 UTC

Previous turn PROGRESS8ae43de7b. Original handoff/pilot; MLP17 calibration_two_readers_v1/v2 primary precedent checked. Prereg83eb82e8d. V1 ran17:14:14–17:14:18 and failed after saving states because publication called stat().st_size(). Preserve V1 bytes/log and failure note. Publisher-only V2 repair15fb6bd40 keeps all science and changes result/binding/state filenames. Accepted run_gerund_readout_factorial_v2.py SHA0f218d92d8af515e508e5592f106cab4274f235e27adb3c045c9404a6e5801a8 ran17:16:58–17:17:02,12forwards192seq,1.37302sec. V1/V2 saved states bitwise equal in actual post-result CPU audit.

A instrument/E token-score program held; B norm-only/C numerator-only/D true-norm repair failed. A1/A2 full-effect errors norm-only .93533/.97952, numerator-only .47626/.58483, projected numerator+true norm .87871/.91634. Pair intervals for latter .87346–.88409/.91124–.92173. Thus omitted token-specific numerator information remains important; no normalization-only rescue. Full numerator+norm bridges ~1e-5 relative effect error, all64 native pairs capable, prior local intervention replay holds. Endpoint interaction .04486/.06194 is not independent circuit composition.

Actual token answer/foil readers plus shared norm polynomial give11 context-dependent coefficients. h(delta)=h0+delta*b+delta^2*a: numerator degree2, norm squared degree4, then actual softcap. Max native token error8.03e-6/margin8.73e-6; half-command composition5.33e-15. CPU reload composition3.55e-15, no checkpoint. This is local conditional token-score/log-odds prediction, not initial context production or full-CE/model extraction. State cache GERUND_READOUT_FACTORIAL_V2_STATES.pt (3,010,885bytes) contains h_base/h_edited/h_projected/u_base/delta/linear/quadratic/token_state/token_ids and row IDs for CPU reuse. Canonical gerund_token_norm_program specified local score program and rejected isolated readout simplifications. Explanation/LATEST17:17, MLP17/master dossiers updated.

Hourly17:14 completed: three valid native receipts, gaps646/1304sec median975sec, executor4.81105sec; failed V1 and successful V2 fall in next hour, not counted retroactively. Focus/novelty pass, ceremonybudget FAIL unverified despite74.63% phase coverage (913.47s missing). Repair active: mark first-tool restoration and mark publication BEFORE report/registry authoring, using existing1614 log; state cache avoids recapture. Next actual extraction target is upstream production of required token/context gates and shared moments, not another local identity/rank. Full goal active; paired and saved-state CPU continuation performed, no queuedGPU. Next hourly18:14/math19:49.
...
CPU run_selected_reader_response_v1.py SHA f2458383ed22495bb694c804101030bb5544c66e1ca494cd519981671d0b8a9a,1.79254sec,zero model forwards/GPU. All A/B/C held: selected response1.01e-13, composition1.59e-13, stateupdate2.51e-16. All16 synthetic equal-e/equal-K/equal-norm pairs witness differing full-output responses: minimum common-prediction relative errors .1087–.2416. Contexts inside RMS ball but not claimed natural-text reachable. Stored SELECTED_READER_RESPONSE_V1_PROGRAM.pt SHA bc663b940d8beb8918f0addc2652ae0829555abad6cce4b4a9f68ea5a2b3fb19 has2306 FP64 coefficients,18448 tensor bytes/20613 file bytes. Separate actually executed reload audit uses no checkpoint, new32 random contexts and commands .375/-.2, errors<=1.55e-16.

Canonical gerund_selected_response specified for conditional local response/composition, rejected for full-output closure; do not count as a new native causal screen or behavioral OOD/extraction. LATEST16:54, existing gerund explanation and MLP17/master dossiers updated. Literature mapping covers linear/hierarchical lumping, constant-gradient ridge state, linear2-RNN/Hankel, tensor uniqueness/graph-width limitations. Next highest-information native question is scalar numerator context versus RMS gain and attention consumers; first validate selected reader semantics on native/saved contexts without refit. Actual CPU witness plus independent serialized reload are continuation receipts. No GPU job queued; runners healthy. Full goal active. Next mathematical19:49/hourly17:14, prospective1614 phase log continues.

## Folded grammatical MLP consumers held; conditional closure failed — 2026-09-10 16:42 UTC

Previous turn PROGRESSaf770179c. Prereg bb3152ff3 and parser-only pre-execution fix622c993f3 pushed. Initial managed enqueue refused dict-key syntax before any model execution; no threshold or semantic changes. Accepted runner run_gerund_mlp_consumer_v1.py SHA6838667d18f4a16d34082f496f61fdbe14def1d6393456ff9907b651c5316439 ran16:42:25–16:42:29,28forwards448seq,1.71751sec. Original handoff/pilot and two unembedding views. Dossiers/v184/v185 precedent checked. Restore natural recipient scalar at all18 normalized MLP inputs, leaving input complement live; apply exact folded bilinear finite difference before original all36 output e edits. This is post-RMS and does not renormalize the edited input. Attention/norm-induced complementary changes remain live.

A/B/C/E held; D conditional closure failed. Target swap loss .29139/.29055 (pairedCI .25625–.32386/.26203–.31871), recovery .66036/.57286 from .95175/.86341. G base-only zeroCE .38682->.11766,69.6% reduction; not comparable to previous two-endpoint .54788. Scalar prediction live errors .64876/.64467 become .15287/.08449 on blocked computation, not an improved unchanged-model predictor. All64 native pairs capable, replay exactly0, folded rel<=1.60e-6. Actual post-result CPU paired audit completed. k_e/k_agreement contextual weight-reader cosines min-.0201/median.2053/max.7364, descriptive not site selection. Canonical gerund_mlp_scalar_consumers separates live consumer necessity/mediation and rejected closure. Existing explanation/LATEST16:42 and dossiers updated. All native weights remain; no independent producers or selective repair. Next derive and test context-gate producers and remaining attention/norm consumer paths. Full goal active, actual CPU continuation performed; no new GPU successor queued. Next hourly17:14/math16:49; prospective1614 phase clock remains active.
...
Managed run_gerund_scalar_network_v1.py SHA377bf0d922c1dda2948831ae3e5e4b1063907e52dae25f32f49d0cf75d82c4e9 ran16:06:35–16:06:39,48forwards768seq,2.03933sec. A/B/D/E held, C frozen-background edit prediction failed. All-group swaps recover .93577/1.01669 with P/C meanabsCE .04036/.00962 and C recovery.00128. All-group zero targetCE+.97659/+1.26780, C meanabsCE.04334; P zero damage.98513 is not preserved and not in unrelated-control E gate. Attention-only swap .19964/.17512, MLP-only .78713/.89626.

All-group final e-coordinate equals donor by algebraic control, but scalar-only full-vocabulary prediction errors .65367/.66960 show changed complementary state matters. Native MLP scalar-write share .8397/.8662 is signed accounting, not causal attribution. Final state bridge rel<=1.40e-7, readoutmax<=4.01e-5, all-portscalarmaxerror .000728. Actual post-result CPU paired audit and two-coordinate feedback counterexample completed. All-swap recovery CIs .8979–.9743/.9790–1.0539; predictionerrorCIs .6487–.6585/.6666–.6729; targetremovalCIs .8783–1.0859/1.1463–1.4044; C absremovalCI .0257–.0630.

Canonical gerund_scalar_write_network has site_live distributed-port claim and separate rejected scalar-only prediction claim; previous terminal-scalar result unchanged. Report2026-09-10/gerund_scalar_writes_and_live_feedback.md linked first in LATEST16:06; MLP17/master dossier updated. All545902902nativeparams remain, no independent producer, broad OOD or model simplification. Next identify context-dependent complementary responses and test broader constructions/controls; do not call a scalar endpoint identity a closed program or add ranks/gains to erase the failure. Actual claimed CPU continuation completed; no successor GPU queued. Full original handoff goal active. Hourly16:14 completed at16:16 safe boundary: three owned native receipts, median gap1485s; CIRCUIT_FOCUS/NOVELTY pass, CEREMONY_BUDGET fails auditability. Existing phase logger now active in RESEARCH_ACTIVITY_2026-09-10_1614.jsonl with prospective starts; no retrospective invented timing. Next hourly17:14/math16:49.

## Shared gerund state: partial transfer and selective removal — 2026-09-10 15:49 UTC

Previous turn PROGRESS0801f08f8; prereg4a4d9bec4 pushed. Original handoff/pilot and user token/structured-unembedding direction. Module/readout, two-circuit weight math, calibration/signed-reader and hierarchy precedents checked. Eight specified raw U_ing-U_bare contrasts define e, no activation fit. Sixteen distinct test verbs in A1/A2, can/may P and reused either/not C. These are paired-answer margins, not greedy top1 accuracy or pretraining-OOD claims.

Managed run_gerund_shared_reader_v1.py SHA81722dc21a791f08de4f7f313da71661ea29bbb95a8897b2a5ee764e88c2e719 ran15:49:03–15:49:06 after Claude's v519;12forwards144seq,1.223576seconds. A instrument/B all64pair capability/E selective zero removal held; C>=.80 state sufficiency and D MLP producer failed. Final scalar recovery .58642/.62148, cross-verb donor cue deltas .58418/.61995; no independent/donor-free command. MLP scalar .07134/.09990, complete MLP .15043/.21065, carried-input scalar .51528/.52152. Q=e-folded bilinear form and explicit final normalization/softcap bridge held; online maxlogiterror2.82e-5.

Zero removal target mean CE+.56461/+.68599, mostly gerund endpoints+1.05567/+1.29308 versus bare+.07355/+.07891. C unrelated meanabsCE .02318 (CI.01699–.02971), scalar swap absCE .01387; can/may scalar swap absCE .04429. P zero-removal meanabsCE .22092 is reported, not E gate; no universal selectivity claim. Paired CPU audit ACTUALLY EXECUTED: final recoveryCIs .5291–.6460/.5587–.6881; removalCIs .4178–.7137/.5040–.8754. Carried raw-scalar delta norm fractions .8774/.8383, MLP .1233/.1622, not behavioral attribution percentages.

Lexical CPU audit ACTUALLY EXECUTED before reading native results, but AFTER the managed job had already ended: heldout mean contrastcos .34862, FIT .57399, old gerund/base clustercontrast .63455. Board15:49:32 entry mistakenly called the job still queued; authoritative runner ended15:49:06. No outcome-dependent e changes. Canonical subroutine.readout.gerund_shared_scalar site_live records partial effect, failed sufficiency and held narrow removal. All545902902nativeparams plus1332865 extra coefficients; no model saving or independent upstream producer. Explanation2026-09-10/shared_gerund_component_from_unembedding.md linked first in LATEST15:49; MLP17 dossier updated. Actual post-result CPU audit is continuation receipt; no next GPU queued. Next scientific target: trace the carried scalar's earlier producers with trained residual-mix and norm semantics intact. Full goal active; next hourly16:14/math16:49.
