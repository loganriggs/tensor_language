...
def main(kind,registered_predictions):
    tag='WEIGHT_STRUCTURAL_BASELINE_V2_'+kind
    ...
    out=P/(tag+'_RESULT.json');assert not out.exists();assert shutil.disk_usage(P).free>=80_000_000,'Insufficient checkpoint headroom'
