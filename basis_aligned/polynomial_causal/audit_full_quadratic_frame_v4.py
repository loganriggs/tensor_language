"""V4 checks memoized exact-Hessian trust regions on independent starts.
...
with Path(__file__).with_name('FULL_QUADRATIC_FRAME_V4_RESTART_AUDIT.json').open('x') as f:
