...
plan=json.loads((P/'FIXED_SUPPORT_PRODUCT_TOY_PLAN_V1.json').read_text());rows=[];t0=time.monotonic()
for case in range(5):
 T,bases,private,maps,templates=fixture(case);metric=FixedSupportProducts(T,bases,private,templates)
 shapes=[]
...
(P/'FIXED_SUPPORT_PRODUCT_TOY_V1.json').write_text(json.dumps(out,indent=2)+'\n');print(json.dumps(out),flush=True)
