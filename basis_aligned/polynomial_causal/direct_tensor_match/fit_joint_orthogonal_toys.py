...
P=Path(__file__).parent;torch.set_num_threads(2);plan=json.loads((P/'JOINT_ORTHOGONAL_TOY_PLAN_V1.json').read_text());rows=[];start=time.monotonic()
for case in range(5):
