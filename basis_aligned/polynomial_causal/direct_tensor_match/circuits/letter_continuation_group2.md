...
## 21 September, 10:00 — Direct component loss and coefficient geometry clarified

Same-prefix all3cache replay passes. Six CPU actual-product readout fits51.4s: primary.1 opened1.52/1.85/14.91%, componentFAIL/coefficientPASS. Fulltrainthird1.89% versusopened14.91%; panelstdsimilar, notdenominatorartifact. Recentlocalcoefficientobjective is calibration-shaped, not nativeisotropic: sourceprimary7.94% versusnativeequalpair59.83%. Exactnativeprojection in fixeddictionarystill59.43%, withnormalresidual<3.3e-15, so outputrefitscannotrepairdictionarynativefidelity. Rawweak128inputaxes gain2.04xopenedenergy; whitening-eigenvector grouping corrected because trainingmatrixidentity. Nextmustchangeinputdirections/graph andexplicitlycomparebothmetrics; no semantic/extraction adoption. [Report](../../explanations/for_logan/research_update_2026-09-21_1000_component_loss_and_metric_correction.md).
...
## 21 September 2026, 10:56 UTC — Shared linear-node graph fails fidelity; layout bound explains limit

Nine fixed-basis/readout-refit programs19.28s, five planted controls and full-width/saved execution checks pass~1e-15. Primarymixed448 uses1,047,116floats/1,036,176source mults vs1,342,028/1,331,088parent; products592unchanged. All3values7.48/4.76/22.77% vs1.34/1.54/10.27%, coefficientnative75.35/cov22.09% vs32.75/6.91. ArithmeticPASS, component/metricFAIL. Actual successorCPU target-onlyspanbound gives necessary631directions for mixedparentnativeguard vsmax460for20%multsaving. No optimizer/basis can meet both in thisdensebottleneck layout; no generalDAG or behavioral bound. Nativeports remain, no fresh claims. [Report](../../explanations/for_logan/research_update_2026-09-21_1056_shared_linear_graph_and_limits.md).

## 21 September 2026, 11:09 UTC — Local overlapping reader sharing fails; fixed-span relaxation completed

Four CPU fits14.99s, primarycov128/160 keeps1152products buttotal source mults986496vs1330560 andfloats996876vs1340940. Components13.62/10.41/47.90%vs1.87/2.05/8.81%; nativecoef99.45/cov37.47%. Instrument/arithmeticPASS, component/metricFAIL. Actual successorCPU dense-core projection ineachfixed352span improvescovcoef13.64%, values4.00/3.06/14.85%, stillfailsbaseline; not a component-error lowerbound or cheap program. Fixed learned-product architecture andchosen spansbothlimitthis construction; jointlylearneddirectionsuntested. Tensor-viewpackingbugcorrectedforbothcurrentgraphfamilies, bitwisevaluesunchanged; physicalfloatstorage nowmatcheslogicalprice. [Report](../../explanations/for_logan/research_update_2026-09-21_1109_overlapping_local_reader_graph.md).

## 21 September 2026, 11:32 UTC — Joint directions improve the program, not stable circuit identity

ToyV1fails2of5recovery; equal1800stepV2Muon.03passes5of5vsAdam3of5. Four nativefits238.92s, primarycovwarm values2.41/2.44/13.53%, native61.34/cov8.22%; instrument/arithmeticPASS, component/metricFAIL. Independentdecode/autodiff/storage audit<6.3e-15. Near-costpair284:994740floats/984060mults vs996876/986496graph; covbaseline third11.34%better than13.53%. Actual successorCPUsharedidentity: total-source cos.9991(cov), sharedbranchcos.3273; isotropic.9722/.4592. Centeredsharedremoval primarythird98.08%showsutility, notidentity/semantics. Fivegaugecontrols pass. Actual nextCPUcross-slot topology audit: old0directshared/private sourceproducts, proposal158/160/131sameprice; fivefixed-subspacecrosscontrols pass. Proposalnotfitted, fullgoalunmet. [Report](../../explanations/for_logan/research_update_2026-09-21_1132_joint_graph_fit_and_identity.md).
