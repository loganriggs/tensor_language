...
from profiled_mixed_products import profiled_loss
...
(P/('PROFILED_MIXED_PRODUCTS_CHECK_V1.json' if args.only_case is None and args.steps==2000 else f'PROFILED_MIXED_PRODUCTS_CASE{args.only_case}_STEPS{args.steps}_RATE{args.learning_rate}_SEED{args.restart_seed}_V1.json')).write_text(json.dumps(out,indent=2)+'\n')
