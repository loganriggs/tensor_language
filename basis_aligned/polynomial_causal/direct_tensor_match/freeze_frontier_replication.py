...
meta=json.loads((P/'FRONTIER_FRESH_ROWS_V2.json').read_text());previous=[]
for name in ['SHARED_MODE3_FRESH_ROWS_V1.json','SHARED_MODE3_SECOND_ROWS_V1.json','PARTIAL_GRAPH_FRESH_ROWS_V1.json','PARTIAL_GRAPH_FRESH_ROWS_V2.json','COMPACT_GROUP_FRESH_ROWS_V1.json','DUAL_FRESH_ROWS_V1.json','FRONTIER_FRESH_ROWS_V1.json']:previous+=json.loads((P/name).read_text())['fineweb_documents']
...
tokens=torch.load(P/'FRONTIER_FRESH_TOKENS_V2.pt',weights_only=True);donors={};stats={}
...
file=P/'FRONTIER_FRESH_DONORS_V2.pt';torch.save(donors,file)
files=['FRONTIER_FRESH_GRAPH_V1.pt','FRONTIER_FRESH_BASELINE_CALIBRATION_SHAPED_V1.pt','FRONTIER_FRESH_BASELINE_NATIVE_ISOTROPIC_V1.pt','PARTIAL_GRAPH_ORIGINAL_FORMS_V1.pt','FRONTIER_FRESH_DONORS_V2.pt','pairwise_component_interface.py','pairwise_reader_graph.py','quadratic_pair_blocks.py','source_interface.py']
