"""Same five planted structures and schedules; exact conditional output weights."""
from pathlib import Path
import json,time,torch
from learned_quadratic_factors import controls,dense
from profiled_learned_quadratic_factors import fit
p=Path(__file__).resolve().parent;out=p/'PROFILED_FULL_QUADRATIC_TOYS_V1.json';assert not out.exists();torch.set_num_threads(2);start=time.monotonic();check=controls();records=[]
