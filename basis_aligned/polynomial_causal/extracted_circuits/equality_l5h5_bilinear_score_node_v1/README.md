...
`score = dot(q1,k1)/128 * dot(q2,k2)/128`.
...
sparse grid of pair interactions.  The package does not yet extract the native
linear projections or the residual sources feeding those projections.
