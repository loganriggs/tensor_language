...
53 sequence tokens are supported; others are rejected. CPU and isolated replay pass; native readout check pending. Fresh formula evidence is CITY_FULL_FRESH_V1_RESULT.json. Composition and corpus/token-only claims remain open.
