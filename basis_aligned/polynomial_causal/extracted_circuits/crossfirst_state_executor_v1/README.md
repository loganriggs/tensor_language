...
Next validation: physical composition of parent, child and retained remainder at the head9 output interface. [HIERARCHY.json](HIERARCHY.json) records the weight-verified containment and the no-double-removal rule. Preserve every prior failed generalization/control criterion.
