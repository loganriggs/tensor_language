...
from city_attention7_subset_v1 import execute as attention7
from city_mlp7_readers_v1 import execute as readers

def execute(program,residual6,token_ids,city,destination,return_queries=False,heads=tuple(range(9))):
    generated=attention7(program['attention7'],residual6,token_ids,heads=heads)
