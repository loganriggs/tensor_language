"""Shared frozen FineWeb selection rules with explicit streaming-iterator cleanup."""
from pathlib import Path
from datetime import datetime,timezone
import hashlib,json,itertools,re
import tiktoken
P=Path(__file__).resolve().parent;STEM='REGIONAL_FINEWEB_SELECTOR_V3'
...
def main():
 ...
 iterator=iter(ds)
 try:
  for di,doc in enumerate(itertools.islice(iterator,MAX_DOCS)):
