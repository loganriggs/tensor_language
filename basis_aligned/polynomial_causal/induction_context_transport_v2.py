...
def main():
    ...
    result_path = poly / 'INDUCTION_CONTEXT_TRANSPORT_V2_RESULT.json'
    ...
    output_rows = poly / 'INDUCTION_CONTEXT_TRANSPORT_V2_ROWS.jsonl'
    with output_rows.open('x') as f:
        for row in scalar_rows:
            f.write(json.dumps(row, sort_keys=True) + '\n')
    result = dict(experiment='induction_context_transport_v2', evaluated_split='FIT',
