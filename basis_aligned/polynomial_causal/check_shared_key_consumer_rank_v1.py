...
from shared_key_consumer_rank_v1 import compile_program,scalar
...
def main():
 ...
 out={'records':records,'orthogonality_error':ortherror,'baseline_program_scalars':size(full),'scope':'Exact SVD of stacked two-consumer weights, not data fit. Paired scalar effects versus same rank64-transport program, existing72prompts. No fresh/native-logit/semantic-selectivity claim.'}
 (P/'SHARED_KEY_CONSUMER_RANK_V1_CONTROL.json').write_text(json.dumps(out,indent=2)+'\n');print(json.dumps(out,indent=2))
