...
import numpy as np
import torch
from shared_reader_variable_projection_v1 import Objective
...
def planted(seed=2901):
    torch.manual_seed(seed);d,r,m,o=9,3,3
...
def main():
    ...
    (Path(__file__).parent/'SHARED_READER_VARIABLE_PROJECTION_V1_CONTROL.json').write_text(json.dumps(result,indent=2)+'\n')
