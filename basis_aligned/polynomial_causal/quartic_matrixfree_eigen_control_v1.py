...
import numpy as np
import torch
from quartic_matrixfree_eigen_v1 import SymmetricCoordinates,eigenmatrices
...
d=8;coordinates=SymmetricCoordinates(d)
...
out=Path(__file__).with_name('QUARTIC_MATRIXFREE_EIGEN_V1_CONTROL.json');assert not out.exists()
