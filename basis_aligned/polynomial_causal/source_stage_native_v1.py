"""Shared source-stage execution with optional factored prefix-memory context."""
...
def run(backend,world,ids,delta=None,native=None,memory_pair=None):
    ...
    for start in (0,16):
        ...
        try:
            ...
            if memory_pair is None:memory_chunks.append(memory)
