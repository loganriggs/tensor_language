...
### 3.1 The downstream MLP read was not sparse in its own hidden-unit basis
...
The important correction was that activation energy was the wrong target. An in-sample rank-4 subspace captured about
...
### 3.2 Attention block 5 is unusually simple geometrically

Across natural text, removing attention block 5 costs about 2.20 nats of cross-entropy, making it an unusually
important component. Its output write is 98.1% concentrated in one direction, the most one-dimensional write among
