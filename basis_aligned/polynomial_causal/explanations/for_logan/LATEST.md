[24 September 05:40 — Circuits on bilin18, closed + held-out check: transport heads 9.8/9.7/8.2 (OV side) and the block-17 read-out funnel transfer to fresh FineWeb contexts (0.52 / 0.67 removed); the 30-unit creator lists do not (0.18 → 0.06) — creation is fixed unit forms contracted with the context's transport, spread over hundreds of units; answers on what the 100 directions are and how shared the heads/units are at the end](research_update_2026-09-24_circuits.md)
...
**Previous regional update: [18 September — Selective city interchange](research_update_2026-09-18_0235_city_interchange.md).** Fresh prediction/selective swapping pass; standalone two-prefix export cuts native state31%. Independent composition remains unresolved.
