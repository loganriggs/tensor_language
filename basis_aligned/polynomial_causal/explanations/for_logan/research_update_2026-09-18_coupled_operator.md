...
| Extracted executable interface | fold + isolated replay | 80 fresh fixtures | exact declared support; 702-token table; isolated replay passes | established boundary |
...
- [Coupled fold result](../../CITY_MLP8_COUPLED_VALUE_V1_CPU_RESULT.json), [isolated replay](../../CITY_MLP8_COUPLED_VALUE_V1_ISOLATED_RESULT.json), and [package manifest](../../extracted_circuits/city_mlp8_coupled_value_v1/manifest.json).
