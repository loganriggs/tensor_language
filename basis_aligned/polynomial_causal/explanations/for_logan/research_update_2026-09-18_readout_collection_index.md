...
| number (agreement) | 5.7, 7.8, 9.7 + 11.3 | lexical were/was (within scope), perfect have/has | yes ×2 | yes / yes ×2 (were/was fails the tense-reader gate on natural rows, and orthogonalizing against tense does not fix it: v138–v141) | have/has no: 60%, MLP 9–17 relay | adjacent-subject case MLP-borne; have/has over-additive (11.3 dominant) |
