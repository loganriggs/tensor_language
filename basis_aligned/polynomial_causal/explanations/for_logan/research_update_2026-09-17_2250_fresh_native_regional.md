...
| Extracted | Earlier conditional head8/head9 package is standalone at three native inputs. The broader coupled head8/MLP8 prototype has three inputs and about17million floats; only its CPU learned-weight formula check has passed. Native bundle certification is next. |
