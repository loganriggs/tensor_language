...
**Scope.** Two behaviours, one fresh panel each, head grain. Not yet: random-set nulls, natural rows, response census,
source folds. Scorecards: `basis_aligned/claude_hourly_review/SELECTION_DOD_SCORECARD.md`,
