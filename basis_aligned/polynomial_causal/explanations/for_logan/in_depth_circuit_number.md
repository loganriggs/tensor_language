...
layer-matched random null, with the upper four (1036, 2483, 1779, 829) alone at 11% and the MLP-3 pair adding its 3–4% roughly additively. On the 128 natural sentences (v371) the same six cost 8.8% of the labelled-pronoun margin (60× the null; the upper four 7.8%).
