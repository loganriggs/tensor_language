...
RESULT=HERE.parents[2]/"bilinear_quotient/circuits/fast_screens/setting2_regional_qk1_value_interaction_attribution_v1_result.json"
OUT=HERE/"assets/research_update_2026-09-15_routing_value_composition.png"

data=json.loads(RESULT.read_text())["family_reports"]
labels=("Routing", "Value", "Joint", "Factorial\ninteraction", "Explicit\nhead cross")
keys=("routing_target_rms", "value_target_rms", "joint_target_rms", "interaction_target_rms", "explicit_cross_target_rms")
...
ax.set_title("The explicit head9.8 cross term explains the recursive interaction")
