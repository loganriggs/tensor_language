...
**Latest graph edit — [Overlapping dictionaries with private paths](research_update_2026-09-21_1109_overlapping_local_reader_graph.md).** About26%source arithmetic saving, but component fidelity fails. A dense-core diagnostic isolates both subspace and product restrictions; unused tensor backing storage was corrected without changing any values.
...
**Latest — [Random starts recover functions, not product identities](research_update_2026-09-21_0811_random_discovery_and_identity.md).** Eight direct fits recover comparable source approximations at fixed cost; internal atoms remain unstable. Downstream readout correction and a finite product-rotation explanation fail their registered targets.
...
**Latest — [Mixed products and graph reuse](research_update_2026-09-21_0707_mixed_products_and_graph_reuse.md).** Two components improve, the third fails; fixed-dictionary sharing survives stronger controls; an explicit graph edit is being refitted.
...
**Previous requested update: [15 September, 03:46 UTC — Regional weight folding to QK interactions](research_update_2026-09-15_0346_regional_weight_folding.md).** A task-matched unembedding-to-MLP17-to-MLP16 path converges on head9.8, then separates its QK carry/attention8/MLP8 interactions. Includes definitions, equations, plots, limits, and a reproducibility appendix.
...
**Previous: [13 September, 02:55 UTC — A compact predictor of a circuit interaction](research_update_2026-09-13_0255_joint_attention_predictor.md).** High-level rundown, explained equations, fresh prediction results, mathematical-cycle contribution, limits and next steps.
...
**Previous: [12 September — Critical review, counter-review and best ROI](method_redteam_and_roi_2026-09-12.md).** Includes additions through 23:44 UTC.
