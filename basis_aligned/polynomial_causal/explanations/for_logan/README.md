...
**Latest requested update: [15 September, updated through 05:34 UTC — Subject response and a compact regional interaction path](research_update_2026-09-15_0430_subject_response_interaction.md).** The native L11H3 coordinate requires an interaction with its MLP6/7 response; the regional path now has an exact late-group QK1 fold, fresh causal removal, and downstream response census. Includes definitions, display equations, four graphs, limits, and a reproducibility appendix.
