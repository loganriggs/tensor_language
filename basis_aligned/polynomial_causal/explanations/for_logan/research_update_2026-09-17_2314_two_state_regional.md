...
```mermaid
flowchart LR
 R[Native recipient residual7 and donor-city residual7] -->|fold: two arrays, opened replay| B[Block8 reentry and normalization]
 T[Token IDs and weight-derived tables] -->|fold: 74 supported sequence tokens| B
 B -->|fold: complete native products| A[Full attention8 and retained head8.2 write]
 A -->|fold: coupled skip and MLP8 response| D[Change entering block9]
 D -->|edit: 18–29% attenuation, fresh panel| S[External native suffix to UK/US spelling]
 linkStyle 0,1,2,3 stroke:#2471a3
 linkStyle 4 stroke:#238b45
```
