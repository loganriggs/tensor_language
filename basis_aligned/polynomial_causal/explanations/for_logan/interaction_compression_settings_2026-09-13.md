...
Requested direction, 13 September 2026. **Status at 07:12 UTC: campaign underway.** Initial interaction fits, a small exact graph simplification, full-U shared/private fits and sparse-core baselines have completed; see the progress note below. This supersedes the previous restriction against compression as a primary task. Discover structure from weights first, then validate on text. Earlier failed fits remain relevant controls.
