...
**Latest results and explanation, 21:43:** [Unsupervised structure campaign](unsupervised_structure_campaign.md). Shared input factors transferred across corpus panels, but their physical MLP17 replacement failed prediction-preservation thresholds: shared-refit top1 agreement87.65%, mean CE damage+0.05879. Controls held exactly. A probability/RMS diagnostic is queued to red-team the metric mismatch; matched normal-equation/QR nonlinear refinement is running. No circuit adoption or new convergence claim.
