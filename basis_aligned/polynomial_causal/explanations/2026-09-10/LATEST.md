...
**Newest optimizer result, 22:28:** [Signed-square fit and stopping mismatch](unsupervised_structure_campaign.md#signed-squares-finished-stopping-mismatch-identified--2228-utc). Signed squares reached9.645% coefficient capture but remained unconverged. CPU audit found L-BFGS's absolute-gradient stop satisfied while our relative convergence test fails; raw reader norms are53–2037. The next step is a function-preserving parameter normalization and tighter internal stopping tolerance. No native polish has run yet.
