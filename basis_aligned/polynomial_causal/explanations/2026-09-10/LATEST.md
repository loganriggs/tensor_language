...
**Newest update, 23:06:** [Restart disagreement and broader block conditioning](unsupervised_structure_campaign.md#restart-disagrees-broader-block-conditioning-repaired--2306-utc). Both sparse-frame runs converged, but the second has lower capture (3.29% versus 3.67%) and function cosine0.796; reproducibility failed. An exact conditioning repair now preserves the broader block model's function and penalty, preparing its next optimization. The23:00 math summary remains below; no identified circuits or new data fitting.
