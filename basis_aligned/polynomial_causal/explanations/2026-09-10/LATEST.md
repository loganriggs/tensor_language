...
**Latest answers and results, 21:20:** [Million-token weighting, optimizer details, literature and measured costs](unsupervised_structure_campaign.md#your-questions-one-million-tokens-optimization-and-cost--2114-utc). The explicit cancellation-penalty weight fit **converged locally in57s**, retaining99.56%of the old captured energy. Natural shared-reader validation error is1.94% versus affine3.16%, but that fit remains unconverged. The1,048,576-token Pile capture **completed in27.74s**, allchecksheld; fitting on the new panel is pending. The appended section distinguishes preparation, completed runs and proposed optimizer upgrades.
