...
**Newest update, 23:00:** [Sparse-frame convergence and mathematical review](unsupervised_structure_campaign.md#sparse-frame-converged-what-the-math-review-establishes--2300-utc). The weight-only sparse frame converged at3.67% token-contrast capture, missing the5%target. Spectral recovery verifies identifiability of the fitted square tensor under checked numerical ranks; native boundary-energy checks show extraction still needs substantial external connections. An independent sparse-frame restart is queued. No data fitting or circuit promotion.
