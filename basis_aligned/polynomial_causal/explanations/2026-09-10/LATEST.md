...
**Current update, 22:15 — weight-first:** [Joint Gauss–Newton implementation and benchmark](unsupervised_structure_campaign.md#joint-gaussnewton-implemented-and-queued--2215-utc). Exact small Jacobian and step-acceptance controls pass; native benchmark queued behind the live multi-output block fit. Earlier ALS passed numerical checks but failed convergence/reference quality. Signed squares remain prepared, not submitted. Most structural hypotheses remain untested; no new data fitting.
