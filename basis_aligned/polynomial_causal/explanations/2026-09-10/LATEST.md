...
**Newest update, 22:47:** [Native sparse-frame optimization](unsupervised_structure_campaign.md#native-sparse-frame-optimization-queued--2247-utc) is queued. Riemannian conjugate-gradient and exact-resume controls pass; native results are pending. This learns both the shared input subspace and its orientation for sparse interactions. Signed squares remain locally converged at9.645% capture. No data fitting or identified circuits.
