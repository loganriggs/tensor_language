**13 September, 05:01: interaction compression campaign underway.** [Three settings, criteria and initial results](../for_logan/interaction_compression_settings_2026-09-13.md). Fixed-class baselines are weak; an exact retained-graph rewrite saves 0.51% of core multiplications. Learned output-block fits converge with only modest gain and a contrast tradeoff. Shared global/local full-U structure now has an executed pricing/bound analysis; its native fit remains pending.
