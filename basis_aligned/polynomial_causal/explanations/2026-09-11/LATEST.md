**13 September, 08:28: shared output-subspace fit reaches coordinate tolerance but fails own-effect preservation.** At4.88MB, coefficient error12.48%; regional own-term errors exceed10%in two groups despite compact-predictor error<0.42%. Exact audit finds2.23%pair-sum versus32.0%spelling-difference error. Sparse edges remain the stronger tested local storage/behavior baseline. [Method and results](../../INTERACTION_SHARED_WRITES_V1_MATH.md) · [Hourly review](../../HOURLY_STRATEGIC_REVIEW_2026-09-13_0824.md).
