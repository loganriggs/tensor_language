...
Current overview: [QR, decomposition and arithmetic circuits](for_logan/research_update_2026-09-21_0104_full_coverage_and_shared_baselines.md). Latest follow-up: [shared linear graph edits and capacity limits](for_logan/research_update_2026-09-21_1056_shared_linear_graph_and_limits.md).
...
**Latest regional update: [18 September — Fresh one-input removal](for_logan/research_update_2026-09-18_0014_one_input_removal.md).**

**Previous regional update: [18 September — Removal sign failure](for_logan/research_update_2026-09-18_0003_removal_sign_failure.md).**

**Previous regional update: [17 September — Fresh single-head response](for_logan/research_update_2026-09-17_2348_single_head_fresh.md).**

**Previous regional update: [17 September — Normalization screen](for_logan/research_update_2026-09-17_2341_normalization.md).**

**Previous update: [17 September — Two-state regional executor](for_logan/research_update_2026-09-17_2314_two_state_regional.md).**
...
**Latest full update: [13 September — Final compression update](for_logan/research_update_2026-09-13_final_compression.md).**
...
- [explanation_2026-09-04_0917.md](explanation_2026-09-04_0917.md) — task 14's independently audited 97.3% native
  ...
  interaction plan; the independent block showing that local head morphology could fake the first design, plus the
  active complete-subject-transfer repair; the post-identification bilinear weight equations; and the separate
  42.55-million-parameter frontier-price result without mistaking it for circuit identification
...
- [explanation_2026-09-04_0630.md](explanation_2026-09-04_0630.md) — full update since 04:21: task 17's valid native
  ...
  cutoffs; the planned full 21-candidate response and causal weight translation; and a clearly separated diagnostic
  numeric-roundness direction plus the current pre-execution boundary
...
- [explanation_2026-09-03_1652.md](explanation_2026-09-03_1652.md) — robust-circuit update: R549's audited
  ...
  organization intended to scale without duplicate circuit work
- [explanation_2026-09-03_1642.md](explanation_2026-09-03_1642.md) — where the price of shrinking the writes lives (§2694/§2696): variance rank does not
  predict causal use, the early MLPs 0–3 carry 59% of the single-site price, blocks 7–17 read a thin slice; plus the §2697
  red-team of R549's .011-margin strong null
...
- [explanation_2026-09-03_1248.md](explanation_2026-09-03_1248.md) — rung532's audited result: all four observed
  ...
  rung533's matched-control test of a branch-exchangeable equality family on natural text and code
...
- [explanation_2026-09-03_0005.md](explanation_2026-09-03_0005.md) — rung512's valid first-consumer null:18/42
  ...
  and the exact `Q/K/Q2/K2/value` interaction-basis successor
...
- [explanation_2026-09-02_1500.md](explanation_2026-09-02_1500.md) — attention1 identified as the unique exact named
  ...
  sufficient, and explains the active selective-reader versus full-attention1-knockout test
...
- [explanation_2026-09-02_0512.md](explanation_2026-09-02_0512.md) — full update since 04:31: exact MLP product
  ...
  rung470 finding that distance/count/position predict code averages but not individual or natural effects, the
  paired downstream-response rung471 successor, and the active-loop safeguard
...
- [explanation_2026-09-01_1957.md](explanation_2026-09-01_1957.md) — complete update since 18:07 covering rungs
  ...
  carrier, payload, and overlap computationally, specify both sparse Q/K extensions, and give the evidence ladder
  from continuous identification through executable simplicity to causal semantics; sections 16–17 report both
  sparse extensions, including the positive cross-head vocabulary, score-coupling gain, sparse atom-pair
  concentration, and the restart instability that prevents individual semantic names
...
- [explanation_0501.md](explanation_2026-09-03_0501.md) — the MLP10 estimation-power chapter (§2657–§2661): why grouping nulled (fingerprint reliability 0.016), pooling recovers a reliable source-shared 3-dim summary, the document/pooling budget, no reliable private residual, and the shared summary feeds block-6 circuits
- [explanation_0632.md](explanation_2026-09-03_0632.md) — full R521/R522 update: why whole attention8 is reliable but broad, the exact projected-swap computation, the passing 19.86 GB instrument smoke, the 103-frame TEST seal, and the constrained-permutation proof that replaced an impossible 90% label-null rule
- [explanation_0726.md](explanation_2026-09-03_0726.md) — the MLP10 chapter's honest close (§2657-§2668): fingerprints are noise, pooling recovers a real ~3-dim shared subspace, but two self-corrections (block-6 base-rate, rung521 broad-not-N) and a prequential-MDL red-team show it captures only ~12% of effect energy and saves ~0 bits — little compressible structure at current N
- [explanation_0908.md](explanation_2026-09-04_0908.md) — §2858–§2873: the control that was measuring itself, the repair, three of my own accounts withdrawn, and the pivot to the frontier (reproduction gate +2.6736 vs +2.6735)
...
- [Conditional three-source quadratic observable](../SEMANTIC_SOURCE_QUADRATIC_JET_2026-09-20.md): validated native derivatives predict unit/negative/mixed effects below10%, doubled edits fail37.16%. Signed rank-one baseline also passes first three arms but directions vary across contexts.192-context CPU coefficient extraction passes; native coefficient generation remains required. v1 precision-invalid and v2 missing-bias-invalid preserved.
...
- [research_update_2026-09-20_2121_cross_bank_and_output_metric](for_logan/research_update_2026-09-20_2121_cross_bank_and_output_metric.md) — Cross-bank optimization qualification and common-logit artifact audit.
