...
The active GPU continuation is rung488. A pass licenses the native-state-dominance falsifier before extraction and
selective-swap tests; a failure sends the MLP0 work to separate within-branch finite-response models. No rank sweep is
on either route.
