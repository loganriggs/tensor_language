...
from thin_stiefel_v1 import manifold_for
...
def control():
    ...
    with Path(__file__).with_name('BLOCK_TRUST_REGION_V3_CONTROL.json').open('x') as f:json.dump(result,f,indent=2);f.write('\n')
