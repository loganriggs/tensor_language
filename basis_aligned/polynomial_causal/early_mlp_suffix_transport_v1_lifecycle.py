...
NUMERICAL_STAGE_CLOSURE = (
    ...
    HERE / "early_mlp_suffix_transport_v1_observational_role.py",
    ...
    HERE / "early_mlp_suffix_transport_v1_diagnostic_integration.py",
    HERE / "test_early_mlp_suffix_transport_v1_diagnostic_integration.py",
    HERE / "early_mlp_suffix_transport_v1_production_callback.py",
    HERE / "test_early_mlp_suffix_transport_v1_production_callback.py",
)
FROZEN_SHA256 = {
