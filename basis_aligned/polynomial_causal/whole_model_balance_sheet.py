        ...
        "ranked_actions": [
            {
                ...
                "why": "The v1 affine executable predicts the original-minus-plank residual from z alone even though the live plank output mo contains token/context state not determined by z. Its descriptive global-CE path fails all statistical gates despite individually audited integrity checks and approximate gauge stability: NQN loses 0.0982 nats, QQN loses 0.0505, and local MLP1 R2 of 0.341 does not translate causally. The next rung should separate missing state, wrong Euclidean loss, and wrong grammar while exploiting the exact bilinear tensor.",
            },
            {
                "priority": 2,
