...
def main():
    ...
    for old in previous:
        ...
        rows.append(dict(tolerance=old['tolerance'],discarded=k,retained=1152-k,
    ...
    (P/'INTERACTION_COORDINATE_COMPLEMENT_V1_RESULT.json').write_text(json.dumps(result,indent=2)+'\n')
