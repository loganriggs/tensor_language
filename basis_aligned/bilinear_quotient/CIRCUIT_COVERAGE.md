...
| `task.numbered_list.index_successor` | specified | held | — | — | — | — | held | planned | — | run the registered R573 v2 price-only repair; do not represent it as an independent blind replication |
