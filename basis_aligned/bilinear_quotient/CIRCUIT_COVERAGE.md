...
| `task.numbered_list.index_successor` | specified | held | — | — | — | — | held | — | — | run raw-row R572 confirmation of the list +2 conflict, then preregister exact L8H7/L8H3 value-path ceilings |
