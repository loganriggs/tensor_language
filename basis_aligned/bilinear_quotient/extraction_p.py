# extraction_p: EXTRACTION PROPERTY, PRONOUNS (clone of extraction_q;
# assumption registered: same design and bars port to the harder late-site
# class whose heads are less selective (42x vs 186x) (the third
...
OUT = PT + 'extraction_p_results.json'
NR = 960
H = m.transformer.h
...
def main():
    ...
    CLS = {'pronouns': rx(r'^ (he|she|they|He|She|They)$')}
    SITES = {'pronouns': 17}
