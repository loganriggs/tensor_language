"""v61: why is dative's OOD (A2) removal weak -- the direction or the set?
...
OUT = ROOT / "circuits/followups/unit_dative_ood_direction_v61_result.json"
NAME = "dative"
...
def _plan():
    return {"candidate_id": "corpus.unit_dative_ood_direction_v61", "set": v23.SETS[NAME][1],
...
def main() -> None:
    ...
    result = {"predictions": predictions, "schema": "circuit_unit_dative_ood_direction_result_v1", "candidate_id": "corpus.unit_dative_ood_direction_v61",
