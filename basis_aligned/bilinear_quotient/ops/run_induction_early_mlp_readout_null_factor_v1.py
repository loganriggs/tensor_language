...
p=prior.p
ROWS=prior.ROWS; PREREG=POLY/'INDUCTION_EARLY_MLP_READOUT_NULL_FACTOR_V1_PREREGISTRATION.md'; BINDING=POLY/'INDUCTION_EARLY_MLP_READOUT_NULL_FACTOR_V1_BINDING.json'; OUT=POLY/'INDUCTION_EARLY_MLP_READOUT_NULL_FACTOR_V1_RESULT.json'
