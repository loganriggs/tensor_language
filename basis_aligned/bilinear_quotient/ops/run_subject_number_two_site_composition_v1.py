...
ROWS = POLY / "SUBJECT_NUMBER_TWO_SITE_COMPOSITION_V1_ROWS.json"
RANK1 = POLY / "SUBJECT_NUMBER_DIRECTION_CARDINALITY_RANK1_V1_ARTIFACT.json"
PREREG = POLY / "SUBJECT_NUMBER_TWO_SITE_COMPOSITION_V1_PREREGISTRATION.md"
...
BINDING = POLY / "SUBJECT_NUMBER_TWO_SITE_COMPOSITION_V1_BINDING.json"
OUT = POLY / "SUBJECT_NUMBER_TWO_SITE_COMPOSITION_V1_RESULT.json"
...
def plan():
    ...
    return {
        "schema": "subject_number_two_site_composition_v1_plan",
        "model_loaded": False,
        "gpu_accessed": False,
        "queue_touched": False,
        "rows": rows["row_count"],
...
def main():
    ...
    result = {
        "schema": "subject_number_two_site_composition_v1_result",
        "terminal": terminal,
