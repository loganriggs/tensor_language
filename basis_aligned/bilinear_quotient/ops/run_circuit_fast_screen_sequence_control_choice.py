...
import circuit_fast_screen_candidate_sequence_control_choice as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_sequence_control_choice_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/numeric_sequence_control_choice_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "numeric-sequence-control-choice-v1"
EXPERIMENT_ID = "fast-screen-numeric-sequence-control-choice-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "65af0c92b39efa860fb4035902ac307e2ad85547259d91ce0b2756effe858716"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "bd0089f468b92a1855d76734c5e7215adc61ce8280e258c72d540e0648b9e442"
)
