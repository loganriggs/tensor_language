...
"""Frozen hybrid output formula on48 fresh noun/syntax combinations.
...
OUT=ROOT/'basis_aligned/bilinear_quotient/circuits/followups/subject_attention_freeze_v687_result.json'
