...
import circuit_fast_screen_candidate_degree_result as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_degree_result_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/degree_result_too_vs_so_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "degree-result-too-vs-so-v1"
EXPERIMENT_ID = "fast-screen-degree-result-too-vs-so-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "4a26c9e4f7bf4b1d01bee31a27ce5028a6c38da29fe4aa0782c1d0e9de0997da"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "c9f28fe91f9fe7683a38a46749000358cf1c096f7676cff6d2434e454ab1fbab"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="which degree word licenses the result clause",
    proposed_operation="carry the degree word across the adjective in two constructions",
