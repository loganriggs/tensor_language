...
"""Pronoun number they/he DoD (v199): the MLP-6 stage OUT OF THE PANEL. Zero the three MLP-6 units {2483, 2826, 4131} (v182: 57% of MLP 6's part of the plural
detector 829; v196 in-panel edit: 829 -6.3%, margin -0.67%, 29x the null) at the CUE position of the same 128 natural rows as v197 and read the label
margin at the final token; v197's design otherwise (congruent / incongruent cells, 16 random 3-unit sets of MLP 6 at the cue, number-free readers).
Bars set from v196: the in-panel margin effect was 0.7%, so LIVE here is registered at 0.005 (v197's MLP-8 trio: 3.3%).
...
OUT = ROOT / "circuits/followups/pronoun_number_dod_mlp6_units_natural_v199_result.json"
...
CANDIDATE_ID = "pronoun_number.they_vs_he.dod_mlp6_units_natural_v199"
LAYER, UNITS, CONGRUENT = 6, (2483, 2826, 4131), ("natural_plural_they", "natural_singular_he")
NULL_SEEDS = tuple(range(7951, 7967))
