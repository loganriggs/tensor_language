...
if __name__=='__main__':run('data_product_s0',0,RUNNER,POLY/'STRUCTURED_FIT_V1_data_product_s0_C00_BINDING.json',dry=bool(os.environ.get('BQLIB_DRYRUN') or os.environ.get('BQLIB_NO_MODEL')))
