...
we're seeing what we're seeing'). MODEL = EleutherAI/pythia-70m (softmax, ROTARY on a quarter of each head, GPT-NeoX tokenizer;
...
step-0 10 + 300 + validation 39 + held-out 91 + snapshot 9) = 950; manipulability 168; per-head ablations scale with the head count; bar set per model. Bars: forwards <= 1600, backwards <= 600.
"""
...
FORWARDS_MAX, BACKWARDS_MAX = 1600, 600
