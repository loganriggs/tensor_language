...
"""Export conditional response program with explicit context output encoders.
...
OUT=ROOT/'basis_aligned/bilinear_quotient/circuits/followups/subject_joint_chain_v659_result.json'
...
def main():
    ...
    artifact=OUT.parent/'subject_response_v659_program.pt'
