...
STEM='ODD_FRAMING_ROLE_SPLIT_NATIVE_V1';ARM_ORDER=['native','remove_odd_description','remove_odd_instruction','remove_odd_framing','remove_all_odd']
...
def main():
    ...
    if os.environ.get('BQLIB_DRYRUN') or os.environ.get('BQLIB_NO_MODEL'):
        ...
        print('240bodyforwards;48 frozen prefixes; CPUcontrol',cpu_control());return
    ...
    def hook(module,args,output):
        ...
        selected={1:pieces['description'],2:pieces['instruction'],3:pieces['framing']}.get(arm)
