...
"""Sparse symmetric Tucker on the joint C,A,B tensor vs independent matrix decomposition (v613; Logan's redirect, 19-20 Sep). Supersedes v609/v611:
...
OUT = ROOT / "circuits/followups/joint_tensor_tucker_fit_v613_result.json"
CANDIDATE_ID = "tucker.joint_tensor_fit_v613"
KS = (16, 32, 64)
...
def main() -> None:
    ...
    payload = {"schema": "joint_tensor_tucker_fit_result_v613", "candidate_id": CANDIDATE_ID, "plan": plan,
