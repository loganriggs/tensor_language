...
"""Perfect-number have/has reuse census (v50): blind readout sweep + top-4 set on the line's authored A1/A2 contexts (opened
...
PRICE (registered maximum): 362 forwards; bar <= 380."""
...
if __name__ == "__main__":
    R.run("perfect_number.have_vs_has.dod_reuse_census_v50", "perfect_number_dod_reuse_census_v50_result.json", rows, pos, neg)
