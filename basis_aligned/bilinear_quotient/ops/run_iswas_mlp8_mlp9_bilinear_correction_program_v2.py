...
PRIOR = ROOT / "circuits/prior_art/iswas_mlp8_mlp9_bilinear_correction_program_v2.json"
...
V1_RESULT = ROOT / "circuits/followups/iswas_mlp8_mlp9_bilinear_correction_program_v1_result.json"
V1_RUNNER = ROOT / "ops/run_iswas_mlp8_mlp9_bilinear_correction_program_v1.py"
...
OUT = ROOT / "circuits/followups/iswas_mlp8_mlp9_bilinear_correction_program_v2_result.json"
CANDIDATE_ID = "cross_task.iswas_mlp8_mlp9_bilinear_correction_program_v2"
FACTORS = ("left_change", "right_change", "bilinear_interaction")
EXPECTED = {"prior": "93e9252ef1b08df40d790485ef03d2bd8a3d69c43f4bba3d283416bbbbbc99e3", "direct": "ee569e6cbf16a84dfcb615fc08c6c633d92a4854a867f054dc117af92bf41090",
    ...
    "v1_result": "05b0dbdc41089fdc27b743fc3064f2732ad7378f027bf824bbc18c80d2f9fd35",
    "v1_runner": "40609971d922583c194c2c64eeda476b6bfe96c25361217337a2ee6cf96b3567"}
...
def main():
    ...
    prior, direct, atlas, greedy, capability, subspace, v1_result = [json.loads(path.read_text())
        for path in (PRIOR, DIRECT, ATLAS, GREEDY, CAPABILITY, weight.SUBSPACE, V1_RESULT)]
    ...
    if (prior.get("candidate_id") != CANDIDATE_ID or direct.get("terminal") != "null"
            ...
            or v1_result.get("terminal") != "bilinear_gate"
            or v1_result.get("predictions", {}).get("pred_b_full_factor_union_replays_exact_mlp9_correction") is not False
            or len(rows) != 30):
