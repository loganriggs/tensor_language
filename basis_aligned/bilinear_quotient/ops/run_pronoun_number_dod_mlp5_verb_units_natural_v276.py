...
"""Pronoun number they/he DoD (v276): the verb-site MLP-5 units {1036, 715} zeroed at the ANNOTATED VERB of the natural rows. v248 found the verb-site units undetectable at cue + 1, where the
...
PREDICTIONS (scored as written; failures preserved; priors from the panel)
    ...
    pred_b_congruent_damage_live            congruent rows: damage fraction >= 0.003 and positive >= 0.60
...
OUT = ROOT / "circuits/followups/pronoun_number_dod_mlp5_verb_units_natural_v276_result.json"
...
CANDIDATE_ID = "pronoun_number.they_vs_he.dod_mlp5_verb_units_natural_v276"
LAYER, UNITS, CONGRUENT = 5, (1036, 715), ("natural_plural_they", "natural_singular_he")
NULL_SEEDS = tuple(range(8701, 8717))
LIVE_FRACTION, LIVE_POSITIVE, GATE_RATIO, INSTRUMENT_TOL = 0.003, 0.60, 0.25, 1e-4
FORWARDS_MAX = 84
PREDICTIONS = {"pred_a_instrument_replays_native": "<= 1e-4", "pred_b_congruent_damage_live": ">= 0.003, positive >= 0.60", "pred_c_units_beat_random_unit_triples": "> random max", "pred_d_units_selective": "three gates", "pred_e_incongruent_shifts_toward_label": "< 0"}
...
def main() -> None:
    ...
    OUT.write_text(json.dumps({"schema": "pronoun_number_dod_mlp5_verb_units_natural_v276_result", "candidate_id": CANDIDATE_ID, "plan": plan, "instrument_max_abs_error": instrument, "arms": arms, "null_damage_max": null_max, "null_moves": null_moves, "nulls": nulls, "gates": gates,
