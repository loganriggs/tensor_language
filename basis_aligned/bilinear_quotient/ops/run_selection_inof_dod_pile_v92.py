...
"""Selection family DoD (v92): the run_selection_dod_battery_v85 set on Pile rows (out-of-corpus) (PREDICTS OOD).
Body: `dod_natural_line.run`. Rows: `selection_dod_natural_rows.py` (generic miner `dod_natural_miner.py`, receipt
`circuits/followups/selection_inof_dod_pile_rows_v92.json`), cue token within 12 tokens of a next token ' in' / ' of'; congruent cells ("natural_interested_in", "natural_afraid_of")
...
CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_pile_v92"
ROWS = N.ROOT / "circuits/followups/selection_inof_dod_pile_rows_v92.json"
OUT = "selection_inof_dod_pile_v92_result.json"
