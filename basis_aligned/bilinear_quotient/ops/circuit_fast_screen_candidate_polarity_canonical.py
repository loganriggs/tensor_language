"""polarity_state.canonical_control -- polarity_state.negative_vs_positive scored against the CANONICAL same-answer control.
...
TASK_ID = "polarity_state.canonical_control"
POLARITY = (" any", " some")
