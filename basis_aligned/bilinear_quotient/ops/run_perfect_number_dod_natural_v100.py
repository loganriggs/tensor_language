...
"""Perfect have/has DoD (v100): the set {11.3, 7.8, 5.3, 9.7} on natural FineWeb rows (training corpus, out-of-panel) (PREDICTS OOD). Body: `dod_natural_line.run`; rows
`perfect_number_dod_natural_rows.py` (generic miner; receipt `circuits/followups/perfect_number_dod_natural_rows_v100.json`; a list noun in singular / plural form within 12
...
CANDIDATE_ID = "perfect_number.have_vs_has.dod_natural_v100"
ROWS = N.ROOT / "circuits/followups/perfect_number_dod_natural_rows_v100.json"
OUT = "perfect_number_dod_natural_v100_result.json"
