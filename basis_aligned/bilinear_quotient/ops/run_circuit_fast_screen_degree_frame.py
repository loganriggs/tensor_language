...
import circuit_fast_screen_candidate_degree_frame as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_degree_frame_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/degree_frame_comparative_vs_equative_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "degree-frame-comparative-vs-equative-v1"
EXPERIMENT_ID = "fast-screen-degree-frame-comparative-vs-equative-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "eae7123d5ad6890c2f98650e1ef943c186b5a0655bd5d48b50c341ea36bdbec1"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "c81b3441b4759cfb02a80ff6800f0a46efe4c671914f868162f1a0b3dffb8bc7"
)
