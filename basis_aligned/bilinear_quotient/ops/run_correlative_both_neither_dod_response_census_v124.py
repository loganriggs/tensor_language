...
"""correlative_both_neither DoD (v124): RESPONSE CENSUS of the run_correlative_both_neither_dod_battery_v120 set removal on its fresh rows (better_circuits §3.3). Body: v74's from the set's lowest block.
...
v74.OUT = v74.ROOT / "circuits/followups/correlative_both_neither_dod_response_census_v124_result.json"
v74.CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_response_census_v124"
v74.FORWARDS_MAX = 8
