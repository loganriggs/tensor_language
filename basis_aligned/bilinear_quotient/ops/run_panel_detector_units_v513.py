...
OUT = ROOT / "circuits/followups/panel_detector_units_v513_result.json"
CANDIDATE_ID = "chain.panel_detector_units_v513"
N_HEAD = 9
...
def main() -> None:
    ...
    OUT.write_text(json.dumps({"schema": "panel_detector_units_result_v513", "candidate_id": CANDIDATE_ID, "plan": plan, "report": report, "predictions": predictions, "forwards": forwards,
