# SECOND CLASS: does §1853's domination survive a different covered set?  -- fit slice [288:384].
#
...
#
# This is slice [288:384], 5914 covered types. FULL RANK only: it is the dominated candidate, and the
...
OUT = PT + 'ops/second_class_dom_288_384_results.json'
...
FITLO, FITHI = 288, 384      # a 96-row slice DISJOINT from §1834's first 96   # 5x the fit rows -> a larger covered set
H = m.transformer.h
NCOV = 5419
...
def main():
    ...
    print(f'SECOND CLASS DOM | fit slice [288:384], full rank only | '
    ...
    json.dump({'run': 'second_class_dom_288_384', 'fit_slice': [288, 384],
