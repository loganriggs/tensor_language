#!/usr/bin/env python3
"""Corrected family labeling for the frozen-projector OOD/KL red-team."""
...
PRIOR = ROOT / "circuits/prior_art/temporal_five_mlp_frozen_response_ood_regularization_v2.json"
V1 = ROOT / "circuits/followups/temporal_five_mlp_frozen_response_ood_regularization_v1_result.json"
...
OUT = ROOT / "circuits/followups/temporal_five_mlp_frozen_response_ood_regularization_v2_result.json"
EXPECTED = {
    "prior": "ceaefe5a383e9512fecee5c2b3656e94fbcd75f012accbd828a7e5df41b40643",
    "invalid_v1": "ca14e4dd366146a253373fbca6f7acddc74fe5c8b6452e46a8cf6102f46d6bfe",
...
def control_report(backend, rows, base_state, state, scales):
    ...
    names = ["temporal" if str(r["task_id"]).startswith("temporal_auxiliary.") else "iswas" for r in rows]
    fractions = {}
...
def main():
    paths = {"prior": PRIOR, "invalid_v1": V1, "interface": INTERFACE, "temporal_builder": TB,
    ...
    dry = {"candidate_id": "temporal_auxiliary.five_mlp_frozen_response_ood_regularization_v2",
    ...
    result = {"schema": "temporal_five_mlp_frozen_response_ood_regularization_result_v2",
