...
"""Pythia-1b at step 4000 (8.4B tokens) — the training-length curve at 6x the size of the 160m run. v766 (160m step 4000): 0.982 / 0.947; v772 (70m step 4000): 0.979 / 0.939. H3 predicts the 1b model at 8B tokens is on the same curve: rank 32 >= 0.96, rank 16 >= 0.92. All-in-one, ROW-CENTRED logits (Logan, 22 Sep: 'try a few sets of pythia models, then other models, to test the specific hypothesis of why
...
PRICE (registered maximum): stock 7 + explicit 7; means 16; kernels 2; 128 x 7 = 896 (Pythia-1b: 16 layers x 8 heads x 128 dims); all-ablated 7; kernels-only 7 + col0 7; ladder 35; 2 arms x (kappa_r 26 +
