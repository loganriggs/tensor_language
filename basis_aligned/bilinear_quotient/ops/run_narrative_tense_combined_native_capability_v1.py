#!/usr/bin/env python3
"""Run the frozen combined capable-construction narrative native capability gate."""
...
PREREG = ROOT / "circuits/prior_art/NARRATIVE_TENSE_COMBINED_NATIVE_CAPABILITY_V1_PREREGISTRATION.md"
RESULT = ROOT / "circuits/fast_screens/narrative_tense_combined_native_capability_v1_result.json"
CAPABILITY_RESULT = ROOT / "circuits/fast_screens/narrative_tense_combined_native_capability_v1_capability.json"
LICENSE = ROOT / "circuits/fast_screens/narrative_tense_combined_native_capability_v1_license.json"
PREREG_SHA256 = "56355b0231074cb3739a2f87ba16c4e88d5c6615f7825cdef26c9f3f86b22300"
AUTHORITY_FILE_SHA256 = "dea01f20355999af3104a54c701a6d0ee15c3192990f6fe448ed897eb0a70f12"
AUTHORITY_LOGICAL_SHA256 = "a08264f00441cf6208ac7638c085c144661714046d2bad6148861d5bda5593e3"
...
def compile_plan() -> dict:
    gate = build_gate()
    return {
        "schema": "narrative_tense_combined_native_capability_plan_v1",
...
def main(argv: Sequence[str] | None = None):
    ...
    result = {
        "schema": "narrative_tense_combined_native_capability_result_v1",
