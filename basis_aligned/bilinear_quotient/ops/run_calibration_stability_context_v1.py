#!/usr/bin/env python3
# BQGATE: disjoint-fit calibration and fixed mean/donor replacements;32forwards126seq.
...
Arm formulas and full gates: CALIBRATION_STABILITY_CONTEXT_V1_PREREGISTRATION.md.
"""
...
OUT=POLY/'CALIBRATION_STABILITY_CONTEXT_V1_RESULT.json'
BINDING=POLY/'CALIBRATION_STABILITY_CONTEXT_V1_BINDING.json'
...
def main():
    ...
    try:
        with torch.inference_mode():
            ...
            del fit_m,fit_q
            artifact=POLY/'CALIBRATION_STABILITY_CONTEXT_V1_AXES.pt';assert not artifact.exists()
