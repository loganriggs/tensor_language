...
import circuit_fast_screen_candidate_possessive_adjacent as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_possessive_adjacent_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/possessive_number_adjacent_antecedent_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "possessive-number-adjacent-antecedent-v1"
EXPERIMENT_ID = "fast-screen-possessive-number-adjacent-antecedent-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "d3b36d10d9fd0a749f938733256c88a2b3f7e546e1411eb688b74facbc012271"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "3a6c81ff2951ece02df13c653b61d1c352b82f6aeb177cf089c8dbbf3aa22adc"
)
