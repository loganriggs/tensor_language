...
import circuit_fast_screen_candidate_correlative_canonical as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_correlative_canonical_control_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/correlative_state_canonical_control_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "correlative-state-canonical-control-v1"
EXPERIMENT_ID = "fast-screen-correlative-state-canonical-control-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "5125dbe662a0f3664a9e05b925e2074db26e5e7779363427a1f6fc728e7c546f"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "c67c005991b0699bdc840f126c8dce0ac25c643eaecaec4b80ae606a992b4f1d"
)
