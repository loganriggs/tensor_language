#!/usr/bin/env python3
"""Prospective history-disjoint v19 bank for factor-program confirmation."""
from __future__ import annotations

from typing import Any, Mapping, Sequence
import circuit_candidate_tense_auxiliary_is_was_fresh_lexicon_v18 as v18

SCHEMA, SPLIT, GROUPS = v18.SCHEMA, v18.SPLIT, 16
SEED = 20261114
TASK_ID, TASK_SPEC, READOUT = v18.TASK_ID, v18.TASK_SPEC, v18.READOUT
canonical_sha256, CandidateBankError = v18.canonical_sha256, v18.CandidateBankError
_AGENTS = (
    "psycholinguist", "rheumatologist", "sedimentologist", "sociolinguist",
    "spectroscopist", "stratigrapher", "vulcanologist", "zoologist",
    "algologist", "craniologist", "exobiologist", "folklorist",
    "gerontologist", "ornithomologist", "protozoologist", "thanatologist",
)
...
def _panel(group_number: int) -> list[dict[str, Any]]:
    ...
    era = lambda present: f"{'In modern times' if present else 'In bygone times'}, the {agent}"
    season = lambda present: f"{'For the current season' if present else 'For the former season'}, the {agent}"
    paraphrase = lambda present: f"{'In contemporary times' if present else 'In earlier times'}, the {agent}"
    group_id = f"FIT:{canonical_sha256([SCHEMA, TASK_ID, 'factor_confirm_v19', SEED, group_number])[:24]}"
    sentence_types = (
    ...
    common_no_vocab = dict(
        ...
        reporter=agent, alternate_reporter=alternate, adjective="factor_confirm_v19",
        object_name="modern_bygone_current_former", spec=TASK_SPEC,
    )
    common = dict(common_no_vocab, vocabulary=READOUT)
    base = v18.v17.v16.v15.v14.v13.v12.v11.v10.v9.v8.v1
    return [
        base.builder._row(
            **common, transform_id="A1", construction_id="modern_bygone_times_auxiliary_v19",
        ...
        base.builder._row(
            **common, transform_id="A2", construction_id="current_former_season_auxiliary_v19",
            direction_id=direction, matched_suffix=f", the {agent}",
            base_text=season(base_present), donor_text=season(donor_present),
            base_answer=answer(base_present), donor_answer=answer(donor_present),
            sentence_types=sentence_types,
        ),
        base.builder._row(
            **common, transform_id="P", construction_id="era_paraphrase_auxiliary_v19",
            direction_id="primary_to_alternative" if forward else "alternative_to_primary",
            matched_suffix=f", the {agent}", base_text=era(base_present),
...
def _validate(rows: Sequence[Mapping[str, object]]) -> str:
    ...
    if materialized != _build():
        raise CandidateBankError("rows differ from sealed v19 authority")
    base = v18.v17.v16.v15.v14.v13.v12.v11.v10.v9.v8.v1
    try:
    ...
    old_modules = (
        base, v18.v17.v16.v15.v14.v13.v12.v11.v10.v9.v8.v2,
        v18.v17.v16.v15.v14.v13.v12.v11.v10.v9.v8.v3,
        v18.v17.v16.v15.v14.v13.v12.v11.v10.v9.v8.v4,
        v18.v17.v16.v15.v14.v13.v12.v11.v10.v9.v8.v5,
        v18.v17.v16.v15.v14.v13.v12.v11.v10.v9.v8.v6,
        v18.v17.v16.v15.v14.v13.v12.v11.v10.v9.v8.v7,
        v18.v17.v16.v15.v14.v13.v12.v11.v10.v9.v8,
        v18.v17.v16.v15.v14.v13.v12.v11.v10.v9,
        v18.v17.v16.v15.v14.v13.v12.v11.v10,
        v18.v17.v16.v15.v14.v13.v12.v11,
        v18.v17.v16.v15.v14.v13.v12,
    ...
    if (len(materialized) != 64 or len(ids) != 64 or ids & old_ids
        ...
        raise CandidateBankError("v19 count, novelty, or construction check failed")
    return digest
