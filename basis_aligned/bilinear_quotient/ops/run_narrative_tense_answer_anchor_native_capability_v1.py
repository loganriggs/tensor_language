#!/usr/bin/env python3
"""Run the frozen answer-clause-anchor narrative native capability gate."""
...
import circuit_fast_screen_candidate_narrative_tense_answer_anchor_authority as authority
...
PREREG = ROOT / "circuits/prior_art/NARRATIVE_TENSE_ANSWER_ANCHOR_NATIVE_CAPABILITY_V1_PREREGISTRATION.md"
RESULT = ROOT / "circuits/fast_screens/narrative_tense_answer_anchor_native_capability_v1_result.json"
CAPABILITY_RESULT = ROOT / "circuits/fast_screens/narrative_tense_answer_anchor_native_capability_v1_capability.json"
LICENSE = ROOT / "circuits/fast_screens/narrative_tense_answer_anchor_native_capability_v1_license.json"
PREREG_SHA256 = "909d9a5c9449c2d36e6e88a25a2b28b83e6414dd72ab5c7c9541047a1cc8d4d1"
AUTHORITY_FILE_SHA256 = "75a357e09bd3b00c22b21e42c42f18829a17538716d03975ecfc747a105e2bb0"
AUTHORITY_LOGICAL_SHA256 = "012fec13ad5c4392ac351fc011df269e44b2177a7c430a23426d604dce33c7f5"
...
def compile_plan() -> dict:
    gate = build_gate()
    return {
        "schema": "narrative_tense_answer_anchor_native_capability_plan_v1",
...
def main(argv: Sequence[str] | None = None):
    ...
    result = {
        "schema": "narrative_tense_answer_anchor_native_capability_result_v1",
