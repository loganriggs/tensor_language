...
OUT=ROOT/'basis_aligned/bilinear_quotient/circuits/followups/subject_attention_freeze_v678_result.json'
...
def main():
    ...
    package=torch.load(OUT.parent/'subject_response_v677_program.pt',map_location='cpu',weights_only=True)
    def gpu(value):
