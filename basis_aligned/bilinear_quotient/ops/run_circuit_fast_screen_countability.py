...
import circuit_fast_screen_candidate_countability as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_countability_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/countability_state_count_vs_mass_v2_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "countability-state-count-vs-mass-v2"
EXPERIMENT_ID = "fast-screen-countability-state-count-vs-mass-v2"
EXPECTED_AUTHORITY_SHA256 = (
    "ac9ed51e203668872116f783dc41c28f1a2a6814ec7502ee17c32086cfaef99c"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "6977cfc4d6ff55b59143ab57235f6a9be7b2d07e02ad34f8ed58be24fe381d49"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="whether the noun is count or mass",
    proposed_operation="carry noun countability across the clause in two constructions",
    proposed_write="evidence for many rather than much",
