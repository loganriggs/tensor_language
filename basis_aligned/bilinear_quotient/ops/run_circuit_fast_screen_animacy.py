...
import circuit_fast_screen_candidate_animacy as candidate
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="whether the antecedent is animate",
    proposed_operation="carry antecedent animacy across the clause in two constructions",
    proposed_write="evidence for who rather than which",
