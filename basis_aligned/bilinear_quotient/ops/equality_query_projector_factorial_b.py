...
OPS = BQ / "ops"
OUT = BQ / "equality_query_projector_factorial_b_results.json"
...
def main():
    ...
    if os.environ.get("BQLIB_DRYRUN") == "1":
        ...
        print(json.dumps({
            "status": "dry_run_passed", "rung": "projector_factorial_b",
    ...
    pred_a = bool(
        ...
        and bridge_error <= 1e-5 and doubled_max <= 1e-9
    ...
    result = {
        "status": "complete", "rung": "equality_query_projector_factorial_b",
