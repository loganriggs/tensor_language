...
BINDING = POLY / "INDUCTION_TYPED_CONSUMER_GROUP_RESPONSE_V4_BINDING.json"
OUT = POLY / "INDUCTION_TYPED_CONSUMER_GROUP_RESPONSE_V4_RESULT.json"
CANDIDATE_GROUPS = {
...
def main():
    ...
    result = {
        "experiment": "induction_typed_consumer_group_response_v4",
        ...
        "discovery": {
            ...
            "candidate_reports": {name: discovery_reports[name] for name in CANDIDATES},
        ...
        "confirm": {
            ...
            "candidate_reports": {name: confirm_reports[name] for name in CANDIDATES},
