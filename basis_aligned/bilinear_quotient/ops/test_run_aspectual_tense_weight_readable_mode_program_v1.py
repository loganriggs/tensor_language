...
import run_aspectual_tense_weight_readable_mode_program_v1 as runner


def test_frozen_program_and_exact_dryrun():
    _splits, _chosen, _pools, programs, _subspaces = runner.validate_static()
