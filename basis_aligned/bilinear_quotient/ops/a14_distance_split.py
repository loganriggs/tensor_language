...
if os.environ.get('BQLIB_DRYRUN')=='1':
    ...
    print(f"DRYRUN OK: published L2_F {_p['L2_F']}; distance split of the a14L ind damage on FR (damage convention)")
    raise SystemExit(0)
import torch
...
OUT=PT+'a14_distance_split_results.json'
...
if __name__=='__main__':
    ...
    res={'full':r_full,'skip14':r_skip,
         ...
         'pred_a_near_carries':bool(pa),'pred_b_peak_near':bool(pb),'pred_c_reproduces_s2155':bool(pc),
