...
if __name__=='__main__':run('data_product_s0',1,RUNNER,POLY/'STRUCTURED_FIT_V2_data_product_s0_C01_BINDING.json',dry=bool(os.environ.get('BQLIB_DRYRUN') or os.environ.get('BQLIB_NO_MODEL')))
