#!/usr/bin/env python3
"""Valid source- and MLP-resolved suffix extension of aspectual program v3."""
...
PROGRAM_ID = "aspectual_anchor.has_vs_had.transparent_path_program_v5"
...
def bilinear_hidden_delta(
    ...
    *,
    ...
    return left_base - left_base if hidden is None else hidden
...
def suffix_mlp_write_delta(
    ...
    *,
    ...
    """Project the corrected frozen two-term MLP11 or MLP15 response."""
...
def compiled_suffix_crossing_delta(
    ...
    *,
    ...
    """Compose carried state, source-resolved attention, and corrected MLP response."""
    return (
...
def program_manifest() -> dict[str, object]:
    """Return the exact stable inventory exposed by executable program v5."""
    manifest = dict(v3.program_manifest())
    manifest.update({
        "program_id": PROGRAM_ID,
        "suffix_mlp_factors_by_boundary": dict(SUFFIX_MLP_FACTORS_BY_BOUNDARY),
        "suffix_mlp_evidence": "corrected three-role-context split v2",
