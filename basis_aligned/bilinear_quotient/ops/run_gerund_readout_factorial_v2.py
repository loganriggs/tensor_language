...
OUT=POLY/'GERUND_READOUT_FACTORIAL_V2_RESULT.json';BIND=POLY/'GERUND_READOUT_FACTORIAL_V2_BINDING.json'
...
def main():
    ...
    artifact=POLY/'GERUND_READOUT_FACTORIAL_V2_STATES.pt';assert not artifact.exists();torch.save(saved,artifact)
