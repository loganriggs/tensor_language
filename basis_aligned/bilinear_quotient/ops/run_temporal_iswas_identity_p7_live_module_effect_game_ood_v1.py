#!/usr/bin/env python3
"""Trace block-10 identity through live P7 modules with an exact effect game."""

# BQGATE: EXPERIMENT pred_a_authority_capture_all_subset_noop_full_identity_replay_finiteness_and_exact_price pred_b_exact_mobius_reconstruction_and_shapley_efficiency pred_c_at_least_one_p7_module_has_stable_live_route_credit pred_d_at_least_one_p7_pair_has_stable_interaction pred_e_every_source_conditioned_subset_is_temporally_selective
...
PRIOR = ROOT / "circuits/prior_art/temporal_iswas_identity_p7_live_module_effect_game_ood_v1.json"
...
OUT = ROOT / "circuits/followups/temporal_iswas_identity_p7_live_module_effect_game_ood_v1_result.json"
EXPECTED = {
    "prior": "0b387b27568688abfca308ec1e9e16da63f88337f0d10ed4ea9232386c3e7bd6",
...
PREDICTION_KEYS = (
    "pred_a_authority_capture_all_subset_noop_full_identity_replay_finiteness_and_exact_price",
...
def main():
    ...
    for phase in ("FIT", "HOLDOUT"):
        ...
        parent_row = parent_by[(phase, "identity_full")]
    ...
    result = {"schema": "temporal_iswas_identity_p7_live_module_effect_game_ood_result_v1",
        ...
        "full_identity_replay_max_abs_error": replay_error,
