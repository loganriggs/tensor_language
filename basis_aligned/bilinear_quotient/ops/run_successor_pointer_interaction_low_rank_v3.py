#!/usr/bin/env python3
# BQLANE: gpu
# BQGATE: 22forwards154seq90readouts; successor cross-type residual low-rank V3 instrument serialization;0updates.
...
V3_CORRECTION = POLY / "SUCCESSOR_POINTER_INTERACTION_LOW_RANK_V3_SERIALIZATION_CORRECTION.md"
...
V2_BINDING = POLY / "SUCCESSOR_POINTER_INTERACTION_LOW_RANK_V2_BINDING.json"
V2_RUNNER = OPS / "run_successor_pointer_interaction_low_rank_v2.py"
V2_RESULT = POLY / "SUCCESSOR_POINTER_INTERACTION_LOW_RANK_V2_RESULT.json"
BINDING = POLY / "SUCCESSOR_POINTER_INTERACTION_LOW_RANK_V3_BINDING.json"
OUT = POLY / "SUCCESSOR_POINTER_INTERACTION_LOW_RANK_V3_RESULT.json"
...
def load_bound():
    ...
    paths = {"fit_rows": FIT_ROWS, "holdout_rows": HOLD_ROWS, "preregistration": PREREG,
             ...
             "v3_correction": V3_CORRECTION, "v2_binding": V2_BINDING, "v2_runner": V2_RUNNER, "v2_invalid_result": V2_RESULT}
...
def plan():
    ...
    return {"schema": "successor_pointer_interaction_low_rank_v3_plan", "model_loaded": False,
...
def main():
    ...
    if fit_instrument and selected is not None:
        ...
        hold_report = {"instrument": hold_instrument, "self_error": hold["self_error"], "ceiling_error": hold["ceiling_error"], "capability": hold_capability, "joint": hold_joint, "family_mean_target": hold_means, "direct_readout_error": hold_readout_error, "selected_rank": hold_rank, "row_manifest_sha256": hold_frozen["row_manifest_sha256"]}
    ...
    result = {
        "schema": "successor_pointer_interaction_low_rank_v3_result", "terminal": terminal,
