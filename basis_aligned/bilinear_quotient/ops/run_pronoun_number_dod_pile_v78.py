...
"""Pronoun number they/he DoD (v78): the set {9.6, 12.4, 15.1, 10.5} on Pile rows (NeelNanda/pile-10k, out-of-corpus) (PREDICTS OOD).

Lane: Claude circuit lane. Parent: v76 (fresh rows 7/7, 76%). Body: `dod_natural_line.run` (the v73/v75 body lifted into a module).
Rows: `pronoun_number_dod_natural_rows.py` (outcome-blind miner, receipt `circuits/followups/pronoun_number_dod_pile_rows_v78.json`, 64 rows, 16 per
...
CANDIDATE_ID = "pronoun_number.they_vs_he.dod_pile_v78"
ROWS = N.ROOT / "circuits/followups/pronoun_number_dod_pile_rows_v78.json"
OUT = "pronoun_number_dod_pile_v78_result.json"
