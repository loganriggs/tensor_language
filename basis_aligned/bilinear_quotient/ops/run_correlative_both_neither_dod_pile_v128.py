...
"""correlative_both_neither DoD (v128): the run_correlative_both_neither_dod_battery_v120 set on Pile rows (out-of-corpus) (PREDICTS OOD). Body: `dod_natural_line.run`; rows receipt `circuits/followups/correlative_both_neither_dod_pile_rows_v128.json` (outcome-blind
...
CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_pile_v128"
ROWS = N.ROOT / "circuits/followups/correlative_both_neither_dod_pile_rows_v128.json"
OUT = "correlative_both_neither_dod_pile_v128_result.json"
