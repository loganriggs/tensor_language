...
ROOT=Path(__file__).resolve().parents[3];P=ROOT/'basis_aligned/polynomial_causal';A=ROOT/'basis_aligned/bilinear_quotient/circuits/followups';OUT=A/'fixed_query_fresh_v4_result.json';PLAN=dict(prefix=18,native_suffix=48,baseline_attention=6)
def main():
