...
import circuit_fast_screen_candidate_polarity_state as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_polarity_state_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/polarity_state_negative_vs_positive_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "polarity-state-negative-vs-positive-v1"
EXPERIMENT_ID = "fast-screen-polarity-state-negative-vs-positive-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "c3d75ae8a75d30c59e70ba9aea9fd24679f82c939d7937face653cbf5df76f55"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "91c939127ab3adbd02ba026f4882d05b99b988b076e5eb12480f61388af8c287"
)
