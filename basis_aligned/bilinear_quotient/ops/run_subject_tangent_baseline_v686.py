...
"""Baseline tangent and discarded-input correction, same source interfaces.
...
OUT=ROOT/'basis_aligned/bilinear_quotient/circuits/followups/subject_attention_freeze_v686_result.json'
PREDICTIONS=dict(pred_a_exact_replay='original replay plus baseline tangent centralfinitechange relative error<=.01',
 ...
 pred_c_capable_position_transfer='sparse-plus-discarded-input-tangent A/B target<=.10 and modal<=.05 everycell')
