...
"""Frozen native directional-response screen on fresh normalized inputs.
...
pred_b_order: quartic response error <=quadratic for each learned amplitude.
...
Prices unchanged; no fitting; folded-function local responses, not semantic
