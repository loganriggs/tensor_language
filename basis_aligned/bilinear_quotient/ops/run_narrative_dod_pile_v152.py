...
"""Narrative was/is DoD (v152): the v42 / v43 set {15.5, 11.3, 9.1, 9.4} on Pile rows (out-of-corpus) (PREDICTS OOD). Body: `dod_natural_line.run`; rows
`narrative_dod_natural_rows.py` (receipt `circuits/followups/narrative_dod_pile_rows_v152.json`): a single temporal adverb (yesterday / ago / formerly / previously /
...
CANDIDATE_ID = "narrative_tense.past_vs_present.dod_pile_v152"
ROWS = N.ROOT / "circuits/followups/narrative_dod_pile_rows_v152.json"
OUT = "narrative_dod_pile_v152_result.json"
