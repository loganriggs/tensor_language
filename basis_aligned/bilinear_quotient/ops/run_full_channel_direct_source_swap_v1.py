...
"""Direct MLP16 residual-path donor swaps with recomputed RMS17.
...
Existing frozen program3686products/14,067,072coefficients, no fit,48captures.
"""
...
def main():
 ...
 out=P/'FULL_CHANNEL_DIRECT_SOURCE_SWAP_V1.json';assert not out.exists()
