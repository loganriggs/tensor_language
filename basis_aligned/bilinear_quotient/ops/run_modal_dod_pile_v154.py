...
"""modal DoD (v154): the run_modal_dod_battery_v66 set on Pile rows (out-of-corpus) (PREDICTS OOD). Body: `dod_natural_line.run`; rows receipt `circuits/followups/modal_dod_pile_rows_v154.json` (outcome-blind
...
CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_pile_v154"
ROWS = N.ROOT / "circuits/followups/modal_dod_pile_rows_v154.json"
OUT = "modal_dod_pile_v154_result.json"
