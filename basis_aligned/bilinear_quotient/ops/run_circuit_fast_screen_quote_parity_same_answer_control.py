...
import circuit_fast_screen_candidate_quote_parity_same_answer_control as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_quote_parity_same_answer_control_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/quote_parity_pending_close_same_answer_control_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "quote-parity-pending-close-same-answer-control-v1"
EXPERIMENT_ID = "fast-screen-quote-parity-pending-close-same-answer-control-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "9654c39e3ab5a8f9114036a09cabf839d4cb01c5485bbca1c387d7357ff2bcaf"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "a387972bfddf70f67aa7b683b445b42b0cd5645655d6584d7c142ae81c1c44fb"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    semantic_position_role="final input token before period or closing quote",
    batch_size=32,
