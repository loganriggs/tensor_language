...
"""Attention lane, v732: the sink head's program — kappa(d) plus ONE number for position 0.
...
OUT = ROOT / "circuits/followups/attention_sink_program_v732_result.json"
...
NATIVE_V615 = 3.13241
CANDIDATE_ID = "attention.sink_program_v732"
FORWARDS_MAX = 80
EBATCH = 32
L_, H_ = 5, 7; H = 9
BETAS = (0.0, 0.25, 0.5, 1.0, 1.5, 2.0, 3.0, 4.0, 6.0)
