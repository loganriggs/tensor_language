...
import run_temporal_iswas_v23_l9h1h4_layerwise_transport_localization_v1 as experiment
...
def test_boundary_order_and_price_are_frozen():
    assert experiment.BOUNDARIES[0] == "block10_input_after_block9"
    ...
    assert experiment.PRICE["sequence_evaluations_exact"] == 5 * 64
