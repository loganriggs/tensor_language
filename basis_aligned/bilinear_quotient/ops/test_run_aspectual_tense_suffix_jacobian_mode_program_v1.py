...
import run_aspectual_tense_suffix_jacobian_mode_program_v1 as runner


def test_fit_only_population_and_dryrun():
    _static, splits, _chosen, _pools, programs = runner.validate_static()
