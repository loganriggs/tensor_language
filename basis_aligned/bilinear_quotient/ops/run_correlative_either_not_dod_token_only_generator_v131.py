...
"""correlative_either_not DoD (v131): token-only generator for ALL FOUR heads {8.1, 16.8, 14.8, 7.8} on the fresh rows (v113's body; cue tokens (" either", " not")). Parents:
...
v113.OUT = v113.ROOT / "circuits/followups/correlative_either_not_dod_token_only_generator_v131_result.json"
v113.CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_token_only_generator_v131"
v113.PRONOUN_TOKENS = (" either", " not")
