...
"""correlative_either_neither DoD (v150): the run_correlative_either_neither_dod_battery_v147 set on Pile rows (out-of-corpus) (PREDICTS OOD). Body: `dod_natural_line.run`; rows receipt `circuits/followups/correlative_either_neither_dod_pile_rows_v150.json` (outcome-blind
...
CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_pile_v150"
ROWS = N.ROOT / "circuits/followups/correlative_either_neither_dod_pile_rows_v150.json"
OUT = "correlative_either_neither_dod_pile_v150_result.json"
