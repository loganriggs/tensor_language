...
"""Lexical number were/was DoD (v138): the v55 set {11.3, 5.7, 7.8, 9.7} on natural FineWeb rows (training corpus, out-of-panel) (PREDICTS OOD; the number family's first line had no natural
rows). Body: `dod_natural_line.run`; rows `lexical_number_dod_natural_rows.py` (generic miner; receipt `circuits/followups/lexical_number_dod_natural_rows_v138.json`; a list noun in
...
CANDIDATE_ID = "lexical_number.pp_intervener.dod_natural_v138"
ROWS = N.ROOT / "circuits/followups/lexical_number_dod_natural_rows_v138.json"
OUT = "lexical_number_dod_natural_v138_result.json"
