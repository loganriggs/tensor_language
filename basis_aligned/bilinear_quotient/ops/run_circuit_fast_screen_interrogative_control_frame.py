...
import circuit_fast_screen_candidate_interrogative_control_frame as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_interrogative_control_frame_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/interrogative_licensing_control_frame_variant_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "interrogative-licensing-control-frame-variant-v1"
EXPERIMENT_ID = "fast-screen-interrogative-licensing-control-frame-variant-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "7e48f58ec403024ef0b6d6e59117bf3ddaa205698383a6933115ddbfb36be5e8"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "699627d4c67914a3ad799751b09d0ca1927b231e90427813d36b218d63248c11"
)
