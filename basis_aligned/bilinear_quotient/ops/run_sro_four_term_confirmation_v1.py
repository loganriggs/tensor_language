...
pred_c heldout3/6/7 cue prediction error<=.10 EACHfamily.
Null: cue reduction fails on fixed new templates or native capability is absent.
Price576bodyforwards,72prefixes,180seconds; full native weights and five observed
...
STEM='SRO_FOUR_TERM_CONFIRMATION_V1'
...
def main():
    ...
    result={'pred_a':max(checks)<=1e-10 and replay<=1e-12,
            ...
            'source_shas':binding,'scope':'New constructions; fixed four-term reduction calibrated from corners0/1/2/4/5, evaluated on held-out corners3/6/7. Original model/context and observed-corner costs retained; no autonomous prediction or semantic identification.'}
