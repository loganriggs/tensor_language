...
BINDING = POLY / "INDUCTION_TYPED_CONSUMER_GROUP_RESPONSE_V1_BINDING.json"
OUT = POLY / "INDUCTION_TYPED_CONSUMER_GROUP_RESPONSE_V1_RESULT.json"
CANDIDATE_GROUPS = {
...
def main():
    ...
    assert len(CANDIDATES) == 8 and binding["price"] == {"forwards": 30, "sequences": 960}
    if REQUESTED_DRY:
        print(json.dumps({
    ...
    result = {
        "experiment": "induction_typed_consumer_group_response_v1",
