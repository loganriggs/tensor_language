...
import circuit_fast_screen_candidate_bracket_positive_control as candidate
...
RESULT_RELATIVE = Path(
    "circuits/fast_screens/bracket_positive_control_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "bracket-positive-control-v1"
EXPERIMENT_ID = "fast-screen-bracket-positive-control-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "7beed767107c14439ec85e56636f207d625741dde4ee43dc12518f567bf74cd7"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "2923056f3bf64775230cd132b2bc0dbb228085f4c3e2f673e4ead975d9a6c9c7"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="which opener type is pending at the closer position",
    proposed_operation=(
        "carry the pending opener type forward and emit its matching closer"
    ),
    proposed_write="evidence for the matching closer against the other closer",
    ...
    semantic_position_role="final input token before the predicted closer",
    batch_size=32,
