...
"""Replication, all-in-one, HF families (OPT / Llama-style), ROW-CENTRED logits (see v760: per-query-row constants are removed before kernels are estimated and added back in the program). MODEL = facebook/opt-125m (12 x 12 x 768, softmax, LEARNED ABSOLUTE positions,
