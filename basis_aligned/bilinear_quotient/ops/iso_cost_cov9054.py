# THE BUDGET-CONSTRAINED OPTIMUM -- coverage 9054, rank 611, at the deployed 230.087M budget.
#
...
#
# This is the 9054-type point: rank 611, costing about 229.9M. With §1861's it says whether the
...
#   pred_d CONTROLS: the cost computed from §1754's model is at most 230.087M; coverage is 9054 from
#          fit rows [0:192]; the ceiling is finite and above live on every role; the covered CE lies
...
OUT = PT + 'ops/iso_cost_cov9054_results.json'
...
TRANKS = (611,)          # None = full rank; §1786/§1813 use this ladder
...
def main():
    ...
    print(f'ISO COST COV | 9054 types, rank 611, at the deployed budget | '
    ...
    pd = (cost <= DEPLOYED_COST_M and NFULL == 9054
    ...
    json.dump({'run': 'iso_cost_cov9054', 'n_covered': NFULL, 'rank': R,
