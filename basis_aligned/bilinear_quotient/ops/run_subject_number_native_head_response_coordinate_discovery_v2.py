...
CORRECTION = POLY / "SUBJECT_NUMBER_NATIVE_HEAD_RESPONSE_COORDINATE_DISCOVERY_V2_CORRECTION.md"
...
BINDING = POLY / "SUBJECT_NUMBER_NATIVE_HEAD_RESPONSE_COORDINATE_DISCOVERY_V2_BINDING.json"
OUT = ROOT / "circuits/fast_screens/subject_number_native_head_response_coordinate_discovery_v2_result.json"
...
def plan():
    ...
    return {"schema": "subject_number_native_head_response_coordinate_discovery_v2_plan",
...
def main():
    ...
    with torch.no_grad():
        ...
        for subset in factor_gate.BACKGROUND_SUBSETS:
            ...
            native_axis = torch.tensor(axis_artifact["axis"], device=device, dtype=xb.dtype)
    ...
    result = {"schema": "subject_number_native_head_response_coordinate_discovery_v2_result",
