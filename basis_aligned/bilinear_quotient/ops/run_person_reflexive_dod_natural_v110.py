...
"""Reflexive person DoD (v110): the set {8.1, 13.1, 10.5, 15.1} on natural FineWeb rows (training corpus, out-of-panel) (PREDICTS OOD). Body: `dod_natural_line.run`; rows
`person_dod_natural_rows.py` (generic miner; receipt `circuits/followups/person_reflexive_dod_natural_rows_v110.json`; an I / you token within 12 tokens, next token myself /
...
CANDIDATE_ID = "reflexive_person.i_vs_you.dod_natural_v110"
ROWS = N.ROOT / "circuits/followups/person_reflexive_dod_natural_rows_v110.json"
OUT = "person_reflexive_dod_natural_v110_result.json"
