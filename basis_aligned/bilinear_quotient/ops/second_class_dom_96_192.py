# SECOND CLASS: does §1853's domination survive a different covered set?  -- fit slice [96:192].
#
...
#
# This is slice [96:192], 5932 covered types. FULL RANK only: it is the dominated candidate, and the
...
OUT = PT + 'ops/second_class_dom_96_192_results.json'
...
FITLO, FITHI = 96, 192      # a 96-row slice DISJOINT from §1834's first 96   # 5x the fit rows -> a larger covered set
H = m.transformer.h
NCOV = 5419
...
def main():
    ...
    print(f'SECOND CLASS DOM | fit slice [96:192], full rank only | '
    ...
    json.dump({'run': 'second_class_dom_96_192', 'fit_slice': [96, 192],
