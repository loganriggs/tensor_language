...
"""Partial output whitening, power.5, same random graph capacity.
...
if __name__=='__main__':
 ...
 main('SOURCE_OUTPUT_BALANCE_HALF_PLAN_V1.json','SOURCE_OUTPUT_BALANCE_HALF_V1.json','SOURCE_OUTPUT_BALANCE_HALF_PROGRAMS_V1.pt')
