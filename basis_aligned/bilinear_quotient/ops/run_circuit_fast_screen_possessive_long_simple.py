...
import circuit_fast_screen_candidate_possessive_long_simple as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_possessive_long_simple_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/possessive_number_long_simple_intervener_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "possessive-number-long-simple-intervener-v1"
EXPERIMENT_ID = "fast-screen-possessive-number-long-simple-intervener-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "9d520be8ceeba33359b550552fb94e85a27598e8b724e72747f4f378b8e40314"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "0ef9b2818dc6219e3d075c1b8a020d663747247bff089fc8b0069f356203d4f5"
)
