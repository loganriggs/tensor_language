...
"""correlative_either_not DoD (v125): the run_correlative_either_not_dod_battery_v119 set on natural FineWeb rows (training corpus, out-of-panel) (PREDICTS OOD). Body: `dod_natural_line.run`; rows receipt `circuits/followups/correlative_either_not_dod_natural_rows_v125.json` (outcome-blind
...
CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_natural_v125"
ROWS = N.ROOT / "circuits/followups/correlative_either_not_dod_natural_rows_v125.json"
OUT = "correlative_either_not_dod_natural_v125_result.json"
