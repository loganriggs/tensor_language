#!/usr/bin/env python3
"""Fresh-population source atlas with causal-only closure for auxiliary value transport."""
...
PRIOR = ROOT / "circuits/prior_art/iswas_mlp8_auxiliary_value_source_subset_atlas_v3.json"
...
V2_INVALID = ROOT / "circuits/followups/iswas_mlp8_auxiliary_value_source_subset_atlas_v2_result.json"
ATTENTION_LIBRARY = ROOT / "ops/attention_source_destination_eval.py"
OUT = ROOT / "circuits/followups/iswas_mlp8_auxiliary_value_source_subset_atlas_v3_result.json"
CANDIDATE_ID = "cross_task.iswas_mlp8_auxiliary_value_source_subset_atlas_v3"
RESULT_SCHEMA = "iswas_mlp8_auxiliary_value_source_subset_atlas_result_v3"
EXPECTED = {
    "prior": "ad2aa4542ff4cae98acf98df63d31b2ddf2340b6613bd6f8f56501ffabf5a56e",
    ...
    "v2_invalid": "a547d8f1e1fbafef58dbf37aa1835b362d19be444ecf54e62c9b3f9c4585f436",
...
MAX_FORWARDS, MAX_EVALUATIONS = 40, 1200
...
def main() -> None:
    paths = {"prior": PRIOR, "parent": PARENT, "parent_runner": PARENT_RUNNER,
             "capability": CAPABILITY, "builder": BUILDER, "v2_invalid": V2_INVALID,
    ...
    v2_invalid = json.loads(V2_INVALID.read_text())
    ...
    if (prior.get("candidate_id") != CANDIDATE_ID or parent.get("terminal") != "screen"
            or v2_invalid.get("terminal") != "invalid" or len(rows) != 30):
