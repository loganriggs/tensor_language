#!/usr/bin/env python3
# BQLANE: gpu
# BQGATE: 7forwards56seq; fresh length-six pointer-group confirmation;0fits.
"""A exact instrument; B fresh capability; C pointer group confirms; D null."""
...
PREREG = POLY / "SUCCESSOR_FIXED_POINTER_LENGTH6_CONFIRMATION_V1_PREREGISTRATION.md"
SCREEN = POLY / "SUCCESSOR_FIXED_POINTER_TYPED_GROUP_RESPONSE_V1_RESULT.json"
BINDING = POLY / "SUCCESSOR_FIXED_POINTER_LENGTH6_CONFIRMATION_V1_BINDING.json"
OUT = POLY / "SUCCESSOR_FIXED_POINTER_LENGTH6_CONFIRMATION_V1_RESULT.json"
...
PRICE = {"forwards": 7, "sequences": 56, "fits": 0}
...
def plan():
    ...
    return {
        "schema": "successor_fixed_pointer_length6_confirmation_v1_plan",
        "model_loaded": False,
        "gpu_accessed": False,
        "queue_touched": False,
        ...
        "predicates": [
            ...
            "pred_c_pointer_group_confirmed",
            "pred_d_pointer_group_null",
        ],
    }
...
def main():
    ...
    terminal = "invalid" if not (pred_a and pred_b) else ("pointer_group_confirmed" if pred_c else "pointer_group_null")
    result = {
        "schema": "successor_fixed_pointer_length6_confirmation_v1_result",
        "terminal": terminal,
        "predictions": {
            "pred_a_exact_instrument": pred_a,
            "pred_b_live_target_and_capability": pred_b,
            "pred_c_pointer_group_confirmed": pred_c,
            "pred_d_pointer_group_null": pred_d,
        },
        "bars": BARS,
