...
"""Reflexive person I/you DoD (v284): the "look one block lower" check for the person port. v259: MLP 8's write on 10.5's myself - yourself reader direction is spread at the
pronoun (top-10 26%, frame Jaccard 0.09) -- a port; the temporal family's port at MLP 8 turned out to have concentrated units at MLP 7 (v278). Same exact census for
MLP 7 on the same reader direction at the PRONOUN and the FINAL token of the v104 rows. Kill: top-10 < 0.30 at both positions -> port at MLP 7 as well.
PREDICTIONS (scored as written; failures preserved; priors unsure)
    ...
    pred_b_pronoun_top10_carry_half            at the pronoun, the top-10 |pooled| units carry >= 0.50 of MLP 7's pooled write on r
...
OUT = ROOT / "circuits/followups/person_reflexive_dod_mlp7_unit_census_10_5_v284_result.json"
CANDIDATE_ID = "reflexive_person.i_vs_you.dod_mlp8_unit_census_10_5_v259"
LAYER, HEAD, CLOSURE_TOL, TOP10_MIN, JACCARD_MIN = 7, (10, 5), 1e-3, 0.50, 1 / 3
