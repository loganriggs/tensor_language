...
"""Pronoun number they/he DoD (v202): the bottom of the chain -- carrier-level unit census of MLP 1 and MLP 2 into MLP-3 unit 3465 (v201: MLP 1 carries
41% and MLP 2 22% of 3465's plural - singular contrast; the embedding 5%). v194's identity per source block (unit j's carrier da_j mB + mA db_j with
c_j = (prod of lam0 over blocks s+1..3) h_j Down_s[:, j]); closure tolerance 1e-2 (fp32 sums over 4608 units). Registered question: does MLP 1 compute
the number feature in a few units (a lexical plural detector at block 1) or spread it?
...
OUT = ROOT / "circuits/followups/pronoun_number_dod_mlp12_unit_carriers_into_3465_v202_result.json"
CANDIDATE_ID = "pronoun_number.they_vs_he.dod_mlp12_unit_carriers_into_3465_v202"
UNIT, SRCS, DST, CLOSURE_TOL, TOP10_MIN, TOP50_MIN, BATCH = 3465, (1, 2), 3, 1e-2, 0.50, 0.80, 32
FORWARDS_MAX = 5
