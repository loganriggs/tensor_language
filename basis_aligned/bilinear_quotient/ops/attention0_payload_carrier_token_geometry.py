"""RUNG 423 (Claude red-team lane) -- CROSS-ARC TOKEN-GEOMETRY UNIFICATION.
...
OUT = BQ / "attention0_payload_carrier_token_geometry_results.json"
...
def main() -> None:
    if os.environ.get("BQLIB_DRYRUN") == "1":
        ...
        print("ATTENTION0 PAYLOAD-CARRIER TOKEN GEOMETRY | dry run: cross-arc unification, both splits")
        return
    ...
    for split in SPLITS:
        ...
        for side in cc_base.SIDES:
            ...
            carrier, _spec, _res = cc_base._top_average_projector(bases, 420)
            repeat, _rspec, _rres = cc_base._top_average_projector(bases, 421)
            stability = cc_base._overlap(carrier, repeat)
            head_overlaps = [
