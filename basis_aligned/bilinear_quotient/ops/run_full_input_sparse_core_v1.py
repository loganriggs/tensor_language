...
STEM='FULL_INPUT_SPARSE_CORE_V1'
...
def main():
    ...
    result=dict(pred_a=max(errors)<=1e-8,pred_b=reports[1]['capture']['4096']>=1.25*reports[0]['capture']['4096'],
                pred_c=reports[1]['capture']['4096']>=.5,reports=reports,identity_errors=errors,
