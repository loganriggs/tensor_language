"""Outcome-sealed syntax-preserving lexical/recombination holdout for aspect."""
...
_AGENTS = (
    "analyst", "baker", "dentist", "gardener", "historian", "inspector",
    "jeweler", "keeper", "librarian", "mechanic", "operator", "painter",
    "architect", "barber", "courier", "sailor",
)
_PERIODS = (
...
def _panel(group_number: int) -> list[dict[str, Any]]:
    ...
    group_id = f"FIT:{canonical_sha256([SCHEMA, TASK_ID, 'lexical_holdout_v2', SEED, group_number])[:24]}"
    sentence_types = (
