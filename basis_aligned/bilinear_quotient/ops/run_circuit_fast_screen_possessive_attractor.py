...
import circuit_fast_screen_candidate_possessive_attractor as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_possessive_attractor_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/possessive_number_animate_attractor_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "possessive-number-animate-attractor-v1"
EXPERIMENT_ID = "fast-screen-possessive-number-animate-attractor-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "9d73c726b125cff1a0e5916a363b93e3a20c462e539d8d8dee1b3039c0040a50"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "c10e0d064bb5fbb3186f7d492e7e06f8d142094479e8900c171a465426c01d24"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    proposed_operation="carry number to an ADJACENT possessive pronoun in two constructions",
