...
import circuit_fast_screen_candidate_possessive_medial as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_possessive_medial_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/possessive_number_medial_antecedent_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "possessive-number-medial-antecedent-v1"
EXPERIMENT_ID = "fast-screen-possessive-number-medial-antecedent-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "bdc1ff77ede18bf7f2d93480e077c4b715271d840dd69c1d1c7d43d52b000a0d"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "23269243d381218ed1256da2ad83411127591a8e030a77bf415baf0301915e2f"
)
