#!/usr/bin/env python3
"""Capability-only wrapper for the sealed v11 temporal authority."""
...
PRIOR = ROOT / "circuits/prior_art/temporal_auxiliary_will_had_fresh_v11_capability_v1.json"
OUT = ROOT / "circuits/followups/temporal_auxiliary_will_had_fresh_v11_capability_v1_result.json"
CANDIDATE_ID = "temporal_auxiliary.will_vs_had.fresh_v11_capability_v1"
EXPECTED = {"prior": "55cbb061695c8945f411d95c839ecd6988281aa85f25a4249fe0f5f2162dd262",
...
def configure():
    ...
    def write_result(_path, result):
        result["schema"] = "temporal_auxiliary_fresh_v11_capability_result_v1"
