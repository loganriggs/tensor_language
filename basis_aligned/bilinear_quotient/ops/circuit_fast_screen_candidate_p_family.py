"""Numeric-sequence discriminator replacing digit P with word P."""
...
CONFIG = shared.NumericSequenceCandidateConfig(
    task_id="numeric_sequence.p_family_discriminator",
    prior_art_name="fast_screen_p_family_prior_art.json",
    family_map={
