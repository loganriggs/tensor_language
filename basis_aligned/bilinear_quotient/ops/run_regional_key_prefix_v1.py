#!/usr/bin/env python3
# BQGATE:112 existing rows through14blocks;14 short prefixes plus zero anchors;180sec;no fit;compact artifact.
...
def main():
    ...
    prefixes=sorted(prefixes); assert len(rows)==112 and len(prefixes)==14
    buckets={}
    ...
    result=dict(pred_a=a,pred_b=a and maxima['attention']<=.1,pred_c=a and maxima['mlp']<=.1,
