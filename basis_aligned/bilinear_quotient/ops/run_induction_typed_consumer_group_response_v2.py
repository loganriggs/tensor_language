...
BINDING = POLY / "INDUCTION_TYPED_CONSUMER_GROUP_RESPONSE_V2_BINDING.json"
OUT = POLY / "INDUCTION_TYPED_CONSUMER_GROUP_RESPONSE_V2_RESULT.json"
CANDIDATE_GROUPS = {
...
def main():
    ...
    result = {
        "experiment": "induction_typed_consumer_group_response_v2",
