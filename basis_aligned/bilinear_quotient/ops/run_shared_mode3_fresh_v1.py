...
Primary shared_affine256: natural/hybrid<=15%,change<=20%, <=1.10independent128
in everydomain/cohort. Freshdocument-indexedFW, reusedcode. No fitting.
"""
import os,json,sys
...
def main():
 ...
 run.PROGRAM_FILE='SHARED_MODE3_FRESH_PROGRAMS_V1.pt';run.PLAN_FILE='SHARED_MODE3_FRESH_PLAN_V1.json';run.DONOR_FILE='SHARED_MODE3_FRESH_DONORS_V1.pt';run.TOKEN_FILE='SHARED_MODE3_FRESH_TOKENS_V1.pt';run.OUTPUT_FILE='SHARED_MODE3_FRESH_NATIVE_V1.json'
 run.PRIMARY='shared_affine256';run.ANCHOR='independent128';run.FORWARDS=48;run.MODE_INDEX=2;run.FOLD_FILE='MODE3_ORIGINAL_SOURCE_FORMS_V1.pt';run.INCLUDE_NATURAL=True
 run.main()
