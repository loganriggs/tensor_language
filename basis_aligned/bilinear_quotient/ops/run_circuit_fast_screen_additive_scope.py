...
import circuit_fast_screen_candidate_additive_scope as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_additive_scope_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/additive_scope_not_only_vs_plain_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "additive-scope-not-only-vs-plain-v1"
EXPERIMENT_ID = "fast-screen-additive-scope-not-only-vs-plain-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "b49e6b72d7c9e11ac3b7ab59b9f37ceff51cb67074c9068515a0826126fa51f6"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "77c14c9ad6b644b4523adf690636d4fc6e336852961097e4bec23fed278883d6"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="whether a scope operator is present",
    proposed_operation="carry the scope operator across the object in two constructions",
    proposed_write="evidence for but rather than and",
