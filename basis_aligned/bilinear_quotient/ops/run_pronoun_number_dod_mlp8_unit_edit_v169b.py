...
PRICE (registered maximum): 3 batches x (native + producer + 3 arms + 16 nulls) = 63 forwards; 0 backwards; 0 fits. Bar <= 66. (v169 ran to completion but its
receipt was withheld by the price guard: 63 > the mis-registered 46 -- the 96-row panel is three batches. Same numbers expected; readers made explicit and
number-free here (v169 inherited the lib defaults, including was-were, which is number-marked).)
"""
...
OUT = ROOT / "circuits/followups/pronoun_number_dod_mlp8_unit_edit_v169b_result.json"
V164 = ROOT / "circuits/followups/pronoun_number_dod_mlp8_unit_census_v168_result.json"
CANDIDATE_ID = "pronoun_number.they_vs_he.dod_mlp8_unit_edit_v169b"
