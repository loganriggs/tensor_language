...
"""person_object_control DoD (v156): the run_person_object_control_dod_battery_v105 set on Pile rows (out-of-corpus) (PREDICTS OOD). Body: `dod_natural_line.run`; rows receipt `circuits/followups/person_object_control_dod_pile_rows_v156.json` (outcome-blind
...
CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_pile_v156"
ROWS = N.ROOT / "circuits/followups/person_object_control_dod_pile_rows_v156.json"
OUT = "person_object_control_dod_pile_v156_result.json"
