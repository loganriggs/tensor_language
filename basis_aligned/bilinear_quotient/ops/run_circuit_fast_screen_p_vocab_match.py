...
import circuit_fast_screen_candidate_p_vocab_match as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_p_vocabulary_match_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/numeric_sequence_p_vocab_match_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "numeric-sequence-p-vocab-match-v1"
EXPERIMENT_ID = "fast-screen-numeric-sequence-p-vocab-match-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "c74e4f9bd7114880aef5215cc87f3d764e3c9692adbe50d6a9cbd1a388f478c2"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "84a0e17029bbf09dd96c973a096fc555297f1e2d5afa368973b54347b8e39bb8"
)
