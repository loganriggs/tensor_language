...
"""Pronoun number they/he DoD (v275): the MLP-6 trio {2483, 2826, 4131} zeroed at the ANNOTATED VERB of the natural rows. v248 found the verb-site units undetectable at cue + 1, where the
...
OUT = ROOT / "circuits/followups/pronoun_number_dod_mlp6_trio_verb_natural_v275_result.json"
...
CANDIDATE_ID = "pronoun_number.they_vs_he.dod_mlp6_trio_verb_natural_v275"
LAYER, UNITS, CONGRUENT = 6, (2483, 2826, 4131), ("natural_plural_they", "natural_singular_he")
NULL_SEEDS = tuple(range(8601, 8617))
...
def main() -> None:
    ...
    OUT.write_text(json.dumps({"schema": "pronoun_number_dod_mlp6_trio_verb_natural_v275_result", "candidate_id": CANDIDATE_ID, "plan": plan, "instrument_max_abs_error": instrument, "arms": arms, "null_damage_max": null_max, "null_moves": null_moves, "nulls": nulls, "gates": gates,
