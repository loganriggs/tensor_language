"""degree_frame.canonical_control -- degree_frame.comparative_vs_equative scored against the CANONICAL same-answer control.
...
TASK_ID = "degree_frame.canonical_control"
DEGREE = (" than", " as")
