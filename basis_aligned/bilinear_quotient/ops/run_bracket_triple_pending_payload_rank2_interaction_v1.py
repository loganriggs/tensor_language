...
PREREG = POLY / "BRACKET_TRIPLE_PENDING_PAYLOAD_RANK2_INTERACTION_V1_PREREGISTRATION.md"
BINDING = POLY / "BRACKET_TRIPLE_PENDING_PAYLOAD_RANK2_INTERACTION_V1_BINDING.json"
OUT = POLY / "BRACKET_TRIPLE_PENDING_PAYLOAD_RANK2_INTERACTION_V1_RESULT.json"
...
def main():
    ...
    try:
        with torch.inference_mode():
            native = exact.native_logits(model, tokens, tm, F)
            replay, factors = exact.factor_forward(model, tokens, finals_t, {}, tm, F, facade)
    ...
    result = {
        "schema": "bracket_triple_pending_payload_rank2_interaction_v1_result",
