...
import circuit_fast_screen_candidate_polarity_canonical_v2 as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_polarity_canonical_v2_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/polarity_state_canonical_control_v2_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "polarity-state-canonical-control-v2"
EXPERIMENT_ID = "fast-screen-polarity-state-canonical-control-v2"
EXPECTED_AUTHORITY_SHA256 = (
    "2607721a0c830fa3015730c72c10fd595325e3d6376bc6dd72929b65a7c396ca"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "8ef984436443a57a540ecdb9c79fd22429793bb7622d1206e6c750d5ee2ec551"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="whether the clause is negated",
    proposed_operation="carry clause polarity across the verb in two constructions",
