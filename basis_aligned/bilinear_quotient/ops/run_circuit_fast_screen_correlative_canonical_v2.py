...
import circuit_fast_screen_candidate_correlative_canonical_v2 as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_correlative_canonical_v2_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/correlative_state_canonical_control_v2_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "correlative-state-canonical-control-v2"
EXPERIMENT_ID = "fast-screen-correlative-state-canonical-control-v2"
EXPECTED_AUTHORITY_SHA256 = (
    "af4b72524139ccf4927f8fb03b9950a80b4c3ca602e0def042c9f6b9edc9cbcd"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "68fcb39ef4e4675743bab714d6a850f51de8a86a8c28e7fd59315e89901fe7dd"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="which correlative conjunction is open",
    proposed_operation="carry the open correlative across the noun phrase and two constructions",
    proposed_write="evidence for nor rather than or",
    ...
    semantic_position_role="final input token before the correlative second element",
    batch_size=32,
