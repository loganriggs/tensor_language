...
import circuit_fast_screen_candidate_list_p_family as candidate
...
RESULT_RELATIVE = Path(
    "circuits/fast_screens/numbered_list_p_family_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "numbered-list-p-family-v1"
EXPERIMENT_ID = "fast-screen-numbered-list-p-family-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "4348ff097f87c0747b50496ef7afebf2c5d524be5cdf2250b318101f76a84e08"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "f4d5237a3bf6064ef12b103c4033908f1aa4fcf6e54778307c17799dbc57f8e5"
)
