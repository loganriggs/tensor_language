#!/usr/bin/env python3
# BQGATE:48prefixes;912suffixes;180seconds.
...
48prefixes;912suffixes;180seconds. Two existing rank48 subspaces, two branches,
...
@torch.no_grad()
def main():
    binding=json.loads((P/'PARENT_KEY_MAIN_EFFECT_V1_BINDING.json').read_text())
    ...
    if os.environ.get('BQLIB_DRYRUN') or os.environ.get('BQLIB_NO_MODEL'):
        print('48prefixes;912suffixes;180seconds');return
    out=P/'PARENT_KEY_MAIN_EFFECT_V1_RESULT.json';assert not out.exists()
