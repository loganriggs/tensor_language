...
import circuit_fast_screen_candidate_narrative_tense_canonical_v2 as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_narrative_tense_canonical_v2_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/narrative_tense_canonical_control_v2_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "narrative-tense-canonical-control-v2"
EXPERIMENT_ID = "fast-screen-narrative-tense-canonical-control-v2"
EXPECTED_AUTHORITY_SHA256 = (
    "962dfcb0c2a55b5689bd0599f63095f7125c6c2a71e68fc64eecd5483878d103"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "1008b81c36c631e70653324173c842b404750922b2bd1edf6bffe2e1ddf2b75e"
)
