...
import circuit_fast_screen_candidate_modal_remoteness as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_modal_remoteness_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/modal_remoteness_would_vs_will_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "modal-remoteness-would-vs-will-v1"
EXPERIMENT_ID = "fast-screen-modal-remoteness-would-vs-will-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "77d028fb334902342cf512a5c98d4ceeb6b0d09f9eb7d3df75e77464c1cbbcdf"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "7214fe064cfd9b1ec77aef168089641b148c7289d4abaf15c0a5c90e5898c89b"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="whether the conditional antecedent is remote",
    proposed_operation="carry conditional remoteness across the consequent subject in two constructions",
    proposed_write="evidence for would rather than will",
