#!/usr/bin/env python3
# BQGATE: EXPERIMENT pred_a_instrument pred_b_components pred_c_coefficients pred_d_arithmetic
...
def main():
 plan=json.loads((P/'FREE_PRIVATE_NATIVE_PLAN_V1.json').read_text())
 if os.environ.get('BQLIB_DRYRUN') or os.environ.get('BQLIB_NO_MODEL'):print(json.dumps(plan));return
 import torch
 sys.path.insert(0,str(P));from free_private_varpro import FreePrivateMetric,parameters_from_private
 ...
 assert not (P/'FREE_PRIVATE_NATIVE_V1.json').exists()
