...
PANELS = {
    ...
    "noun_number_v158_agents": ('researcher', 'retailer', 'reviewer', 'secretary', 'servant', 'sniper', 'sorcerer', 'supervisor', 'technician', 'therapist', 'translator', 'treasurer', 'veterinarian', 'waitress', 'baby', 'child'),
    "noun_number_v158_objects": ('honey', 'jam', 'candy', 'cookie', 'pasta', 'pizza', 'album', 'anthem', 'banner', 'canopy', 'capsule', 'carriage', 'cassette', 'charm', 'cigar', 'coffin'),
    "noun_number_v158_adjectives": ('thick', 'thin', 'flat', 'square', 'odd', 'stale', 'ripe', 'sour', 'bitter', 'cool', 'wet', 'hard', 'loud', 'costly', 'crisp', 'sleek'),
...
# Second screened object pool (2026-09-18 10:43 UTC), appended after the first was exhausted; appending keeps earlier runners' picks stable.
OBJECT_POOL_2 = ('album', 'anthem', 'banner', 'canopy', 'capsule', 'carriage', 'cassette', 'charm', 'cigar', 'coffin', 'collar', 'comet', 'crane', 'crib', 'crystal', 'diary', 'dome', 'dungeon', 'emblem', 'engine', 'fabric', 'feather', 'fossil', 'gem', 'globe', 'gown', 'hatch', 'idol', 'jewel', 'kernel', 'ledger', 'mast', 'mosaic', 'nozzle', 'palette', 'parcel', 'pearl', 'pillar', 'plank', 'pouch', 'relic', 'rune', 'stump', 'tablet', 'throne', 'token', 'turret', 'vault', 'yacht')
OBJECT_POOL = OBJECT_POOL + OBJECT_POOL_2
