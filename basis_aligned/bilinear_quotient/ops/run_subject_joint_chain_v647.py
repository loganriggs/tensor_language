...
OUT=ROOT/'basis_aligned/bilinear_quotient/circuits/followups/subject_joint_chain_v647_result.json'
    ...
    def score(c,panel):
        for name,program in programs.items():
            ...
            for l,p in enumerate(program):
                ...
                h=c['base']['backgrounds'][l];m0=c['base']['mlp_writes'][l]@frames[l+1]
