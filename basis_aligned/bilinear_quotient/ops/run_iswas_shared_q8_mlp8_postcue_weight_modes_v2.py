...
PREDICTION_KEYS = (
    "pred_a_authority_exact_factor_weight_closure_finiteness_and_price",
    "pred_b_rank8_weight_modes_preserve_the_postcue_writer",
    "pred_c_rank8_complement_is_secondary",
    "pred_d_left_right_terms_explain_the_weight_mode_write",
    "pred_e_weight_interface_is_compressive_and_zero_fit",
)
