"""correlative_state.canonical_control -- correlative_state.either_vs_neither scored against canonical control V2 (disjoint vocabulary).
...
TASK_ID = "correlative_state.canonical_control_v2"
CORRELATIVE = (" or", " nor")
