...
"""Selection family DoD (v93): the run_selection_particle_dod_battery_v86 set on natural FineWeb rows (training corpus, out-of-panel) (PREDICTS OOD).
Body: `dod_natural_line.run`. Rows: `selection_dod_natural_rows.py` (generic miner `dod_natural_miner.py`, receipt
`circuits/followups/selection_updown_dod_natural_rows_v93.json`), cue token within 12 tokens of a next token ' up' / ' down'; congruent cells ("natural_woke_up", "natural_calmed_down")
...
CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_natural_v93"
ROWS = N.ROOT / "circuits/followups/selection_updown_dod_natural_rows_v93.json"
OUT = "selection_updown_dod_natural_v93_result.json"
