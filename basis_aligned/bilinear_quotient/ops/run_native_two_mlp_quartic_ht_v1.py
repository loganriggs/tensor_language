...
ROOT=Path(__file__).resolve().parents[3];P=ROOT/'basis_aligned/polynomial_causal';A=ROOT/'basis_aligned/bilinear_quotient/circuits/followups';OUT=A/'native_two_mlp_quartic_ht_v1_result.json'
...
def main():
    ...
    export=A/'native_two_mlp_quartic_ht_v1.pt';guard_torch_save(exports,label=export.name);torch.save(exports,export)
