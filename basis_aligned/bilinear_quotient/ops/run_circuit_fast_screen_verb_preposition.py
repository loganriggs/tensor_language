...
"""Thin verb-preposition wrapper for the generic managed FIT screen."""

from __future__ import annotations

from pathlib import Path

import circuit_fast_screen_candidate_verb_preposition as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_verb_preposition_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/verb_preposition_relied_vs_objected_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "verb-preposition-relied-vs-objected-v1"
EXPERIMENT_ID = "fast-screen-verb-preposition-relied-vs-objected-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "b7187b5303620d103c28c11555ece2ada934dbead8d57f98e157c0c9afba921b"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "46f3ded19491f1b85254bff2159f0c69c3a98287c8ce2b4c8f50efea403e3453"
)
REGISTERED_PREDICTIONS = (
    ("pred_a_native_capability", "Every ordered native capability cell passes."),
    ("pred_b_cross_construction_transfer", "One site transfers both verb-frame constructions."),
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="which prepositional frame the verb opens",
    proposed_operation="carry the verb frame across the intervening adverbial in two constructions",
    proposed_write="evidence for on rather than to",
    alternative_explanation=(
        "a local reading of the verb token rather than a frame carried across the adverbial"
    ),
    circuit_prediction=(
        "one site transfers the on/to decision in both constructions while sparing the agent rewrite"
    ),
    opposing_null_prediction=(
        "native capability fails, or no site transfers both constructions"
    ),
    semantic_position_role="final input token before the preposition",
    batch_size=32,
