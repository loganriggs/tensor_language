#!/usr/bin/env python
"""late_tail_gate_mode_rank_probe -- how many CORE directions independently modulate each late MLP's linear tail read. The cross term
...
Preregistration: polynomial_causal/LATE_TAIL_GATE_MODE_RANK_PROBE_PREREGISTRATION.md
"""
...
SELF = Path(os.path.abspath(sys.argv[0])) if sys.argv and sys.argv[0].endswith(".py") else Path("/workspace/tensor_language/basis_aligned/bilinear_quotient/ops/late_tail_gate_mode_rank_probe.py")
sys.path.insert(0, str(SELF.parent))
import mlp_in_situ_usage_rank_map_probe as R

if not torch.cuda.is_available():
    raise RuntimeError("late_tail_gate_mode_rank_probe is a lane-1 CUDA script; refusing to fall back to CPU")
DEV = torch.device("cuda")
ROOT = R.ROOT
PREREG = R.POLY / "LATE_TAIL_GATE_MODE_RANK_PROBE_PREREGISTRATION.md"
PRIOR = ROOT / "late_tail_readout_rank_probe_results.json"   # §2798
OUT = ROOT / "late_tail_gate_mode_rank_probe_results.json"
HASHES = {PREREG: "dfe74247f84524d52548db22cbda4c742cd8341964dfd75849606c13257ba7f1", PRIOR: "e7098c78f4c999052b202d1131c65791a121924b3eb9cdf8efb220334fa35cc6",
          R.BLOB: "680d6c26cf05af2e9b5eaac1d52fa1c9e4ea443f60a7c74ad211740e317d6de3",
          R.NAT: "666a32015c8ab3dcbabca4a859f5a0c8a3e1b9b9cc8f0b7f7c9e5211d903e2a1"}
RUNG = "late_tail_gate_mode_rank_probe"
