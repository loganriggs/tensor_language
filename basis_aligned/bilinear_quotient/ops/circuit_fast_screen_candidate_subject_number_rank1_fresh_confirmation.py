#!/usr/bin/env python3
"""Frozen fresh authority for subject-number rank-one confirmation."""
...
SCHEMA = "subject_number_rank1_fresh_confirmation_authority_v1"
TASK_ID = "subject_verb.number_agreement"
CAPABILITY_ID = "subject_verb.number_agreement.rank1_fresh_confirmation_capability_v1"
CAUSAL_CANDIDATE_ID = "subject_verb.number_agreement.direction_cardinality_rank1_fresh_confirmation_v1"
SUBJECT_POSITION = 8
ROLES = ("recipient", "opposite_same_lemma", "same_number_different_lemma")
TEMPLATES = (
    ("behind_beside", "Behind the {a1} beside the {a2}, the {subject}"),
    ("among_behind", "Among the {a1} behind the {a2}, the {subject}"),
)
NOUN_PAIRS = (
    ("activist", "activists"), ("adviser", "advisers"),
    ("advocate", "advocates"), ("aide", "aides"),
    ("applicant", "applicants"), ("assistant", "assistants"),
    ("associate", "associates"), ("backer", "backers"),
    ("beginner", "beginners"), ("biologist", "biologists"),
    ("blogger", "bloggers"), ("borrower", "borrowers"),
    ("broker", "brokers"), ("civilian", "civilians"),
    ("claimant", "claimants"), ("cleaner", "cleaners"),
)
EXPECTED_AUTHORITY_SHA256 = "f77914228dd2dabef7045fcd588ad172df1ed3bdd5006399f72d215553931830"
