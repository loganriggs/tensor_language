...
# BQLANE: cpu
"""Pronoun number they/he: natural rows with a VERB annotation (v272, fineweb). Same cells and filters as v77 / v78 (a position whose next token is ' they' or ' he',
...
OUT = Path(__file__).resolve().parent.parent / "circuits/followups/pronoun_number_dod_natural_verb_rows_v272.json"

if __name__ == "__main__":
    cues = {tid: number for tid, (w, number) in base.NOUNS.items()}
    labels = {base.THEY: "they", base.HE: "he"}
    M.mine(cues, labels, "fineweb", OUT, "pronoun_number_dod_natural_verb_rows_v272", exclude=base.PRONOUNS, cue_window=base.CUE_WINDOW, context=base.CONTEXT, per_cell=base.PER_CELL,
