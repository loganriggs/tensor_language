...
import circuit_fast_screen_candidate_polarity_canonical as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_polarity_canonical_control_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/polarity_state_canonical_control_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "polarity-state-canonical-control-v1"
EXPERIMENT_ID = "fast-screen-polarity-state-canonical-control-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "8a8b0da9e20b15e1371504f3ad980e63424b601b38f46aa5e2b8761ec2dd9026"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "78b29270a1da018e2898081cdce5bdd6ff320d432d863c3c3a97a24fe8f99d2f"
)
