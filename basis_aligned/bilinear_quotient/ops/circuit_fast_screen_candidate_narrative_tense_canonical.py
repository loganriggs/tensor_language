"""narrative_tense.canonical_control -- narrative_tense.past_vs_present scored against the CANONICAL same-answer control.
...
TASK_ID = "narrative_tense.canonical_control"
TENSE = (" was", " is")
