...
"""Pythia-70m at step 4000 (8.4B tokens) — the smallest model is the LEAST compressible at 300B (v761: rank 32 rec 0.881, rank 16 0.806); is it on the training-length curve early on? H3 predicts ~0.98 / ~0.95 at 8B tokens like 160m (v766: 0.982 / 0.947); if 70m's density were a size effect it would already be low here. All-in-one, ROW-CENTRED logits (Logan, 22 Sep: 'try a few sets of pythia models, then other models, to test the specific hypothesis of why
