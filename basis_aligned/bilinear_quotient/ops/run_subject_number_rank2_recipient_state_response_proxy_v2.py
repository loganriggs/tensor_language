...
CORRECTION = POLY / "SUBJECT_NUMBER_RANK2_RECIPIENT_STATE_RESPONSE_PROXY_V2_CORRECTION.md"
...
BINDING = POLY / "SUBJECT_NUMBER_RANK2_RECIPIENT_STATE_RESPONSE_PROXY_V2_BINDING.json"
OUT = ROOT / "circuits/fast_screens/subject_number_rank2_recipient_state_response_proxy_v2_result.json"
...
def plan():
    ...
    return {"schema": "subject_number_rank2_recipient_state_response_proxy_v2_plan",
