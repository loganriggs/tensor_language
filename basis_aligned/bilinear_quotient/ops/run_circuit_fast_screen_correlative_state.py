...
import circuit_fast_screen_candidate_correlative_state as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_correlative_state_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/correlative_state_either_vs_neither_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "correlative-state-either-vs-neither-v1"
EXPERIMENT_ID = "fast-screen-correlative-state-either-vs-neither-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "175e8ee6b92b843e158eacc2deb2c6bafa1c6df54abcfa1207ea9b05bd013079"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "3d948ef5d0bc2fc907d8918b96341de692276915ba8bce239717dca0d40bf51a"
)
