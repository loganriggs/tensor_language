...
import circuit_fast_screen_candidate_voice_frame as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_voice_frame_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/voice_frame_passive_vs_active_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "voice-frame-passive-vs-active-v1"
EXPERIMENT_ID = "fast-screen-voice-frame-passive-vs-active-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "6a44ac8bb0f6ef826fa80bedb242c785638a23e9059f442971e02ed3660b30fa"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "f73babc65f524c3c009a4256516d6f7bab20eac0866bbd97807e927bcb8e7b64"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="whether the clause is passive",
    proposed_operation="carry grammatical voice to the post-participle slot in two constructions",
    proposed_write="evidence for by rather than the",
