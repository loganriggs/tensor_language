...
"""Pronoun gender he/she DoD (v178): the male-noun detector's PRODUCT, exactly, as writer-pair terms. u_3152(noun) = (L . x)(R . x) with x = x_8[noun] / rms
...
OUT = ROOT / "circuits/followups/pronoun_gender_dod_unit3152_pair_fold_v178_result.json"
CANDIDATE_ID = "pronoun_gender.he_vs_she.dod_unit3152_pair_fold_v178"
UNIT, CLOSURE_TOL, H81_MIN = 3152, 1e-3, 0.30
FORWARDS_MAX = 4
WRITERS = v16.WRITERS
