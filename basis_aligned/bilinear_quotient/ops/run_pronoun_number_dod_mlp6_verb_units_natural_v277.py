...
"""Pronoun number they/he DoD (v277; v275 zeroed the NOUN-site trio by mistake): the VERB-site MLP-6 units {69, 2483} (v241: 38% + 31% of MLP 6 into 829 at the verb) zeroed at the ANNOTATED VERB of the natural rows. v248 found the verb-site units undetectable at cue + 1, where the
...
PREDICTIONS (scored as written; failures preserved; priors from the panel)
    ...
    pred_b_congruent_damage_live            congruent rows: damage fraction >= 0.005 and positive >= 0.60
...
OUT = ROOT / "circuits/followups/pronoun_number_dod_mlp6_verb_units_natural_v277_result.json"
...
CANDIDATE_ID = "pronoun_number.they_vs_he.dod_mlp6_verb_units_natural_v277"
LAYER, UNITS, CONGRUENT = 6, (69, 2483), ("natural_plural_they", "natural_singular_he")
NULL_SEEDS = tuple(range(8801, 8817))
...
def main() -> None:
    ...
    OUT.write_text(json.dumps({"schema": "pronoun_number_dod_mlp6_verb_units_natural_v277_result", "candidate_id": CANDIDATE_ID, "plan": plan, "instrument_max_abs_error": instrument, "arms": arms, "null_damage_max": null_max, "null_moves": null_moves, "nulls": nulls, "gates": gates,
