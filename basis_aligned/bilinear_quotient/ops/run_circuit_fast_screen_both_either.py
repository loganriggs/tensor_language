...
import circuit_fast_screen_candidate_both_either as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_both_vs_either_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/correlative_pair_both_vs_either_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "correlative-pair-both-vs-either-v1"
EXPERIMENT_ID = "fast-screen-correlative-pair-both-vs-either-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "c6beebf83a692ca983822d5b4f8f1f574685a6eafa151d9963275420cf9b1c31"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "1e7353ca15151829670b5ac643920a370da1b29e1e217ba5df97963b95d745df"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="which correlative is open",
    proposed_operation="carry the open correlative across the object noun in two constructions",
    proposed_write="evidence for and rather than or",
