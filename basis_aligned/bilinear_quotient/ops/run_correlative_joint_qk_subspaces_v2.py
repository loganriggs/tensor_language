...
import correlative_joint_qk_executor_v2 as J
...
OUT=POLY/'CORRELATIVE_JOINT_QK_SUBSPACES_V2_RESULT.json';BIND=POLY/'CORRELATIVE_JOINT_QK_SUBSPACES_V2_BINDING.json'
...
def main():
    ...
    control=json.loads((POLY/'JOINT_ROTARY_PRODUCT_COORDINATES_V1_CONTROL.json').read_text());assert control['joint_transport_relative_error']<=1e-10
