...
"""noun_number_numeral DoD (v162): RESPONSE CENSUS of the run_noun_number_numeral_dod_battery_v158 set removal on its fresh rows (better_circuits §3.3). Body: v74's from the set's lowest block.
...
v74.OUT = v74.ROOT / "circuits/followups/noun_number_numeral_dod_response_census_v162_result.json"
v74.CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_response_census_v162"
v74.FORWARDS_MAX = 8
