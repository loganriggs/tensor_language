#!/usr/bin/env python3
"""possessive_person_my_their.I_vs_they -- a possessive DETERMINER mapping on an axis the family does not yet cover.
...
against the THIRD person: ' my' versus ' their' pits a first-person possessor against a third-person one.
...
SPEC = bs.BehaviourSpec(
    task_id="possessive_person_my_their.I_vs_they",
    vocabulary=(' my', ' their'),
    generator_role="generate_linked_possessive_person_my_their_fit_panels",
    answer_role="score_jointly_tokenized_my_versus_their",
    a1=bs.Family("bare_frame", "bare_frame_person_swap", lambda i, pos: f"Near the {_obj(i)} {'I' if pos else 'they'} kept the crate, of course, since it was"),
    a2=bs.Family("paid_frame", "paid_frame_person_swap", lambda i, pos: f"Because {'I' if pos else 'they'} paid the {_adj(i)} {_agent(i)}, of course, the crate became"),
    p_donor=lambda i, pos: f"Near the {_adj2(i)} {_obj(i)} {'I' if pos else 'they'} kept the crate, of course, since it was",
