"""Numeric-sequence discriminator replacing related-numeral C with punctuation C."""
...
CONFIG = shared.NumericSequenceCandidateConfig(
    task_id="numeric_sequence.control_choice_discriminator",
    prior_art_name="fast_screen_sequence_control_choice_prior_art.json",
    family_map={
