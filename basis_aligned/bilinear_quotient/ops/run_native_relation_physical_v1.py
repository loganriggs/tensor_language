...
"""Test frozen 48-square native suffix program as physical readout-span writes.
...
STEM='NATIVE_RELATION_PHYSICAL_V1'
...
def main():
    ...
    result={'pred_a':a,'pred_b':a and all(c['transfer_held'] for c in cells),
        ...
        'readout_gram_condition':condition,'records':records,'seconds':time.perf_counter()-started,
        ...
        'retains radial and bias; native complement/background remains. No fitting, fresh OOD or automatic promotion. '
