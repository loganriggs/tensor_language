...
"""Signed/mixed post11 source-amplitude stress on now-opened v691 rows.
...
OUT=ROOT/'basis_aligned/bilinear_quotient/circuits/followups/subject_attention_freeze_v692_result.json'
