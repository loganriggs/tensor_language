...
STEM='TYPED_FACE_REDUCED_RESIDUAL7_V1';ARMS=['native','native8_midpoint','compiled']
PACKAGE=P/'extracted_circuits/typed_face_reduced_residual7_v1'
...
def main():
 ...
 v=expand(values,mapping,6);e=v-v[:1];old=torch.load(P/'HEAD2_MLP8_CROSS_FRESH_V1_ARTIFACT.pt',weights_only=True)['values'];anchor=float((v[:2]-old[[0,1]]).abs().max());records={}
