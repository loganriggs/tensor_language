...
import circuit_fast_screen_candidate_verb_complementizer_canonical_v2 as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_verb_complementizer_canonical_v2_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/verb_complementizer_canonical_control_v2_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "verb-complementizer-canonical-control-v2"
EXPERIMENT_ID = "fast-screen-verb-complementizer-canonical-control-v2"
EXPECTED_AUTHORITY_SHA256 = (
    "728442ac45af81784d85bf524b322741d3162a6fd0cafd852bae7d055267ad73"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "f3201bce887fbc7b0b5b7a134e0d971eb410f4b22ff90ffeecf937ede6d15923"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="which complement type the matrix verb selects",
    proposed_operation="carry verb subcategorization across the adverb in two constructions",
    proposed_write="evidence for whether rather than that",
    ...
    semantic_position_role="final input token before the complementizer",
    batch_size=32,
