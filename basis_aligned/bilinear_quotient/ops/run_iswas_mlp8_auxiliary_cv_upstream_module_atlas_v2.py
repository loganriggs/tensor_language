#!/usr/bin/env python3
"""Native-reconstruction-scope repair of the auxiliary c_v upstream module atlas."""
...
PRIOR = ROOT / "circuits/prior_art/iswas_mlp8_auxiliary_cv_upstream_module_atlas_v2.json"
V1_RESULT = ROOT / "circuits/followups/iswas_mlp8_auxiliary_cv_upstream_module_atlas_v1_result.json"
...
OUT = ROOT / "circuits/followups/iswas_mlp8_auxiliary_cv_upstream_module_atlas_v2_result.json"
CANDIDATE_ID = "cross_task.iswas_mlp8_auxiliary_cv_upstream_module_atlas_v2"
...
EXPECTED = {
    "prior": "b28600025ae84d94a170657d0b9bf415f53bd1fceb3d2ece0620a47b334b3598",
    "v1_result": "72edcd48fb7fd57a808cde80452adbae4dc5740b51a2ff2fc8b90fc44e65b312",
...
def main():
    paths = {"prior": PRIOR, "v1_result": V1_RESULT, "parent": PARENT, "parent_runner": PARENT_RUNNER,
    ...
    if (prior.get("candidate_id") != CANDIDATE_ID or parent.get("terminal") != "screen"
            or v1_result.get("terminal") != "invalid"
    ...
    result = {"schema": "iswas_mlp8_auxiliary_cv_upstream_module_atlas_result_v2",
