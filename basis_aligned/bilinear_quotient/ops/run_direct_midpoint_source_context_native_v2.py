...
def main():
 ...
 native.EXTRA_PRODUCT_FILE='MIDPOINT_CENTERED_CORRECTION_GRAPHS_V1.pt';native.SOURCE_CONTEXT_FAMILIES=True;native.OUTPUT_NAME='MIDPOINT_SOURCE_CONTEXT_NATIVE_RAW_V2.json';native.main()
