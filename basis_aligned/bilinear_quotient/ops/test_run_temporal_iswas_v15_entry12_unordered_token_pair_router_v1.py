import run_temporal_iswas_v15_entry12_unordered_token_pair_router_v1 as runner


def test_frozen_token_router_scope_and_price_are_exact():
    assert runner.finite_router.CLASSES == ("A1", "A2", "off")
    assert runner.PRICE_MAX["differentiable_transformer_forwards"] == 24
    assert runner.PRICE_MAX["fit_parameters"] == 2
