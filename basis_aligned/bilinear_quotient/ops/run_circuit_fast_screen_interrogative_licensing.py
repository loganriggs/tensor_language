...
import circuit_fast_screen_candidate_interrogative_licensing as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_interrogative_licensing_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/interrogative_licensing_question_vs_declarative_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "interrogative-licensing-question-vs-declarative-v1"
EXPERIMENT_ID = "fast-screen-interrogative-licensing-question-vs-declarative-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "cf54cc3b638722b867bda8dcfa94ea37e44cf93b5f19d5ffce323fbfe0af82a8"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "dccd280135bfe9f2a237ea5a6d50a7d04c33b7a2b263c3b509ceeb27e9c2ba89"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="whether the clause is a question",
    proposed_operation="carry interrogative mood across the verb in two constructions",
    proposed_write="evidence for any rather than some",
