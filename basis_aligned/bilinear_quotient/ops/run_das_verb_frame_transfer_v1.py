...
OUT = ROOT / "circuits/followups/das_verb_frame_transfer_v1_result.json"
SITE, RANK, STEPS = "resid:17", 1, 300
SPECIFIC, SHARED = 0.20, 0.50
MODEL_FORWARDS_MAX, EXAMPLE_EVALUATIONS_MAX = 40, 2560


def _plan():
    return {"candidate_id": "verb_frame.transfer_v1", "site": SITE, "rank": RANK,
...
def main() -> None:
    ...
    result = {**predictions, "predictions": predictions,
              ...
              "candidate_id": "verb_frame.transfer_v1",
              "site": SITE, "rank": RANK,
