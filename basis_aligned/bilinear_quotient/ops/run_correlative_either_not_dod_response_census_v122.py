...
"""correlative_either_not DoD (v122): RESPONSE CENSUS of the run_correlative_either_not_dod_battery_v119 set removal on its fresh rows (better_circuits §3.3). Body: v74's from the set's lowest block.
...
v74.OUT = v74.ROOT / "circuits/followups/correlative_either_not_dod_response_census_v122_result.json"
v74.CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_response_census_v122"
v74.FORWARDS_MAX = 8
