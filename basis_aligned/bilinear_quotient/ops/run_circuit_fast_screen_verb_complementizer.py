...
import circuit_fast_screen_candidate_verb_complementizer as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_verb_complementizer_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/verb_complementizer_whether_vs_that_v2_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "verb-complementizer-whether-vs-that-v2"
EXPERIMENT_ID = "fast-screen-verb-complementizer-whether-vs-that-v2"
EXPECTED_AUTHORITY_SHA256 = (
    "fc588776e057d2f174aa3cfe67dd899d57aaed9ec55ef82239129e03a7f75802"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "2b42c8f591959ddef8576399565c9c2a595591cc8a9cb439f068fce09f7bf2f2"
)
