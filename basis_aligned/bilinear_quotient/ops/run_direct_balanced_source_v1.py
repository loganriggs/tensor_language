...
"""Balanced-donor sensitivity:32 captures, all reused rows; programs unchanged.
...
run.PLAN_FILE='MIDPOINT_BALANCED_SOURCE_PLAN_V1.json'
run.DONOR_FILE='MIDPOINT_BALANCED_SOURCE_DONORS_V1.pt'
run.TOKEN_FILE='MIDPOINT_SHARED_SOURCE_TOKENS_V1.pt'
run.OUTPUT_FILE='MIDPOINT_BALANCED_SOURCE_NATIVE_V1.json'
