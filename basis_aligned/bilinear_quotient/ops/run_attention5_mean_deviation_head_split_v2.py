...
"""V2: identify which native heads carry attention5's input-dependent mean deviation."""
import json
import os
import signal
import sys
...
STEM = "ATTENTION5_MEAN_DEVIATION_HEAD_SPLIT_V2"
D, V, T, NH, HD = 1152, 50304, 257, 9, 128
...
def main():
    ...
    control = json.loads((P / "ATTENTION5_MEAN_DEVIATION_HEAD_SPLIT_V1_CPU_CONTROL.json").read_text())
