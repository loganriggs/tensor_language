...
import circuit_fast_screen_candidate_quote_parity as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_quote_parity_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/quote_parity_pending_close_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "quote-parity-pending-close-v1"
EXPERIMENT_ID = "fast-screen-quote-parity-pending-close-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "f3e904042b2a7edfa5dbc0c1bd6cd7484b3c98e9cd5eaf1091e17e1cb2a7ccd1"
)
