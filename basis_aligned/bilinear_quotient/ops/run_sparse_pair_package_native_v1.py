...
pred_e packaged regional/newline scores replay prior candidate <=1e-6relative.
...
STEM='SPARSE_PAIR_PACKAGE_NATIVE_V1'
...
def main():
 ...
 compact=load_program(P/'extracted_circuits/sparse_even_key_producers_8_2_9_8_v1/program.pt','cuda')
 ...
 def hook(index,head,module,args,output):
  ...
  selected=packaged_scalar(args[0],context['tokens'],compact,index)
  if arm==0:
 ...
 prior=torch.load(P/'SPARSE_SELECTIVE_PAIR_V1_ARTIFACT.pt',weights_only=True)
