...
"""Frozen sparse-number / attention12-plus-MLP modal path on48 fresh longer combinations.
...
OUT=ROOT/'basis_aligned/bilinear_quotient/circuits/followups/subject_attention_freeze_v691_result.json'
PREDICTIONS=dict(pred_a_exact_replay='original replay plus baseline tangent centralfinitechange relative error<=.01',
 ...
 pred_c_capable_position_transfer='sparse-number plus attention12/allMLP-modal A/B target<=.10,modal<=.05; everycell native capability>=.90 and native modal collateral<=.10')
