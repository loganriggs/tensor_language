...
Null: regionalcomponent doesnotgeneralize to changed cuechannels.
"""
...
STEM='SCALAR_CUE_CHANNEL_SHIFT_V1';FOLDER=P/'extracted_circuits/regional_even_key_producers_8_2_9_8_v1'
@torch.no_grad()
def main():
 ...
 if os.environ.get('BQLIB_DRYRUN') or os.environ.get('BQLIB_NO_MODEL'):print('216bodyforwards72newcue-channelrows;frozenrank64');return
