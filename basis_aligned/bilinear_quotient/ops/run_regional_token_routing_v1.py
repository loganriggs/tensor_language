...
STEM='REGIONAL_TOKEN_ROUTING_V1'
@torch.no_grad()
def main():
    ...
    prior=torch.load(P/'REGIONAL_BEHAVIOR_CONTROLS_V1_ARTIFACT.pt',weights_only=True,map_location='cpu');reference=prior['write_vertices'].cuda();native_delta=writes[:,1]-writes[:,0]
