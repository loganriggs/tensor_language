...
import circuit_fast_screen_candidate_possessive_verbfinal as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_possessive_verbfinal_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/possessive_number_verb_final_distance_six_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "possessive-number-verb-final-distance-six-v1"
EXPERIMENT_ID = "fast-screen-possessive-number-verb-final-distance-six-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "2e3548301c85e7900691c574bc3d1ef7c92cf7687c08eca1b433fc6c19adaf54"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "0a2afa0f24c20edc786682408e4430b427e5da977c303b017439335e8bb72e4d"
)
