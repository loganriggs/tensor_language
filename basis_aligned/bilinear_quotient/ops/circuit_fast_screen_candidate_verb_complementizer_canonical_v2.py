"""verb_complementizer.canonical_control -- verb_complementizer.whether_vs_that scored against canonical control V2 (disjoint vocabulary).
...
TASK_ID = "verb_complementizer.canonical_control_v2"
