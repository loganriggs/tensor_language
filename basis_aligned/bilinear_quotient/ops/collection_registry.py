...
LINES = [
    ...
    ("temporal", "narrative was/is", ("was", "is"), None, "narrative_dod_confirm_v43_result.json", "narrative_dod_random_set_null_v45_result.json", None, None, None, "NARRATIVE_DOD_SCORECARD.md"),
