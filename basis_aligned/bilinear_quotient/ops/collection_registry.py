...
LINES = [
    ...
    ("temporal", "narrative was/is", ("was", "is"), "FROM:narrative_tense_dod_sweep_and_set_v42_result.json", "narrative_tense_dod_confirm_v43_result.json", "narrative_tense_dod_random_set_null_v45_result.json", None, "narrative_dod_natural_v151_result.json", "narrative_dod_pile_v152_result.json", "NARRATIVE_DOD_SCORECARD.md"),
    ("temporal", "modal would/will", ("would", "will"), ["9.4", "11.3", "9.1", "15.5"], "modal_remoteness_dod_battery_v66_result.json", "modal_remoteness_dod_null_and_templates_v67_result.json", None, "modal_dod_natural_v153_result.json", "modal_dod_pile_v154_result.json", "MODAL_DOD_SCORECARD.md"),
    ...
    ("correlative", "correlative either/neither", ("or", "nor"), ["14.8", "8.1", "16.8", "5.7"], "correlative_either_neither_dod_battery_v147_result.json", None, None, "correlative_either_neither_dod_natural_v149_result.json", "correlative_either_neither_dod_pile_v150_result.json", "CORRELATIVE_EITHER_NEITHER_DOD_SCORECARD.md"),
    ("noun-number", "demonstrative these/this", ("ones", "one"), ["11.2", "7.8", "6.3", "15.1"], "noun_number_demonstrative_dod_battery_v157_result.json", "noun_number_demonstrative_dod_random_set_null_v159_result.json", "noun_number_demonstrative_dod_response_census_v160_result.json", None, None, "NOUN_NUMBER_DEMONSTRATIVE_DOD_SCORECARD.md"),
    ("noun-number", "numeral three/one", ("ones", "one"), ["11.2", "7.8", "15.1", "10.5"], "noun_number_numeral_dod_battery_v158_result.json", "noun_number_numeral_dod_random_set_null_v161_result.json", "noun_number_numeral_dod_response_census_v162_result.json", None, None, "NOUN_NUMBER_NUMERAL_DOD_SCORECARD.md"),
    ...
    ("person", "object control me/you", ("myself", "yourself"), ["13.1", "8.1", "10.5", "15.1"], "person_object_control_dod_battery_v105_result.json", "person_object_control_dod_random_set_null_v108_result.json", "person_object_control_dod_response_census_v109_result.json", "person_object_control_dod_natural_v155_result.json", "person_object_control_dod_pile_v156_result.json", "PERSON_OBJECT_CONTROL_DOD_SCORECARD.md"),
]
