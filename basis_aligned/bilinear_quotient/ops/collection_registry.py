...
LINES = [
    ...
    ("noun-number", "demonstrative these/this", ("ones", "one"), ["11.2", "7.8", "6.3", "15.1"], "noun_number_demonstrative_dod_battery_v157_result.json", None, None, None, None, "NOUN_NUMBER_DEMONSTRATIVE_DOD_SCORECARD.md"),
