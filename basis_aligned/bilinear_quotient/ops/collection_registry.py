...
LINES = [
    ...
    ("noun-number", "numeral three/one", ("ones", "one"), ["11.2", "7.8", "15.1", "10.5"], "noun_number_numeral_dod_battery_v158_result.json", None, None, None, None, "NOUN_NUMBER_NUMERAL_DOD_SCORECARD.md"),
