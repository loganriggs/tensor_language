...
"""Selection family DoD (v90): RESPONSE CENSUS of the run_selection_particle_dod_battery_v86 set removal on its fresh rows (better_circuits §3.3). Body: v74's (exact
...
v74.OUT = v74.ROOT / "circuits/followups/selection_particle_dod_response_census_v90_result.json"
v74.CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_response_census_v90"
v74.FORWARDS_MAX = 8
