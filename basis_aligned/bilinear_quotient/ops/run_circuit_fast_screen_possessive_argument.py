...
import circuit_fast_screen_candidate_possessive_argument as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_possessive_argument_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/possessive_number_inanimate_argument_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "possessive-number-inanimate-argument-v1"
EXPERIMENT_ID = "fast-screen-possessive-number-inanimate-argument-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "cca33a0f93eb9f45c63573a5c44f6b4eedff4a5800d6fc4e6f458c6bb6226e96"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "1921ad4100bff61ef7ff74fdd5b600ec41dab0b2e18801d9d8e03dc25dc3f5de"
)
