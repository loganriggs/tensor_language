"""degree_frame.canonical_control -- degree_frame.comparative_vs_equative scored against canonical control V2 (disjoint vocabulary).

A1, A2 and P are unchanged from the degree_frame.comparative_vs_equative authority. Only the control changes, to
...
TASK_ID = "degree_frame.canonical_control_v2"
DEGREE = (" than", " as")
...
def _panel(seed: int, group_number: int, case_index: int) -> list[dict[str, Any]]:
    ...
    common = dict(common_no_vocab, vocabulary=DEGREE)
    return [
