...
OUT=POLY/'CALIBRATION_TWO_READERS_V2_RESULT.json'
BINDING=POLY/'CALIBRATION_TWO_READERS_V2_BINDING.json'
...
def main():
    ...
    try:
        with torch.inference_mode():
            ...
            producer_path=POLY/'CALIBRATION_TWO_READERS_V2_PRODUCER.pt'
