...
STEM='GRADED_NATIVE_PLANE_AUDIT_V1'
FIT_SHA='aa056891e946d5ce09e79fa9ce5e4905a7bea7b5123eb97f9f56953d258ca273'
def main():
    ...
    terminal=json.loads((P/'GRADED_SOURCE_FIT_V1_RESULT.json').read_text());fitpath=ROOT/'basis_aligned/bilinear_quotient/ops/run_graded_source_fit_v1.py';assert terminal['source_shas'][str(fitpath)]==FIT_SHA
    program_path=P/'GRADED_SOURCE_FIT_V1_PROGRAM.pt';assert digest(program_path)==terminal['artifact_sha']
