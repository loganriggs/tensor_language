...
Smoke: V139_SMOKE=<out.json>, V139_SMOKE_SET=<set> -> CPU, 4 rows.
"""
...
OUT = ROOT / "circuits/followups/unit_tier5_cue_readout_alignment_v139_result.json"
FAR_GAP = 3
...
def _plan():
    return {"candidate_id": "corpus.unit_tier5_cue_readout_alignment_v139", "behaviours": 3,
...
def main() -> None:
    ...
    smoke = os.environ.get("V139_SMOKE")
    ...
    sets = dict(READERS)
    if smoke:
        pick = os.environ.get("V139_SMOKE_SET") or "lexical_number_pp"
    ...
    result = {"predictions": predictions, "schema": "unit_tier5_cue_readout_alignment_v139", "candidate_id": "corpus.unit_tier5_cue_readout_alignment_v139",
