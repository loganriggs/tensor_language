...
import circuit_fast_screen_candidate_degree_frame_canonical as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_degree_frame_canonical_control_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/degree_frame_canonical_control_v1_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "degree-frame-canonical-control-v1"
EXPERIMENT_ID = "fast-screen-degree-frame-canonical-control-v1"
EXPECTED_AUTHORITY_SHA256 = (
    "39c0c883e4f851024e350fe330ddb77d948891e1af09448cef24e01db88952a1"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "433a2572ed6042329f66080c6aa2c068a1fea50012c3bc02d2a83d85b195feaf"
)
