...
def main():
 import torch
 sys.path.insert(0,str(P));from shared_mixed_source_graph import component_scalars as partial_components
 component_scalars=COMPONENT_EXECUTOR or partial_components
