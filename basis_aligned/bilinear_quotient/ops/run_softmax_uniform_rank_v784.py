...
at UNIFORM rank 24 -- 19% of its 128-dim head, against Pythia's 31% at rank 20 and 75% at rank 48 -- with the same protocol as v752
...
PREDICTIONS (scored as written; failures preserved)
    ...
    pred_b_closed_form_cost     rank-24 closed-form (SVD-truncated, unfitted) cost <= 0.5. Prior: likely
    pred_c_fitted_cost          rank-24 fitted cost <= 0.15, i.e. recovery >= 0.956 at 19% of the head dimension. Prior: unsure
    pred_d_values_preserved_rank rank-24 manipulability Spearman >= 0.7. Prior: likely
    pred_e_values_preserved_scale rank-24 median value ratio in [0.5, 2]. Prior: likely
...
OUT = ROOT / "circuits/followups/softmax_uniform_rank_v784_result.json"
OUT_PT = ROOT / "circuits/followups/softmax_uniform_rank_v784_programs.pt"
...
CANDIDATE_ID = "softmax.uniform_rank_v784"
...
PREDICTIONS = {"pred_a_native_replays": "+-0.002", "pred_b_closed_form_cost": "rank 24 <= 0.5", "pred_c_fitted_cost": "rank 24 <= 0.15", "pred_d_values_preserved_rank": "rank 24 Spearman >= 0.7", "pred_e_values_preserved_scale": "rank 24 median ratio in [0.5, 2]"}
