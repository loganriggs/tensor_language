...
"""Person family DoD (v109): RESPONSE CENSUS of the run_person_object_control_dod_battery_v105 set removal on its fresh rows (better_circuits §3.3). Body: v74's from the set's
...
v74.OUT = v74.ROOT / "circuits/followups/person_object_control_dod_response_census_v109_result.json"
v74.CANDIDATE_ID = line.CANDIDATE_ID.rsplit(".", 1)[0] + ".dod_response_census_v109"
v74.FORWARDS_MAX = 8
