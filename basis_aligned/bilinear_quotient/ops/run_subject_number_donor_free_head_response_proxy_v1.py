...
BINDING = POLY / "SUBJECT_NUMBER_DONOR_FREE_HEAD_RESPONSE_PROXY_V1_BINDING.json"
OUT = ROOT / "circuits/fast_screens/subject_number_donor_free_head_response_proxy_v1_result.json"
...
def plan():
    ...
    return {"schema": "subject_number_donor_free_head_response_proxy_v1_plan",
...
def main():
    ...
    result = {"schema": "subject_number_donor_free_head_response_proxy_v1_result",
