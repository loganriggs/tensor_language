...
"""Lexical number were/was (plural token in a PP) reuse census (v51): blind readout sweep + top-4 set on the line's authored A1/A2 contexts (opened rows).
...
import circuit_fast_screen_candidate_lexical_number_pp as m
...
rows, pos, neg = R.rows_from_candidate(m, " were", " was", "lexical_number")
if __name__ == "__main__":
    R.run("lexical_number.pp_intervener.dod_reuse_census_v51", "lexical_number_dod_reuse_census_v51_result.json", rows, pos, neg)
