"""HEAD-PARITY BAND TEST II (rung 259): fine band missing at even heads only.
...
even index keep r96 while the others are exact (motifs exact throughout) - half the fine-band deficiency.
...
if os.environ.get('BQLIB_DRYRUN')=='1':
    ...
    print('DRYRUN OK: fine band at even heads')
    raise SystemExit(0)
import torch
...
OUT=PT+'band_evenheads_results.json'
