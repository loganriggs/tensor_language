...
import circuit_fast_screen_candidate_degree_frame_canonical_v2 as candidate
import circuit_fast_screen_managed_runner as managed
import circuit_fast_screen_spec as screen


ROOT = Path(__file__).resolve().parent.parent
PRIOR_ART = ROOT / "circuits/fast_screen_degree_frame_canonical_v2_prior_art.json"
RESULT_RELATIVE = Path(
    "circuits/fast_screens/degree_frame_canonical_control_v2_result.json"
)
RESULT = ROOT / RESULT_RELATIVE
LEDGER = ROOT / "circuits/fast_screen_ledger.jsonl"
REQUEST_ID = "degree-frame-canonical-control-v2"
EXPERIMENT_ID = "fast-screen-degree-frame-canonical-control-v2"
EXPECTED_AUTHORITY_SHA256 = (
    "b4bb94407ad2a48f7c82291152e9e09e3fa923119aa53956268bf35b459d51e9"
)
EXPECTED_PRIOR_ART_SHA256 = (
    "92cd381b4b6ed9b736dc74ad25a12d42d6875a8d1cc65e53e341090660db2d3b"
)
...
CONFIG = managed.CandidateRunConfig(
    ...
    information_read="which degree head governs the adjective",
    proposed_operation="carry the degree frame across the adjective in two constructions",
    proposed_write="evidence for than rather than as",
    ...
    semantic_position_role="final input token before the degree complementizer",
    batch_size=32,
