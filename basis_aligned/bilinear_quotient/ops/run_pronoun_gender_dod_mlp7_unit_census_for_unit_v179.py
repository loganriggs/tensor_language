...
"""Pronoun gender he/she DoD (v179): MLP 7 at UNIT grain as an input of MLP-8 unit 3152 (v178: embedding x MLP-7 pairs are the largest terms of the
Right factor at the noun). `dod_units.unit_census` on block 7 (v178: pairs with MLP 7 carry 63% of the detector product; embed x mlp:07 is the top pair) with reader = the Left row and, separately, the Right row of unit 3152 (both 1152-d),
...
OUT = ROOT / "circuits/followups/pronoun_gender_dod_mlp7_unit_census_for_unit_v179_result.json"
CANDIDATE_ID = "pronoun_gender.he_vs_she.dod_mlp7_unit_census_for_unit_v179"
UNIT, LAYER, CLOSURE_TOL, TOP10_MIN, TOP50_MIN = 3152, 7, 1e-3, 0.50, 0.80
FORWARDS_MAX = 6
