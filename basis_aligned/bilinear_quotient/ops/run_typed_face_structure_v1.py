...
native=atoms.native
STEM='TYPED_FACE_STRUCTURE_V1';ARMS=['native','parent','face','midpoint']+[f'null:{i}' for i in range(16)]
...
def main():
 ...
 def write(arm,row,donor_row,current,donor,mask):
  ...
  if arm=='midpoint':return candidate
 ...
 'scope':'Base templates opened; four structural variants fresh at freeze. Same cities/endpoints, native-state inputs and suffix. Short framing changes wording as well as position. No fitted predictor null, independent composition, complete OOD or token-only certification.'}
