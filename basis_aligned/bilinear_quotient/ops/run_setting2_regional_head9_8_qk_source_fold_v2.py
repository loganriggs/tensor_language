...
BINDING = P / "SETTING2_REGIONAL_HEAD9_8_QK_SOURCE_FOLD_V2_BINDING.json"
PARENT = ROOT / "basis_aligned/bilinear_quotient/circuits/fast_screens/setting2_regional_attn9_head_mlp16_fold_v2_result.json"
OUT = ROOT / "basis_aligned/bilinear_quotient/circuits/fast_screens/setting2_regional_head9_8_qk_source_fold_v2_result.json"
...
def load_bound() -> tuple[dict, list[dict]]:
    ...
    files = {"preregistration": PREREG, "rows": ROWS,
             ...
             "correction": P / "SETTING2_REGIONAL_HEAD9_8_QK_SOURCE_FOLD_V2_CORRECTION.md",
...
def plan() -> dict:
    ...
    return {"schema": "setting2_regional_head9_8_qk_source_fold_v2_plan",
...
def main() -> None:
    ...
    result = {"schema": "setting2_regional_head9_8_qk_source_fold_v2_result",
