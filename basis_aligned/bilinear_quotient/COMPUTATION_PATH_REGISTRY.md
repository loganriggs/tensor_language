...
| PATH-SET2-001 | Selected outputs backward through MLP17 to its late residual sources | MLP17 source self/cross terms, initially background `g`, scaled MLP16 `p`, and head17.2 `a` | Exact six-term donor/base census closes at `2.99e-15`. Change-norm ratios: `gg .9891`, `gp .2849`, `pp .09691`, `ga .01690`, `pa .00552`, `aa .000188`; head17.2 is not a useful center for these readers | Recursively split `g` into earlier incoming residual and non-head17.2 attention17 output; preserve `gp` and `pp` as live terms and do not promote head17.2 causally |
