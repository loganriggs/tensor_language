...
## 12 September08:57 — common MLP15 interface converges reproducibly but misses interventions

Two rank128degree-balanced fits reach gradients<9e-7 and almostidentical subspaces (meanoverlap.99999894), but branch3/8 jointnativefidelity stillfails. Sixteenweight-onlyrotationplanes findno materialescape. ExactpureMLP15→frozenMLP16/17branch eighth-degree coefficient contraction nowcontrolled;2048syntheticprobes give85.8%errorversus87.0%formalpairedmetric, an unresolvedsmallgap. Mixedpaths andnativeRMSremainexplicit. [Convergence/replica/plane evidence](../../polynomial_causal/COUPLED_GRADED_SOURCE_V1_MATH.md), [eighth-degree math and controls](../../polynomial_causal/COMPOSED_EIGHTH_CONTRACTION_V2_MATH.md). These facts do not close MLP15 or promote a circuit.
