"""CIRCUIT PIPELINE Stage A: the big atlas. All 36 component fingerprints
...
D=1152; R0,R1=300,512
PT='/workspace/tensor_language/basis_aligned/bilinear_quotient/'
OUT=PT+'circuit_atlas_big_results.json'
...
def main():
    ...
    torch.save({'base':ce0.cpu(),'fingerprints':fps,'rows':(R0,R1),
                'even_mask':even},PT+'circuit_atlas_big.pt')
