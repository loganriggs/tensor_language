"""Headline replication: the dilution law (section 93, Spearman +0.79,
monotone) re-measured with fresh stats rows (36-96) and fresh transplant rows
(330-354 base / 430-454 source). REGISTERED: (a) Spearman >= 0.6; (b) <= 2
inversions. Original docstring: v3.1 -- v3's dilution ratios came out ~5e4, physically impossible: the
denominator captured the mlp's RMS-NORMALIZED input (~unit scale) while the
numerator is the raw write. Units mismatch; instrument error recorded in section
93. This version divides by the RAW residual stream entering block i+1 (the block
forward's first argument), same units as the write. Predictions unchanged.
...
OUT=('/workspace/tensor_language/basis_aligned/bilinear_quotient/'
     'bilin18_dilution_replicate_results.json')
