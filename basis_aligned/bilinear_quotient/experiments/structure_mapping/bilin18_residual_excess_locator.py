...
OUT=('/workspace/tensor_language/basis_aligned/bilinear_quotient/'
     'bilin18_residual_excess_locator_results.json')
...
def main():
    ...
    out={}
    for tag,clamp in (('free',False),('clamped',True)):
