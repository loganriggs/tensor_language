"""Dose-response control for section 85: was 200 steps too short for the pruned model to
reorganise? Same arms at 600 steps. REGISTERED: (b6) the C-B gap persists at >= 0.01
(spans load-bearing, recovery not just slow); alternative: gap < 0.004 would reopen
the constraint-release door and correct section 85. Original docstring follows.
...
OUT=('/workspace/tensor_language/basis_aligned/bilinear_quotient/'
     'bilin18_constraint_dose_results.json')
...
def finetune(mdl, steps=600, lr=1e-5):
