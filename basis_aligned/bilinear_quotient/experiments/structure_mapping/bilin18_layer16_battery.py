"""Phase C first stop: layer 16 -- the model's most compressible layer (§10) -- at
the same depth as layers 0/1. Generated from bilin18_layer0_battery.py with LI=16 and
...
OUT = ('/workspace/tensor_language/basis_aligned/bilinear_quotient/'
       'bilin18_layer16_battery_results.json')
