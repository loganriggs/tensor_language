"""COMPLETE THE PIPELINE-UNIVERSALITY TABLE to all six models (§815 follow-up: adds
gpt2-medium, gpt2-large, pythia-160m to bilin18+gpt2+pythia-410m). Same three-band
(front/middle/back) collective-ablation + class+position-keep test. Confirms whether the
redundant class+position-maintenance middle holds across the full set, incl. gpt2-medium
(the constant-bias hard case). Predictions as in §815: super-additive middle, >=0.5 class+pos,
front/back high. ORIGINAL DOCSTRING BELOW.
...
OUT = PT + 'cross_model_pipeline_rest_results.json'
MODELS = ['gpt2-medium', 'gpt2-large', 'EleutherAI/pythia-160m']
