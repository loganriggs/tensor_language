"""COMPOSITIONAL LADDER v2 -- RUN UNTIL DRY: iterate library growth until a round adds <3 passes (max 6 rounds). REGISTERED: converged programmable total >=70 of 118; null <=0.6. (v1 bars held: 36+14 (user direction): describe unexplained
...
OUT=PT+'compositional_ladder2_results.json'
CA=300; NB=78
MHL=list(range(2,10))
T=256
...
def main():
    ...
    print(f"converged programmable total: {total}/118 "
          f"(rounds {rounds})")
    print(f"(a) converged >=70: {'HELD' if pa else 'FAILED'}")
