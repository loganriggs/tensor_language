"""HANDOFF 1 DISSECTION -- is the +1.95-nat block-1 junction also a
narrow channel, i.e. is "junction = few directions" a repeated motif?
Same rank ladder as the block-5 dissection.
REGISTERED PREDICTIONS: (a) top-16 directions >= 60% of the full cut;
(b) random-16 <= 20% of the top-16 cost; (c) monotone, k=256 >= 90%."""
...
OUT=PT+'handoff1_dissect_results.json'
CA=300; R0,R1=120,300; LI=1
