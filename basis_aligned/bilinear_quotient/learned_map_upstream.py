"""CLEAN (non-leaky) middle-frontier test: is the middle a smooth function of UPSTREAM content — what it READS
...
OUT = PT + 'learned_map_upstream_results.json'
NEVAL = 200; SEQ = 256; RPCA = 128; RIDGE = 1e2
