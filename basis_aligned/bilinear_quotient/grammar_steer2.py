"""[v2: inject at block15 (readout-adjacent), apples-to-apples with topic §868 — v1 injected at block2 and was washed out by the per-block residual rescaling] CAUSAL CAPSTONE: grammar steers STRONGLY, the mirror of content/topic's WEAK steering (§868) — same method,
...
OUT = PT + 'grammar_steer2_results.json'
NEVAL = 220; SEQ = 256; READ_L = 15; ALPHAS = [8.0, 16.0, 32.0]; NDISTINCT = 40
