# ship_all36_v2: TOTAL GLASS REBUILT WITH THE UNIT CLASS (S1534-35: top-1024-unit
...
#   pred_a ship36_v2 <= 5.25 on skip=7000.
#   pred_b beats v1 (5.5347) by >= .25.
#   pred_c fresh-row band <= .05 (v1 was .003).
...
OUT = PT + 'ship_all36_v2_results.json'
NR = 960
