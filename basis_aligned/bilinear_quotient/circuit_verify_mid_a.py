# circuit_verify_mid_a: NR=1920 VERIFICATION OF THE MID-TIER REGISTRY (S1530-31
# hardened the >50x tier; this completes the registry: every claim large-row
# verified). Heads PARSED from the source results jsons (S1530 lesson). Part a.
#
...
OUT = PT + 'circuit_verify_mid_a_results.json'
NR = 1920
H = m.transformer.h
