...
| `task.induction.selector_payload` | behavior_circuit | task-defined | proposed | induction_selector_payload | 5 | — | removal | 1 / 1 | induction_terminal_collateral_failure.legacy.v1 | freeze two-valid-source and payload-swap rows; measure selector and value site ceilings |
