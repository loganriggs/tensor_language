...
| `task.induction.selector_payload` | behavior_circuit | task-defined | specified | induction_selector_payload | 7 | — | removal | 1 / 1 | induction_selector_payload_capability_audit.r555.preregistered.v1 | execute R554 and immediately apply the pre-outcome R555 receipt/decision audit; only after an audited held capability result preregister separate selector and payload complete-state ceilings |
