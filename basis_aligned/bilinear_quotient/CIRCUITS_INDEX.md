...
|---|---|---|---|---|---:|---|---|---:|---|---|
| `task.bracket.pending_opener` | behavior_circuit | task-defined | specified | pending_opener_state_three_value_candidate | 5 | capability, das_interchange, full_swap_ceiling, null_control | capability, compiled_equivalence, cross_family_transfer, das_interchange, full_swap_ceiling, null_control, seed_stability | 7 / 8 | pending_opener_downstream_response_atlas.r549.preregistered.v1 | execute and independently audit the frozen 204-forward R549 FIT-selection/SELECT-validation downstream-response atlas; FINAL_TEST/OOD remain unopened |
