...
|---|---|---|---|---|---:|---|---|---:|---|---|
| `task.bracket.pending_opener` | behavior_circuit | task-defined | site_live | pending_opener_state_three_value_candidate | 5 | capability, das_interchange, full_swap_ceiling, null_control | capability, compiled_equivalence, cross_family_transfer, das_interchange, full_swap_ceiling, null_control, seed_stability | 9 / 10 | pending_opener_downstream_readout_guard.r551.complete.null.v1 | preregister an L13H8 endpoint-plus-invariance interchange that rewards both answer-changing families and directly penalizes all three live answer-preserving families; do not use R549 as an independent downstream target and keep FINAL_TEST/OOD closed |
