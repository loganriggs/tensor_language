...
| `task.numbered_list.index_successor` | behavior_circuit | task-defined | specified | list_index_state | 6 | — | — | 0 / 0 | — | run the R569 FIT/SELECT native gate with list_middle_index_break scored as invariance under the R568 overlay |
