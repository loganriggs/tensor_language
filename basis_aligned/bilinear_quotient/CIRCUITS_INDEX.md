...
|---|---|---|---|---|---:|---|---|---:|---|---|
| `task.bracket.pending_opener` | behavior_circuit | task-defined | specified | pending_opener_state_three_value_candidate | 5 | capability, das_interchange, full_swap_ceiling, null_control | capability, compiled_equivalence, cross_family_transfer, das_interchange, full_swap_ceiling, null_control, seed_stability | 10 / 11 | pending_opener_target_invariance_das_audit.r559.complete.held.v1 | test a preregistered nonlinear or upstream factorized representation on the same R545 families; do not extend the L13H8 linear-subspace dimension sweep |
