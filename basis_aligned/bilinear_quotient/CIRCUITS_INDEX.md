...
| `task.narrative_tense.past_vs_present` | behavior_circuit | task-defined | site_live | narrative_tense_at_final_position | 4 | composition, full_swap_ceiling | capability | 2 / 3 | narrative_tense.attn11_head3_complement.v1.held | split attention block 11 head 3 into exact source-score and cached-value terms, then test those terms with an output-token confound control that distinguishes shared copula writing from a shared agreement/tense semantic state |
