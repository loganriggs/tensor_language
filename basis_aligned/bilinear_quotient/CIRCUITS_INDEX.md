...
| `task.numbered_list.index_successor` | behavior_circuit | task-defined | specified | list_index_state | 6 | — | — | 0 / 0 | numbered_list_native_capability.r569.preregistered.v1 | run the R569 FIT/SELECT native gate with list_middle_index_break scored as invariance under the R568 overlay |
| `task.numeric_sequence.continuation` | behavior_circuit | task-defined | specified | numeric_sequence_state_and_rule | 9 | — | — | 0 / 0 | numeric_sequence_native_capability.r570.preregistered.v1 | run a preregistered FIT/SELECT native gate that scores digit, word, cross-format, middle-break, copy, and +2-conflict cells separately |
