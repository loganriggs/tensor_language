...
| `task.increment.state` | behavior_circuit | task-defined | proposed | increment_state | 7 | das_interchange, null_control | capability | 1 / 1 | increment_native_capability_audit.r565.held.v1 | use an explicitly exploratory development pool to identify natural prompt forms that elicit +1, number-word +1, copy, and +2; then freeze new group-disjoint rows before any component localization. Do not apply the legacy L8H7/L8H3/MLP8-14 story to R563 |
