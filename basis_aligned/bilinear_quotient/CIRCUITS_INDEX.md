...
| `task.increment.state` | behavior_circuit | task-defined | specified | increment_state | 7 | das_interchange | — | 0 / 0 | increment_native_capability.r564.preregistered.v1 | preregister FIT/SELECT native capability on all seven natural-prompt R563 families; require digit and number-word success, cross-format transfer, middle-edit sensitivity, and stability on both nonincrement controls before reopening L8H7/L8H3 or MLP8-14 localization |
