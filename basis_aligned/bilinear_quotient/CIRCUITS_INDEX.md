...
| `task.narrative_tense.past_vs_present` | behavior_circuit | task-defined | site_live | narrative_tense_at_final_position | 4 | capability, composition, full_swap_ceiling | capability, composition | 4 / 5 | narrative_tense.a1_template_capability_select_holdout.v1.held | build a genuinely new lexical A1+A2 narrative-tense authority using the frozen served_one_purpose construction, then run carrier confirmation only after that authority passes capability |
