...
| `task.narrative_tense.past_vs_present` | behavior_circuit | task-defined | site_live | narrative_tense_at_final_position | 4 | composition, full_swap_ceiling | capability, composition | 3 / 4 | narrative_tense.attn11_head3_source_route_cross_task.v1.invalid | build a fresh disjoint capable narrative-tense authority before testing the outcome-selected remaining-source (R) hypothesis; do not repair the no-op tolerance or control bar on the same rows |
