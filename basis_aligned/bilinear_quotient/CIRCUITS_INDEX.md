...
|---|---|---|---|---|---:|---|---|---:|---|---|
| `task.bracket.pending_opener` | behavior_circuit | task-defined | specified | pending_opener_state_three_value_candidate | 5 | capability, das_interchange, full_swap_ceiling, null_control | capability, compiled_equivalence, cross_family_transfer, das_interchange, full_swap_ceiling, null_control, seed_stability | 9 / 10 | pending_opener_target_invariance_das.r556.preregistered.v1 | execute and independently audit the frozen R556 FIT-trained target-plus-invariance interchange; keep FINAL_TEST/OOD closed and do not extend capacity after a null |
...
| `task.induction.selector_payload` | behavior_circuit | task-defined | specified | induction_selector_payload | 7 | null_control | removal | 1 / 1 | induction_factor_intervention_semantics.r557.held.v1 | execute and audit R554; if native factorial capability holds, preregister a model-facing selector-score versus payload-value interchange screen below the attention-head boundary |
