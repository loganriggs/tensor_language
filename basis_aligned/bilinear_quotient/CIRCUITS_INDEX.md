...
| `task.numbered_list.index_successor` | behavior_circuit | task-defined | specified | list_index_state | 6 | capability, null_control | — | 0 / 0 | numbered_list_conflict_confirmation.r572.preregistered.v1 | run raw-row R572 confirmation of the list +2 conflict, then preregister exact L8H7/L8H3 value-path ceilings |
