...
| `task.numbered_list.index_successor` | behavior_circuit | task-defined | specified | list_index_state | 6 | capability, null_control | — | 0 / 0 | numbered_list_conflict_confirmation.r572.held.v1 | preregister exact L8H7/L8H3 final-label/all-label score-versus-value factor localization with all four invariance families |
