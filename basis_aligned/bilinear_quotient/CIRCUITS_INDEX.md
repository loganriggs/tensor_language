...
|---|---|---|---|---|---:|---|---|---:|---|---|
| `task.bracket.pending_opener` | behavior_circuit | task-defined | specified | pending_opener_state_three_value_candidate | 5 | capability, das_interchange, full_swap_ceiling, null_control | capability, compiled_equivalence, cross_family_transfer, das_interchange, full_swap_ceiling, null_control, seed_stability | 10 / 12 | pending_opener_source_factor_audit.r561.preregistered.v1 | execute the shape-only R560 v2 repair and immediately apply the pre-outcome R561 CPU audit; keep FINAL_TEST/OOD closed |
