...
|---|---|---|---|---|---:|---|---|---:|---|---|
| `task.bracket.pending_opener` | behavior_circuit | task-defined | specified | pending_opener_state_three_value_candidate | 5 | capability, das_interchange, full_swap_ceiling, null_control | capability, compiled_equivalence, cross_family_transfer, das_interchange, full_swap_ceiling, null_control, seed_stability | 10 / 11 | pending_opener_source_factor_interchange.r560.preregistered.v1 | execute and independently audit the frozen R560 semantic-source score/payload factor interchange; keep FINAL_TEST/OOD closed and do not return to a linear-dimension sweep |
