...
|---|---|---|---|---|---:|---|---|---:|---|---|
| `task.bracket.pending_opener` | behavior_circuit | task-defined | proposed | pending_opener_state_three_value_candidate | 5 | capability, das_interchange, full_swap_ceiling, null_control | capability, cross_family_transfer, null_control, seed_stability | 4 / 5 | pending_opener_four_closer_site_gate.r544.native_curly_null.v1 | build fresh content-addressed parenthesis/square/quote groups with new templates and word pools; preregister native capability and attn13h8 full-state confirmation before any subspace fit |
