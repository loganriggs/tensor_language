...
|---|---|---|---|---|---:|---:|---|
| `task.bracket.pending_opener` | behavior_circuit | task-defined | specified | pending_opener_state | 5 | 1 | rerun the unchanged 15-site contract through the source-closed loader that verifies the actual checkpoint bytes; preserve the first outcome as invalid |
