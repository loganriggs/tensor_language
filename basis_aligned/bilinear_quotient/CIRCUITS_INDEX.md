...
| `task.induction.selector_payload` | behavior_circuit | task-defined | specified | induction_selector_payload | 9 | null_control | capability, removal | 2 / 2 | induction_selector_payload_native_capability.r580.preregistered.v2 | execute and independently audit the frozen R580 FIT/SELECT native-capability screen; only a held, audited result may license adapting the existing R557 score/value algebra and R558 interaction lattice to R578 |
| `task.narrative_tense.past_vs_present` | behavior_circuit | task-defined | site_live | narrative_tense_at_final_position | 4 | composition, full_swap_ceiling | capability, composition | 4 / 5 | narrative_tense.attn11_head3_fresh_unchanged_carrier.v1.invalid_capability | predeclare A1 template capability selection on FIT, evaluate it before route outcomes, and freeze an untouched construction holdout; rerun the unchanged-carrier experiment only if the selected authority is capable |
