# sqrd12_closer_quotes: THE LAST SYMMETRIC CELL (§1377). Is sqrd12's 7.0 delimiter-
# general (quote-parity targets), completing the 3x2 closer table?
#
# Registered predictions:
#   pred_a 7.0 carries >= 60% of a7's quote-close damage solo.
...
OUT = PT + 'sqrd12_closer_quotes_results.json'
L7 = 7
NH = 6
HD = 128
NMEAN = 24; NR = 1920
...
def main():
    ...
    print(f"layer dmg {layer_dmg:+.4f} (quote targets)", flush=True)
    solo = {}; keep = {}
    for h in range(NH):
        r = ce_all({h})
