# close_bracket_screen2: 2x-DATA RERUN of the §1337 screen. v1: concentration 45.9 and
# ownership held, but the RANDOM control missed its bar by 0.12 (1.62 vs 1.5) at n~modest
# -> verdict withheld per the evaluability standard. Same §1315->§1317 path: rerun at
# NR=3840 with a fresh random seed. Same registered predictions as v1.
#
# (v1 header follows.)
...
OUT = PT + 'close_bracket_screen2_results.json'
NMEAN = 24; NR = 3840
H = m.transformer.h
