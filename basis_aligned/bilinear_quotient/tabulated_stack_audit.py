# tabulated_stack_audit: §1171's stack at 2x rows on a FRESH draw (§1101 replication law).
# Registered: joint = 0.023 +/- 0.005; sink 0.013 +/- 0.004; foldpat 0.014 +/- 0.004.
...
OUT = PT + 'tabulated_stack_audit_results.json'
NR = 32; W = 128
...
def main():
    ...
    ROWS = cl.fineweb_rows(2 * NR)[NR:][:, :T + 1].contiguous()   # fresh draw, 2x audit (§1101 law)
