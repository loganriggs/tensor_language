# bilin12_closer_quotes: THE DELIMITER-GENERAL CLAIM IN THE SIBLING (§1374). bilin18's
# 13.8 owns brackets AND quotes (§1356). Does bilin12's 7.1 own quote-closing too?
# Quote-parity targets, same 6-head battery at a7.
#
# Registered predictions:
#   pred_a 7.1 carries >= 60% of a7's quote-close damage solo.
...
OUT = PT + 'bilin12_closer_quotes_results.json'
L7 = 7
NH = 6
HD = 128
NMEAN = 24; NR = 1920
