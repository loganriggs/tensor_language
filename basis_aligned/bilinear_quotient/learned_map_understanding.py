"""GAP-FILL: is the middle content a SMOOTH (generalizing) function of named variables, or genuinely
...
OUT = PT + 'learned_map_understanding_results.json'
NEVAL = 200; SEQ = 256; CONTENT_L = 15; K = 12; RTOK = 64; RPOS = 32; RTOPIC = 24; RIDGE = 1e2
