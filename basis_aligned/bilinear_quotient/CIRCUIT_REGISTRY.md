...
mlp4 DIET NAMED (S1422: mlp0 .674/mlp3 .373/mlp2 .121, mlp1~0, attn 5%; coherent-code sensitivity) + NOT topical (S1423: BoW=null, tok-table<constant). mlp4_from_inputs DONE (S1424: lin3 .61 held-out; lin0 -.96 coherent-code #3; class64 .06). mlp4_weight_tensor queued LANE2 (pure-bilinear third-order tensor restricted to named feature bases — weights-level interaction map). Registered next: mlp4_bow was
