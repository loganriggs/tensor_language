...
- REFLECTION DISCOVERY (S1589): mlp17 carries a SIGNED gender readout through odd pathways worth .49 CE at pronoun positions (5x the even gate). ASYMMETRIC coding: reflected he-state does not become she-prediction (p_he -67%, p_she +11% only) — he-mass leaves the pronoun family entirely.
