...
10.6 quote +.036; 13.3/11.7 punct dead (argmax mirages). pair = two-crew #3 (S1416, joint 1.70x); 10.6 inverted (close-side); open-quote UNSERVED; newline_bill queued (5th family into the bill) |
