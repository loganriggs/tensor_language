...
no category below scope-mean 0.02. Wave-4 = medium-CE behavior-conditioned enrichment (launched). 7.8 CLOSED (S1394: sub-floor both skips at 2x power; flavor-only helper).
