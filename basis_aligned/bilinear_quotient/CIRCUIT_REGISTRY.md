...
10.6 quote +.036; 13.3/11.7 punct dead (argmax mirages). pair = two-crew #3 (S1416, joint 1.70x); 10.6 inverted (close-side); open-quote UNSERVED; newline served at .863 by kit28 WITHOUT the pair (S1417 — two-inventory law now general, 4/4; pair not added). CREW = 5 heads L7-12, joint .617 (S1418); 16.3 = 13th committee member; closer = the exception not the paradigm. newline_crews queued (sub-band structure + committee-13 reprice) |
