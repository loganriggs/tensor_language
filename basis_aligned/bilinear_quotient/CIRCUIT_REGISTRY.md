...
mlp4 DIET NAMED (S1422: mlp0 .674/mlp3 .373/mlp2 .121, mlp1~0, attn 5%; coherent-code sensitivity) + NOT topical (S1423: BoW=null, tok-table<constant). mlp4_from_inputs DONE (S1424: lin3 .61 held-out; lin0 -.96 coherent-code #3; class64 .06). weight tensor read (S1425: mlp3-centered mass, hub m3#5, dense in PC basis, PC-projection .13 vs ridge .61 — need function-aware basis). RETRACTION S1426: path-patch ledger stale under lambda-mixing; mids_reads VOID, S1422 magnitudes flagged; reads_exact queued (exact ledger + self-test, mlp4/5/6). Registered next: mlp4_bow was
