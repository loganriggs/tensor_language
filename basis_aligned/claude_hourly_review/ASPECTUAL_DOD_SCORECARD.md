...
| 36 | Head 8.1's cue key is built by mid-block writers: on the discovery rows mlp6 / mlp7 / mlp5 / embedding carry 25 / 24 / 23 / 11% of the first QK score (top-4 = 82%) and mlp6 / mlp5 / attn5 / attn6 the second (65%); on natural rows attn5 / mlp6 / mlp5 / attn7 lead (66% / 64%) | fold | opened + fresh corpus (v23) | closure 4e-5 | 1/3: diffuse and panel-dependent; kill criterion tripped — the cue key is a declared open port (mid-block contextual state at the cue) |
