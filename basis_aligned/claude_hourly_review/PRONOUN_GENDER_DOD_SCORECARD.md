...
| Extracted | held at the head boundary (row 5); direct readout (row 8); sources folded: 10.1/15.1 token-only noun readers, 9.6/12.4 contextual (row 10) | finer position split of the contextual share (v81) |
