...
| U1 | MLP 8 at UNIT grain on head 13.8's reader direction (v85 rows; cue = the adjective where the pair members differ, e.g. interested / afraid; closure 0.0): at the CUE — top-5 26%, top-10 29%, top-50 48%, min Jaccard across verbs 0.14, leaders 2346 (9%), 2506, 1472; at the FINAL — top-5 13%, top-10 8%, top-50 61% (cancelling), Jaccard 0.18 | fold | v85 rows (v261b; v261 crashed on a zero contrast at the verb, which the pairs share) | closure held; "top-10 ≥ 0.50" false at both positions; "stable across verbs" false | 1/4 — the selection family's MLP-8 stage is spread at both positions: a PORT. Its cue is a content word (an adjective), so "content-word cues have MLP-8 detectors" (noun number, noun gender, determiner number) does not generalise to adjectives selecting a particle |
| U2 | MLP 7 at unit grain on 13.8's reader direction (v85 rows; adjective cue; closure 0.0), the one-block-lower check after v261b: at the CUE — top-5 24%, top-10 6%, top-50 -70% (cancelling), min verb Jaccard 0.14, leader 2579; at the FINAL — top-5 -34%, top-10 -49%, top-50 3%, Jaccard 0.14 | fold | v85 rows (v285) | closure held; top-10 ≥ 0.50 false at both positions; stability false | 1/4 — spread at MLP 7 as at MLP 8 (v261b): the selection family is a PORT at both MLP grains; the particle-selecting adjective's feature is not an MLP unit at either block. Declared |
