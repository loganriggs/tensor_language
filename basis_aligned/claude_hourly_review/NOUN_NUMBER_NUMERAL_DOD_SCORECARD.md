...
| U2 | Units 2428 (cue) and 3892 (final) under edit on the v158 rows: u_2428(cue) = −39 on three-rows vs −14 on one-rows (sign agreement 48/48), cos(Down8[:,2428], r_11.2) = −0.23; zeroing 2428 at the cue changes the pooled ones − one margin by −0.31% (a growth; 16 random units ≤ +0.06%); zeroing 3892 at the final +0.10% (random ≤ 0.03%) | fold + edit | v158 rows (v258) | "2428 separates three/one", "aligns ≥ 0.20", "3892 final edit beats random", "3892 > 2428" held; "2428 cue edit removes > 0" false (it opposes) | 4/5 — the numeral line's MLP-8 stage is behaviourally near-inert (|edits| ≤ 0.3%): 2428 is a three-detector that opposes the ones/one readout, 3892's final-position re-firing helps by 0.1%. On this family MLP 8 is a minor, mixed-sign input to 11.2; thread stopped (108 forwards for a null-ish result — noted for Part B) |
