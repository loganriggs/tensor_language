...
ax.plot([v['Mbit'] for _, v in lr], [v['dce'] for _, v in lr], 'o-', color='#3b7dd8', label='low-rank (rank r)')
ax.plot([v['total_Mbit'] for _, v in pr], [v['dce'] for _, v in pr], 's-', color='#c0392b', label='magnitude-prune (values+index)')
