...
Anchors from the optimal-ablation sweep (92/198 components so far;
attention layers land last). Generated 2026-08-25 20:57 UTC; regenerate with
...
2. **mlp0** — unexplained 0.091 nats (Δ_opt 0.908, fidelity 0.90) — class-code writer / token map, S905/S1045
3. **head0.3** — unexplained 0.062 nats (Δ_opt 0.062, fidelity 0.00) — baseline zoo only
4. **mlp7** — unexplained 0.056 nats (Δ_opt 0.056, fidelity 0.00) — baseline zoo only
5. **mlp17** — unexplained 0.053 nats (Δ_opt 0.332, fidelity 0.84) — fitted linear read, S1131-32
...
| mlp2 | 0.7260 | 0.94 | 0.0407 | lin2 [attn2,mlp1] + r256 quad, S1437 (lin2 alone .920) |
