...
Anchors from the optimal-ablation sweep (157/198 components so far;
attention layers land last). Generated 2026-08-25 21:27 UTC; regenerate with
...
2. **head0.3** — unexplained 0.062 nats (Δ_opt 0.062, fidelity 0.00) — baseline zoo only
3. **mlp0** — unexplained 0.062 nats (Δ_opt 0.908, fidelity 0.93) — tok map + residual ridge [attn0,embed] + quad, fid_opt, S1439
